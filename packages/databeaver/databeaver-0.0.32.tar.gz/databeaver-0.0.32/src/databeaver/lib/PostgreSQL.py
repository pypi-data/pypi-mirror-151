...
class PostgreSQL(Object):
    ...
    def __init__(self, host, database, user, password):
        ...
        # Used to hold the connection to postgres
        ...
        # Connect to postgres
        self.connect(self._host, self._database, self._user, self._password)
    ...
    def insert_list_of_dictionaries(self, table_name, rows, schema=None, log_level=logging.DEBUG):
        ...
        for columns, insert_values in data_to_insert.items():
            insert_stmt = f"INSERT INTO {schema_clause}{table_name} ({columns})\n VALUES\n{insert_values}"
            insert_stmt = f"{insert_stmt[:-2]};"
