...
/* harmony import */ var _query__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./query */ "./lib/query.js");
/* harmony import */ var _savequit__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./savequit */ "./lib/savequit.js");
...
function activateRSPExtension(app, mainMenu, docManager, statusBar) {
    ...
    (0,_query__WEBPACK_IMPORTED_MODULE_4__.activateRSPQueryExtension)(app, mainMenu, docManager);
    console.log('...activated...');
    console.log('...activating savequit extension...');
    (0,_savequit__WEBPACK_IMPORTED_MODULE_5__.activateRSPSavequitExtension)(app, mainMenu, docManager);
    console.log('...activated...');
...
var CommandIDs;
(function (CommandIDs) {
    CommandIDs.rspQueryAPI = 'rspqueryapi';
    CommandIDs.rspQuerySquash = 'rspquerysquash';
...
function queryDialog(manager, prompt) {
    let options = {
        title: 'Query ID',
...
function apiRequest(url, init, settings) {
    ...
    */
    // Fake out URL check in makeRequest
    return _jupyterlab_services__WEBPACK_IMPORTED_MODULE_4__.ServerConnection.makeRequest(url, init, settings).then(response => {
        if (response.status !== 200) {
            return response.json().then(data => {
...
function rspQuery(app, docManager, svcManager, qtype) {
...
(function (Private) {
     ...
     */
    function createQueryNode(prompt) {
...
//# sourceMappingURL=lib_index_js.277e0f3b3cc7c0e7c40e.js.map