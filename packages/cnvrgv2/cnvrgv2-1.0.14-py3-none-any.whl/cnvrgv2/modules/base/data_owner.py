...
from cnvrgv2.errors import CnvrgFileError, CnvrgArgumentsError, CnvrgError
...
class DataOwner(DynamicAttributes):
    ...
    def put_files(
        ...
        for path in paths_to_upload:
            ...
            if is_dir:
                fullpaths += get_files_and_dirs_recursive(
                    root_dir=path,
                    regex=pattern,
                    not_tmp=True,
        ...
        if job_slug is not None and last_commit is None and self.start_commit is not None:
    ...
    def clone(self, progress_bar_enabled=False, override=False, commit=None):
        """
