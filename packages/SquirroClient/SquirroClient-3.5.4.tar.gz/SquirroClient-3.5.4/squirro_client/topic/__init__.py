...
class TopicApiBaseMixin:
    def get_projects(self):
        """Return all projects."""
        # Build URL
        url = "{ep}/v0/{tenant}/projects".format(
    ...
    def get_pipelets(self):
        ...
        Example::
            ...
            {'pipelets': [{'id': 'tenant01/textrazor',
                            'name': 'textrazor'}]}
        """
        url = "{ep}/v0/{tenant}/pipelets".format(
            ep=self.topic_api_url,
            tenant=self.tenant,
        )
        res = self._perform_request("get", url)
    ...
    def get_pipelet(self, name):
        ...
        """
        url = "{ep}/v0/{tenant}/pipelets/{name}".format(
            ep=self.topic_api_url,
            tenant=self.tenant,
            name=name,
        )
    ...
    def query(
        ...
        query_context: Optional[Dict[str, Optional[str]]] = None,
        aggregations=None,
        start=None,
        count=None,
        fields=None,
        ...
        **kwargs,
        ...
        :param query_context: Dictionary containing context of the query.
            It includes terms that user typed in a searchbar (`searchbar_query`)
            and dashboard filters (`dashboard_filters`).
        ...
        :param highlight: Dictionary containing highlight information. Keys
            ...
            be highlighted.
        :param spellcheck: (Dictionary) Apply spellchecking on the given query terms.
            Spellchecking is performed against the provided field (full elastic field name).
        ...
        *Detect spelling errors and provide refined search terms*::
        ...
        args = {
            ...
            "timing": "true" if timing else None,  # timing parameter expects a str
        }
        if "scroll" in kwargs:
            logging.warning(
