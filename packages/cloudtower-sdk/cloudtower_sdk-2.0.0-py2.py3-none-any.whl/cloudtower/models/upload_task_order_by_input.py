...
class UploadTaskOrderByInput(object):
    ...
    allowable_values = [ARGS_ASC, ARGS_DESC, CHUNK_SIZE_ASC, CHUNK_SIZE_DESC, CREATEDAT_ASC, CREATEDAT_DESC, CURRENT_CHUNK_ASC, CURRENT_CHUNK_DESC, FINISHED_AT_ASC, FINISHED_AT_DESC, ID_ASC, ID_DESC, RESOURCE_TYPE_ASC, RESOURCE_TYPE_DESC, SIZE_ASC, SIZE_DESC, STARTED_AT_ASC, STARTED_AT_DESC, STATUS_ASC, STATUS_DESC, UPDATEDAT_ASC, UPDATEDAT_DESC]  # noqa: E501
