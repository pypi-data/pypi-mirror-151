...
class UploadResourceType(object):
    ...
    allowable_values = [CLOUDTOWER_APPLICATION_PACKAGE, CLUSTER_IMAGE, CLUSTER_IMAGE_META, CONTENT_LIBRARY_IMAGE, ELF_IMAGE, EVEROUTE_PACKAGE, MONITOR_IMAGE, SVT_IMAGE]  # noqa: E501
