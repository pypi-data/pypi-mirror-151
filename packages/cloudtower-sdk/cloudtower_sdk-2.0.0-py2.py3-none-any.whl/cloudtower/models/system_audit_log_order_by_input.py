...
class SystemAuditLogOrderByInput(object):
    ...
    allowable_values = [ACTION_ASC, ACTION_DESC, CREATEDAT_ASC, CREATEDAT_DESC, FINISHED_AT_ASC, FINISHED_AT_DESC, ID_ASC, ID_DESC, LOCAL_CREATED_AT_ASC, LOCAL_CREATED_AT_DESC, LOCAL_ID_ASC, LOCAL_ID_DESC, MESSAGE_ASC, MESSAGE_DESC, RESOURCE_ID_ASC, RESOURCE_ID_DESC, STATUS_ASC, STATUS_DESC, UPDATEDAT_ASC, UPDATEDAT_DESC]  # noqa: E501
