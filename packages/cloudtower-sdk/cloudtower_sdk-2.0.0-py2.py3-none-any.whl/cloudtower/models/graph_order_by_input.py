...
class GraphOrderByInput(object):
    ...
    allowable_values = [CREATEDAT_ASC, CREATEDAT_DESC, ENTITYASYNCSTATUS_ASC, ENTITYASYNCSTATUS_DESC, ID_ASC, ID_DESC, LOCAL_ID_ASC, LOCAL_ID_DESC, METRIC_COUNT_ASC, METRIC_COUNT_DESC, METRIC_NAME_ASC, METRIC_NAME_DESC, METRIC_TYPE_ASC, METRIC_TYPE_DESC, NETWORK_ASC, NETWORK_DESC, RESOURCE_TYPE_ASC, RESOURCE_TYPE_DESC, SERVICE_ASC, SERVICE_DESC, TARGETS_ASC, TARGETS_DESC, TITLE_ASC, TITLE_DESC, TYPE_ASC, TYPE_DESC, UPDATEDAT_ASC, UPDATEDAT_DESC]  # noqa: E501
