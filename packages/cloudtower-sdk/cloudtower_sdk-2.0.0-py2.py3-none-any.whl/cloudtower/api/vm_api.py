...
class VmApi(object):
    ...
    def mig_rate_vm(self, vm_migrate_params, **kwargs):  # noqa: E501
        """mig_rate_vm  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.mig_rate_vm(vm_migrate_params, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.mig_rate_vm_with_http_info(vm_migrate_params, **kwargs)  # noqa: E501

    def mig_rate_vm_with_http_info(self, vm_migrate_params, **kwargs):  # noqa: E501
        """mig_rate_vm  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.mig_rate_vm_with_http_info(vm_migrate_params, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('vm_migrate_params' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `vm_migrate_params` when calling `mig_rate_vm`")  # noqa: E501
