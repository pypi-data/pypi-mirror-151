...
class GlobalAlertRuleOrderByInput(object):
    ...
    allowable_values = [BOOLEAN_ASC, BOOLEAN_DESC, CAUSE_ASC, CAUSE_DESC, CREATEDAT_ASC, CREATEDAT_DESC, DEFAULT_THRESHOLDS_ASC, DEFAULT_THRESHOLDS_DESC, DISABLED_ASC, DISABLED_DESC, ID_ASC, ID_DESC, IMPACT_ASC, IMPACT_DESC, MESSAGE_ASC, MESSAGE_DESC, NAME_ASC, NAME_DESC, OBJECT_ASC, OBJECT_DESC, OPERATOR_ASC, OPERATOR_DESC, SOLUTION_ASC, SOLUTION_DESC, THRESHOLDS_ASC, THRESHOLDS_DESC, UNIT_ASC, UNIT_DESC, UPDATEDAT_ASC, UPDATEDAT_DESC]  # noqa: E501
