...
class NfsInodeOrderByInput(object):
    ...
    allowable_values = [ASSIGNED_SIZE_ASC, ASSIGNED_SIZE_DESC, CREATEDAT_ASC, CREATEDAT_DESC, ENTITYASYNCSTATUS_ASC, ENTITYASYNCSTATUS_DESC, FILE_ASC, FILE_DESC, ID_ASC, ID_DESC, LOCAL_ID_ASC, LOCAL_ID_DESC, LOCAL_UPDATED_AT_ASC, LOCAL_UPDATED_AT_DESC, NAME_ASC, NAME_DESC, PARENT_ID_ASC, PARENT_ID_DESC, SHARED_SIZE_ASC, SHARED_SIZE_DESC, SNAPSHOT_NUM_ASC, SNAPSHOT_NUM_DESC, UNIQUE_SIZE_ASC, UNIQUE_SIZE_DESC, UPDATEDAT_ASC, UPDATEDAT_DESC]  # noqa: E501
