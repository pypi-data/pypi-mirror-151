...
class ElfStoragePolicyOrderByInput(object):
    ...
    allowable_values = [CREATEDAT_ASC, CREATEDAT_DESC, DESCRIPTION_ASC, DESCRIPTION_DESC, ENTITYASYNCSTATUS_ASC, ENTITYASYNCSTATUS_DESC, ID_ASC, ID_DESC, LOCAL_ID_ASC, LOCAL_ID_DESC, NAME_ASC, NAME_DESC, REPLICA_NUM_ASC, REPLICA_NUM_DESC, STRIPE_NUM_ASC, STRIPE_NUM_DESC, STRIPE_SIZE_ASC, STRIPE_SIZE_DESC, THIN_PROVISION_ASC, THIN_PROVISION_DESC, UPDATEDAT_ASC, UPDATEDAT_DESC]  # noqa: E501
    ...
    def __init__(self, **kwargs):  # noqa: E501
        """ElfStoragePolicyOrderByInput - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ElfStoragePolicyOrderByInput):
            return False
