...
class ReportTemplateOrderByInput(object):
    ...
    allowable_values = [CREATEDAT_ASC, CREATEDAT_DESC, DESCRIPTION_ASC, DESCRIPTION_DESC, EXECUTE_PLAN_ASC, EXECUTE_PLAN_DESC, ID_ASC, ID_DESC, NAME_ASC, NAME_DESC, PRESET_ASC, PRESET_DESC, RESOURCE_META_ASC, RESOURCE_META_DESC, TASK_NUM_ASC, TASK_NUM_DESC, UPDATEDAT_ASC, UPDATEDAT_DESC]  # noqa: E501
