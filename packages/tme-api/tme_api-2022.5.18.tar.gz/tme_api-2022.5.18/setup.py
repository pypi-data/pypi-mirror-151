...
"""
pip install -U tme_api
pip --no-cache-dir install -U tme_api
...
setup(
    ...
    description="tme_api",
    # 详细描述
    long_description="访问 icms.tmeoa.com 的api",
    ...
    # 官网地址
    url="https://github.com/ldsxp/tme_api",
    # 程序的下载地址
    download_url="https://pypi.org/project/tme_api",
    # 作者
    author="lds",
    # 作者的邮箱地址
