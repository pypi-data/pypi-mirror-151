...
class RIMEFirewall:
    ...
    def run_firewall_incremental_data(
        ...
        .. code-block:: python
            ...
            incremental_config = {
                "eval_path": "s3://rime-datasets/
                   fraud_firewall/eval_2021_04_30_to_2021_05_01.csv",
        ...
        try:
            RIMEFirewall._throttler.throttle(  # pylint: disable=W0212
