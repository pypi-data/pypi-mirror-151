...
from rime_sdk.protos.project.project_pb2 import CreateProjectRequest, GetProjectRequest
    ...
    def list_stress_test_jobs(
        ...
        .. code-block:: python
            ...
            jobs = rime_client.list_stress_test_jobs(
                status_filters=['RUNNING', 'SUCCEEDED'], project_id='foo')
        """
    ...
    def start_firewall_from_reference(
        ...
        .. code-block:: python
            ...
            "data_info": {
                ...
                "ref_path": "s3://rime-datasets/fraud_firewall/ref.csv",
                "eval_path": "s3://rime-datasets/fraud_firewall/
