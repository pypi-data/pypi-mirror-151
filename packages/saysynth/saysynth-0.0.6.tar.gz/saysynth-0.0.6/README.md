...
## todo
- [x] optionally run the say command in python rather than always piping out to `say`
- [ ] chord generation for drone
- [ ] sequence command via yaml configuration
- [ ] more unit tests
- [ ] better logging of interactive text across threads
- [ ] use threading to spawn multiple say commands to create polyphonic drones which are mostly in sync.
