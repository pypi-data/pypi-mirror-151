...
class Pipeline(object):
    ...
    def get_automl_iteration_metrics(self):
        """
        ...
        url = "project/{0}/sandbox/{1}/automl-iteration-metrics/".format(
            self._project.uuid, self._sandbox.uuid
        )
    ...
    def set_input_query(self, name, use_session_preprocessor=True):
