...
class Sandbox(object):
    ...
    def __init__(self, connection, project):
        ...
        self._last_cpu_clock_time = None
        self._active = False
    ...
    @property
    def last_cpu_clock_time(self):
        return self._last_cpu_clock_time
    ...
    def auto(self, auto_params, renderer=None, version=1):
    ...
    def refresh(self):
        ...
        if err is False:
            ...
            self._last_cpu_clock_time = data.get("last_cpu_clock_time", None)
    ...
    def initialize_from_dict(self, init_dict):
        ...
        self._last_cpu_clock_time = init_dict.get("last_cpu_clock_time", None)
