...
class KnowledgePack(VisualizeMixin):
    ...
    def cost_resource_summary(self, processor_uuid=None, hardware_accelerator=None):
    ...
    def get_report(self, report_type, processor_uuid=None, hardware_accelerator=None):
    ...
    def save(self, name):
        """Save a knowledgepack with a name.
    ...
    def download_library(
        ...
        print("this API was removed. use download_library_v2")

    def download_source(
        self, folder="", run_async=True, platform=None, renderer=None, *args, **kwargs
    ):
        print("this API was removed. use download_source_v2")
    ...
    def _download_v2(
        ...
        **kwargs
        ...
        url = "project/{0}/knowledgepack/{2}/generate_{3}/v2".format(
    ...
    def get_build_log(self, renderer=None, save_as=None):
        url = "knowledgepack/{0}/build-logs/".format(self.uuid)
        ...
        if "content-disposition" in response_data.headers:
            ...
            if renderer:
                renderer.render("Build Log saved to\n{0}".format(output_path))
            else:
                print("Build Log saved to: {0}".format(output_path))
    ...
    def initialize_from_dict(self, init_dict):
        ...
        try:
            ...
            self._feature_file_uuid = json.loads(init_dict["feature_file_uuid"])
            self._training_metrics = json.loads(init_dict("training_metrics"))
            ...
            self._feature_file_uuid = init_dict["feature_file_uuid"]
