...
os.system('cd alphaz;yes | git pull')
os.system("cd alphaz/documentations;mkdocs build")
print(os.getcwd())

version = "0.6.6"

name = input(f"Do you want to deploy {version=} ? (y/n)")
...
'zeep',
'pysftp',
'ldap3','cx_Oracle','pycryptodome','concurrent_log_handler',"flask_cors","pylint","bandit","black",
'unidecode']
...
os.system(f"conda activate alphaz;pip install alphaz=={version};pip install alphaz=={version}")