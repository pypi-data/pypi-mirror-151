...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, latest_version_href=None, retain_repo_versions=None, pulp_created=None, versions_href=None, pulp_labels=None, manifest_signing_service=None, pulp_href=None, name=None, description=None, local_vars_configuration=None):  # noqa: E501
