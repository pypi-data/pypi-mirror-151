...
class ContainerContainerPushRepository(object):
    ...
    def __init__(self, name=None, description=None, retain_repo_versions=None, pulp_labels=None, manifest_signing_service=None, local_vars_configuration=None):  # noqa: E501
