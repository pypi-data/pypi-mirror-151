...
def run_forecast_ensemble(
    ...
    df = dataframe.sort_values(by=date_column)
    ...
    return_dataframe["predicted_values_Ensemble"] = return_dataframe[ensemble_prediction_columns].sum(axis=1, min_count=1)
    ...
    return_dataframe["forecast_values_Ensemble"] = return_dataframe[ensemble_forecast_columns].sum(axis=1, min_count=1)
