    ...
    def get_patching_list(self):
        return [
            AlvinPatch(
                ...
                supported_versions=["2.2.3", "2.2.3+composer", "2.1.4", "2.1.4+composer"],
            ...
            AlvinPatch(
                ...
                supported_versions=["1.10.15", "2.2.3+composer", "2.2.3", "2.1.4", "2.1.4+composer"],
            ...
            AlvinPatch(
                ...
                supported_versions=[
                    ...
                    "1.10.15+composer",
                    "2.2.3",
                    "2.2.3+composer", "2.1.4", "2.1.4+composer"
                ],
    ...
    def get_target_pipelines(self):
        return [
            AlvinPipelineCreator(
                ...
                supported_versions=["2.2.3", "2.1.4"],
            ),
            AlvinPipelineCreator(
                package_name="apache-airflow",
