...
class AlvinBackendComposerMeta(AlvinBackendMeta):
    ...
    def patch_scheduler_functions(cls):
        ...
        if airflow_package.version in ("2.1.4", "2.1.4+composer"):
            from alvin_integration.producers.airflow.patch.functions_214 import update_state
        elif airflow_package.version in ("2.2.3", "2.2.3+composer"):
            ...
            from alvin_integration.producers.airflow.patch.functions_legacy import update_state
