...
from .baseurlscraper import base_url
...
class doodstream_conf:
    ...
    def account_reports(self, last = None, from_date = None, to_date = None):
        ...
        '''
        url = f"{self.base_url}api/account/stats?key={self.api_key}&last={last}&from_date={from_date}&to_date={to_date}"
        return self.req(url)
    ...
    def account_dmca(self):
        ...
        '''
        url = f"{self.base_url}api/account/dmca/list?key={self.api_key}"
        return self.req(url)
    ...
    def copy_video(self, file_id, folder_id):
        ...
        '''
        url = f"{self.base_url}api/file/clone?key={self.api_key}&file_code={file_id}&fld_id={folder_id}"
        return self.req(url)
    ...
    def remote_upload(self, direct_link, new_title, folder_id):
        ...
        try:
            if new_title != None:
                url = f"{self.base_url}api/upload/url?key={self.api_key}&url={direct_link}&fld_id={folder_id}&title={new_title}"
                return self.req(url)
            else:
    ...
    def remote_upload_list(self):
        ...
        url = f"{self.base_url}api/urlupload/list?key={self.api_key}"        
        return self.req(url)
    
    def remote_upload_status(self, file_id):
        '''Get Only status of remote uploads'''
        url = f"{self.base_url}api/urlupload/status?key={self.api_key}&file_id={file_id}"
        return self.req(url)
    
    def remote_upload_slots(self):
        'Check slots for remote uploads'
        url = f"{self.base_url}api/urlupload/slots?key={self.api_key}"
        return self.req(url)
    ...
    def remote_upload_action(self,restart_errors, clear_errors, clear_all, delete_all):
        ...
        '''
        url = f"{self.base_url}api/urlupload/actions?key={self.api_key}&restart_errors={restart_errors}&clear_errors={clear_errors}&clear_all={clear_all}&delete_all={delete_all}"
        return self.req(url)
    ...
    def folder_create(self, folder_name, parent_folder_id = None):
        ...
        '''
        url = f"{self.base_url}api/folder/create?key={self.api_key}&folder_name={folder_name}&parent_id={parent_folder_id}"
        return self.req(url)
    ...
    def folder_rename(self, folder_id, new_name):
        ...
        '''
        url = f"{self.base_url}api/folder/rename?key={self.api_key}&folder_id={folder_id}&new_name={new_name}"
        return self.req(url)
    ...
    def file_list(self, page, per_page, fld_id):
        ...
        '''
        url = f"{self.base_url}api/file/list?key={self.api_key}&page={page}&per_page={per_page}&fld_id={fld_id}"
        return self.req(url)
    ...
    def file_status(self, file_id):
        ...
        Args:
            file_id (str): file id
        '''
        url = f"{self.base_url}api/file/check?key={self.api_key}&file_code={file_id}"
        return self.req(url)
    ...
    def file_info(self, file_id):
        ...
        Args:
            file_id (str): file id
        '''
        url = f"{self.base_url}api/file/info?key={self.api_key}&file_code={file_id}"
        return self.req(url)
    ...
    def file_image(self, file_id):
        ...
        Args:
            file_id (str): file id
        '''
        url = f"{self.base_url}api/file/image?key={self.api_key}&file_code={file_id}"
        return self.req(url)
    ...
    def file_rename(self, file_id, new_name):
        ...
        Args:
            ...
            new_name (str): new name
        '''
        url = f"{self.base_url}api/file/rename?key={self.api_key}&file_code={file_id}&title={new_name}"
        return self.req(url)
    ...
    def file_search(self, search_term):
        ...
        '''
        url = f"{self.base_url}api/file/search?key={self.api_key}&search_term={search_term}"
        return self.req(url)
