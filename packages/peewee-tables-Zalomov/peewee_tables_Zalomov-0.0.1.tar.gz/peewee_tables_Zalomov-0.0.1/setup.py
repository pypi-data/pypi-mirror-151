...
setuptools.setup(
	...
	name="peewee_tables_Zalomov",
	# Номер версии вашего пакета. Обычно используется семантическое управление версиями.
	version="0.0.1",
	# Имя автора.
	author="Roman Zalomov",
	# Его почта.
	author_email="romchik349@gmail.com",
	# Краткое описание, которое будет показано на странице PyPi.
	description="Just some fun things to do with your tables, test module, which doesn't contain anything useful",
	...
	url="https://github.com/BangerVanos/PeeWeeZal",
