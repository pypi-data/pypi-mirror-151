...
class ContextHead(nn.Module):
    ...
    def __init__(self, deep_dims, item_embedding, deep_embed_dims=100, num_wide=0, num_shared=1, 
                 agent_embedding_weight=None, offer_embedding_weight=None):
        super().__init__()
...
class BST(nn.Module):
    def __init__(self, deep_dims, seq_dim, seq_embed_dim, deep_embed_dims, seq_hidden_size,
                 ...
                 item_embedding_weight=None, agent_embedding_weight=None, offer_embedding_weight=None):
        super().__init__()
        ...
        self.context_head = ContextHead(
            ...
            agent_embedding_weight=agent_embedding_weight,
            offer_embedding_weight=offer_embedding_weight,
