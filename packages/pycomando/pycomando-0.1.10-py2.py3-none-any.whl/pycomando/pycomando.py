...
class Comando:
    def __init__(self, yml='args.yml', elasticsearchlink=None, redis_server=None, redis_port: int = 0, f__version__init__=False, log_level=None, redis_exp_time=300):
    ...
    def runCMD_cached(self, command, stdin_str=None, ignore_return_code=False, show_exp_redis=False):
        ...
        if self.redis_client:
            self.redis_client.set(f"cmd:{command}", out, ex=self.redis_exp_time)
