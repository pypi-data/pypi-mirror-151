...
class Sign02:
    ...
    def buy(self, df):
        ...
        df.loc[con1 & con2 & con3 & con4, 'buy_signal'] = True
        return df
    ...
    def sell(self, df):
        ...
        df.loc[con1 & con2 & con3 & con4, 'sell_signal'] = True
        return df
    ...
    def __preprocessing(self, df):
        ...
        df = self.__linear_regression(df, 'log_close', slope_window)
    ...
    def __linear_regression(self, df, feature, window):
