...
class Comparison:
    ...
    def add_data_in_station(self, stationKey:str, data:list=[], datesBegin:list=[], datesEnd:list=[], deltaT:list=[], labels:list=[], colors:list=[], typeOfTraits:list=[], addDataObj:list=[]):
        ...
        if(addDataObj==[]):
            ...
            self.add_data_in_station_from_Subbasin(stationKey, addDataObj)
        if(labels!=[]):
    ...
    def add_data_in_station_from_Subbasin(self, stationKey:str, myAddDataObj:list):
