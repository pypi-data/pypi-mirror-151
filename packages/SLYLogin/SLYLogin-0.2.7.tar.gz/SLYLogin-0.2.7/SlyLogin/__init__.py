...
def betterRegister(accountsFile):
    username = input("Username: ")
    createPass = input("Generate password? (y/n)")
    if createPass == 'y' or createPass == 'Y':
        ...
        print("Registering...")
        sleep(1)
        register(username, password, "accounts.txt")
        return
    elif createPass == 'n' or createPass == 'N':
