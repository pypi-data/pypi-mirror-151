...
from classiq.interface.generator import function_call as function_call, function_param_list as function_param_list, function_params as function_params
from classiq.interface.generator.functions import FunctionLibraryData as FunctionLibraryData
...
class FunctionHandler(abc.ABC, metaclass=abc.ABCMeta):
    ...
    def apply(self, function_name: str, in_wires: Optional[Union[Dict[str, QregOrWire], QuantumRegister]] = ..., out_wires: Optional[Union[Dict[str, QregOrWire], QuantumRegister]] = ..., is_inverse: bool = ..., call_name: Optional[str] = ...) -> Dict[str, Wire]: ...
