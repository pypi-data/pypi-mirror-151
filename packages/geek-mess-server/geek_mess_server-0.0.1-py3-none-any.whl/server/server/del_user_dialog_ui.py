...
# Form implementation generated from reading ui file 'del_user_dialog_ui.ui'
#
...
class Ui_DelUser(object):
    def setupUi(self, DelUser):
        ...
        DelUser.setPalette(palette)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("minus.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        DelUser.setWindowIcon(icon)
        self.layoutWidget = QtWidgets.QWidget(DelUser)
        ...
        font = QtGui.QFont()
        font.setPointSize(10)
        self.pushButtonDelUser.setFont(font)
    ...
    def retranslateUi(self, DelUser):
        ...
        DelUser.setWindowTitle(_translate("DelUser", "Выберете пользователя для удаления"))
        self.labelSelectUser.setText(_translate("DelUser", "Выберите контакт для удаления:"))
        self.pushButtonCancel.setText(_translate("DelUser", "Отмена"))
        self.pushButtonDelUser.setText(_translate("DelUser", "Удалить"))
