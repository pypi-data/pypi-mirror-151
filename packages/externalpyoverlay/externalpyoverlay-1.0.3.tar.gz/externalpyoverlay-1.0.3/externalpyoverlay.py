...
class Overlay:
    ...
    def update_overlay(self) -> None:
        ...
        sleep(self.__delay)
        self.__window_rectangle = win32gui.GetWindowRect(self.__search_window_hwnd)
        print(self.__window_rectangle)
        win32gui.MoveWindow(self.__overlay_hwnd, self.__window_rectangle[0], self.__window_rectangle[1], self.__window_rectangle[2], self.__window_rectangle[3], True)
