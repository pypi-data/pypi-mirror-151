Thai Language Toolkit Project  version 1.5.3
============================================
...
Updates:
--------
Version 1.5 : add WordAna and TextAna. WordAna return the output as an object with word properties. 

res = tltk.nlp.WordAna(w) => res.char (no of char in a word), res.syl (no of syllables), res.corrtone (no of tone match the same tone marker), res.corrfinal (no of final consonant sound match the final character -ก -ด -ง -น -ม -ย -ว), res.karan (no of karan), res.cluster (no of cluster consonant), res.lead (no of leading consonant), res.doubvowel (no of complex vowel)
