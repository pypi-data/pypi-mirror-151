...
# -*- coding: utf-8 -*-
#########################################################
## Thai Language Toolkit : version  1.5.3
...
def TextAna(alltext):
    ...
    for text in alltext.split("\n+"):
        ...
        for u in utext.split("<u/>"):
            ...
            for w in wlst:
                ...
                wrdchar_lst.append(wrd['char'])
                wrdsyl_lst.append(wrd['syl'])
                txt.corrtone += 1  ## no of correct tone form and phone
                txt.corrfinal += 1  ## no of correct final consonant กก กด กง กน กม เกย เกอว
                txt.karan += 1 ## no of karan
                txt.cluster += 1  ## no of cluster
                txt.doubvowel += 1 ## no of double vowel
    ...
    txt.avgcluster = txt.cluster/txt.totalword  ## no of cluster
    txt.avgdoubvowel = txt.doubvowel/txt.totalword ## no of double vowel
    return(vars(txt))   ### return a class object as a dictionary using vars
'''
