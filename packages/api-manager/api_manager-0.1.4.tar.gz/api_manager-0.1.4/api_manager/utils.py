...
from api_manager.settings import PROJECT_ROOT
...
def response_log_message(response):
    ...
    with open(PROJECT_ROOT + '/api_manager/templates/log_template.html', 'r') as template:
