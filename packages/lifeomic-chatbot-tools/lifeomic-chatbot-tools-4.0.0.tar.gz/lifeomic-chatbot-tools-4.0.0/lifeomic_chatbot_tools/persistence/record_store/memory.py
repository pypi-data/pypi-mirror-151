...
from lifeomic_chatbot_tools.persistence.record_store.base import IRecordStore, TIRecord


class InMemoryRecordStore(t.Generic[TIRecord], IRecordStore[TIRecord]):
    r"""
    ...
    def __init__(self):
        ...
        self._db: t.Dict[str, TIRecord] = {}

    def save(self, record: TIRecord):
        self._db[record.get_id()] = record

    def get(self, id_: str) -> t.Optional[TIRecord]:
    ...
    def get_all(self, **where_equals) -> t.Iterable[TIRecord]:
    ...
    @staticmethod
    def _matches(record: TIRecord, **where_equals) -> bool:
