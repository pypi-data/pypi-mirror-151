...
DC_TOOLS = [ 'system-tools', 'dev-tools', 'app-services','dataset-services','dl-model-services','dl-model-training-services',
                'dlstreamer-services','edge-deployment-services','edge-inference-app-services',
                'edge-to-cloud-app-services','k8s-tools','intel-dev-tools']
...
SUB_TOOLS={
  ...
  "app-services":['telemetry','log-anlytics','perf-analysis','video-playback','rtsp-streamer','configs','benchmark-report'],  
  "dataset-services":['intel','partner','public','synthetic'],
  "dl-model-services":['dl-model-tools', 'inference-runtimes', 'model-zoo'],
  "dl-model-training-services":['data-engineering-tools', 'datasets', 'model-zoo', 'training-framework'],
  "dlstreamer-services":['audio-pipelines','dl-streamer-tools','multi-sensory-pipelines','video-pipelines'],
...
TOOLS={
  ...
  "inference-runtimes":['intel-optimized-pytorch', 'intel-optimized-tensorflow','onxx', 'openvino-2022.1', 'openvino-addon-tensorflow'],
  ...
  "model-zoo":['omz'],
  "training-framework":['cnvrg','intel-optimized-pytorch','intel-optimized-tensorflow','kubeflow','one-api','sonoma-creek'],
  ...
  "seo-reference-implementations":['intelligent-connection-management-for-automated-handover','smartvr–livestreaming-of-immersive-media','telehealth-remote-monitoring','wireless-network-ready-intelligent-traffic-management','wireless-network-ready-pcb-defect-detection'],
