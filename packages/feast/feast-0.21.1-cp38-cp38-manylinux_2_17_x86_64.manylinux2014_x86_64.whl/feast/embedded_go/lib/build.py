...
# gopy build -output /project/build/lib.linux-x86_64-cpython-38/feast/embedded_go/lib -vm /opt/python/cp38-cp38/bin/python -no-make github.com/feast-dev/feast/go/embedded
