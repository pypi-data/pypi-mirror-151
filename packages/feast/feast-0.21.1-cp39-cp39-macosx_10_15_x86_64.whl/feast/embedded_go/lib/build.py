# python build stubs for package embedded
...
mod = Module('_embedded')
mod.add_include('"embedded_go.h"')
...
mod.add_function('Map_string_int32_CTor', retval('int64_t'), [])
mod.add_function('Map_string_int32_len', retval('int'), [param('int64_t', 'handle')])
mod.add_function('Map_string_int32_elem', retval('int32_t'), [param('int64_t', 'handle'), param('char*', '_ky')])
mod.add_function('Map_string_int32_contains', retval('bool'), [param('int64_t', 'handle'), param('char*', '_ky')])
mod.add_function('Map_string_int32_set', None, [param('int64_t', 'handle'), param('char*', 'key'), param('int32_t', 'value')])
mod.add_function('Map_string_int32_delete', None, [param('int64_t', 'handle'), param('char*', '_ky')])
mod.add_function('Map_string_int32_keys', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('embedded_OnlineFeatureService_CTor', retval('int64_t'), [])
add_checked_function(mod, 'embedded_OnlineFeatureService_GetEntityTypesMap', retval('int64_t'), [param('int64_t', '_handle'), param('int64_t', 'featureRefs')])
add_checked_function(mod, 'embedded_OnlineFeatureService_GetEntityTypesMapByFeatureService', retval('int64_t'), [param('int64_t', '_handle'), param('char*', 'featureServiceName')])
add_checked_function(mod, 'embedded_OnlineFeatureService_GetOnlineFeatures', retval('char*'), [param('int64_t', '_handle'), param('int64_t', 'featureRefs'), param('char*', 'featureServiceName'), param('int64_t', 'entities'), param('int64_t', 'requestData'), param('bool', 'fullFeatureNames'), param('int64_t', 'output')])
add_checked_function(mod, 'embedded_OnlineFeatureService_StartGprcServer', retval('char*'), [param('int64_t', '_handle'), param('char*', 'host'), param('int64_t', 'port')])
add_checked_function(mod, 'embedded_OnlineFeatureService_StartGprcServerWithLoggingDefaultOpts', retval('char*'), [param('int64_t', '_handle'), param('char*', 'host'), param('int64_t', 'port'), param('PyObject*', 'writeLoggedFeaturesCallback', transfer_ownership=False)])
add_checked_function(mod, 'embedded_OnlineFeatureService_StartGprcServerWithLogging', retval('char*'), [param('int64_t', '_handle'), param('char*', 'host'), param('int64_t', 'port'), param('PyObject*', 'writeLoggedFeaturesCallback', transfer_ownership=False), param('int64_t', 'loggingOpts')])
add_checked_function(mod, 'embedded_OnlineFeatureService_Stop', None, [param('int64_t', '_handle'), param('bool', 'goRun')])
mod.add_function('embedded_OnlineFeatureServiceConfig_CTor', retval('int64_t'), [])
mod.add_function('embedded_OnlineFeatureServiceConfig_RepoPath_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('embedded_OnlineFeatureServiceConfig_RepoPath_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
mod.add_function('embedded_OnlineFeatureServiceConfig_RepoConfig_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('embedded_OnlineFeatureServiceConfig_RepoConfig_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
mod.add_function('embedded_DataTable_CTor', retval('int64_t'), [])
mod.add_function('embedded_DataTable_DataPtr_Get', retval('uint64_t'), [param('int64_t', 'handle')])
mod.add_function('embedded_DataTable_DataPtr_Set', None, [param('int64_t', 'handle'), param('uint64_t', 'val')])
mod.add_function('embedded_DataTable_SchemaPtr_Get', retval('uint64_t'), [param('int64_t', 'handle')])
mod.add_function('embedded_DataTable_SchemaPtr_Set', None, [param('int64_t', 'handle'), param('uint64_t', 'val')])
mod.add_function('embedded_LoggingOptions_CTor', retval('int64_t'), [])
mod.add_function('embedded_LoggingOptions_ChannelCapacity_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('embedded_LoggingOptions_ChannelCapacity_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
mod.add_function('embedded_LoggingOptions_EmitTimeout_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('embedded_LoggingOptions_EmitTimeout_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
mod.add_function('embedded_LoggingOptions_WriteInterval_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('embedded_LoggingOptions_WriteInterval_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
mod.add_function('embedded_LoggingOptions_FlushInterval_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('embedded_LoggingOptions_FlushInterval_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
add_checked_function(mod, 'embedded_NewOnlineFeatureService', retval('int64_t'), [param('int64_t', 'conf'), param('PyObject*', 'transformationCallback', transfer_ownership=False)])

mod.generate(open('embedded.c', 'w'))
