...
# gopy build -output /project/build/lib.linux-x86_64-cpython-310/feast/embedded_go/lib -vm /opt/python/cp310-cp310/bin/python -no-make github.com/feast-dev/feast/go/embedded
