...
/* package github.com/feast-dev/feast/build/lib.macosx-10.15-x86_64-cpython-310/feast/embedded_go/lib */
...
extern long long int Map_string_int32_CTor();
extern GoInt Map_string_int32_len(long long int handle);
extern long int Map_string_int32_elem(long long int handle, char* _ky);
extern char Map_string_int32_contains(long long int handle, char* _ky);
extern void Map_string_int32_set(long long int handle, char* _ky, long int _vl);
extern void Map_string_int32_delete(long long int handle, char* _ky);
extern long long int Map_string_int32_keys(long long int handle);

// --- wrapping struct: embedded.OnlineFeatureService ---
extern long long int embedded_OnlineFeatureService_CTor();
extern long long int embedded_OnlineFeatureService_GetEntityTypesMap(long long int _handle, long long int featureRefs);
extern long long int embedded_OnlineFeatureService_GetEntityTypesMapByFeatureService(long long int _handle, char* featureServiceName);
extern char* embedded_OnlineFeatureService_GetOnlineFeatures(long long int _handle, long long int featureRefs, char* featureServiceName, long long int entities, long long int requestData, char fullFeatureNames, long long int output);
extern char* embedded_OnlineFeatureService_StartGprcServer(long long int _handle, char* host, long long int port);
extern char* embedded_OnlineFeatureService_StartGprcServerWithLoggingDefaultOpts(long long int _handle, char* host, long long int port, PyObject* writeLoggedFeaturesCallback);
extern char* embedded_OnlineFeatureService_StartGprcServerWithLogging(long long int _handle, char* host, long long int port, PyObject* writeLoggedFeaturesCallback, long long int loggingOpts);
extern void embedded_OnlineFeatureService_Stop(long long int _handle, char goRun);

// --- wrapping struct: embedded.OnlineFeatureServiceConfig ---
extern long long int embedded_OnlineFeatureServiceConfig_CTor();
extern char* embedded_OnlineFeatureServiceConfig_RepoPath_Get(long long int handle);
extern void embedded_OnlineFeatureServiceConfig_RepoPath_Set(long long int handle, char* val);
extern char* embedded_OnlineFeatureServiceConfig_RepoConfig_Get(long long int handle);
extern void embedded_OnlineFeatureServiceConfig_RepoConfig_Set(long long int handle, char* val);

// --- wrapping struct: embedded.DataTable ---
extern long long int embedded_DataTable_CTor();
extern long long unsigned int embedded_DataTable_DataPtr_Get(long long int handle);
extern void embedded_DataTable_DataPtr_Set(long long int handle, long long unsigned int val);
extern long long unsigned int embedded_DataTable_SchemaPtr_Get(long long int handle);
extern void embedded_DataTable_SchemaPtr_Set(long long int handle, long long unsigned int val);

// --- wrapping struct: embedded.LoggingOptions ---
extern long long int embedded_LoggingOptions_CTor();
extern long long int embedded_LoggingOptions_ChannelCapacity_Get(long long int handle);
extern void embedded_LoggingOptions_ChannelCapacity_Set(long long int handle, long long int val);
extern long long int embedded_LoggingOptions_EmitTimeout_Get(long long int handle);
extern void embedded_LoggingOptions_EmitTimeout_Set(long long int handle, long long int val);
extern long long int embedded_LoggingOptions_WriteInterval_Get(long long int handle);
extern void embedded_LoggingOptions_WriteInterval_Set(long long int handle, long long int val);
extern long long int embedded_LoggingOptions_FlushInterval_Get(long long int handle);
extern void embedded_LoggingOptions_FlushInterval_Set(long long int handle, long long int val);
extern long long int embedded_NewOnlineFeatureService(long long int conf, PyObject* transformationCallback);
