...
from vectice.models.artifact import Artifact
...
class MLflowIntegration(AbstractIntegration):
    def __init__(self, mlflow_client: MlflowClient, vectice_client: Client, auto_log: Optional[bool] = False):
        ...
        self._output_artifacts: List[Artifact] = []
    ...
    def _extract_outputs(self, mlflow_run: MlflowRun, experiment: MlflowExperiment, run: Run) -> List[Artifact]:
