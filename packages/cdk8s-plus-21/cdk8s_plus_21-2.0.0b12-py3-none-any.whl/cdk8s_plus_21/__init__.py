...
@jsii.data_type(
    jsii_type="cdk8s-plus-21.ApiResourceOptions",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="cdk8s-plus-21.ClusterRolePolicyRule",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="cdk8s-plus-21.ContainerResources",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="cdk8s-plus-21.DnsOption",
    jsii_struct_bases=[],
...
@jsii.enum(jsii_type="cdk8s-plus-21.DnsPolicy")
...
class Env(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-21.Env"):
...
class EnvFrom(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-21.EnvFrom"):
...
@jsii.data_type(
    jsii_type="cdk8s-plus-21.GroupProps",
    jsii_struct_bases=[],
...
@jsii.interface(jsii_type="cdk8s-plus-21.IApiEndpoint")
...
class _IApiEndpointProxy:
    ...
    __jsii_type__: typing.ClassVar[str] = "cdk8s-plus-21.IApiEndpoint"
...
@jsii.interface(jsii_type="cdk8s-plus-21.IApiResource")
...
class _IApiResourceProxy:
    ...
    __jsii_type__: typing.ClassVar[str] = "cdk8s-plus-21.IApiResource"
...
@jsii.interface(jsii_type="cdk8s-plus-21.INamespaceSelector")
class INamespaceSelector(typing_extensions.Protocol):
...
class _INamespaceSelectorProxy:
    ...
    __jsii_type__: typing.ClassVar[str] = "cdk8s-plus-21.INamespaceSelector"
...
@jsii.interface(jsii_type="cdk8s-plus-21.IPodSelector")
class IPodSelector(typing_extensions.Protocol):
...
class _IPodSelectorProxy:
    ...
    __jsii_type__: typing.ClassVar[str] = "cdk8s-plus-21.IPodSelector"
...
@jsii.interface(jsii_type="cdk8s-plus-21.IRole")
...
class _IRoleProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "cdk8s-plus-21.IRole"
    pass
...
@jsii.interface(jsii_type="cdk8s-plus-21.ISubject")
...
class _ISubjectProxy:
    ...
    __jsii_type__: typing.ClassVar[str] = "cdk8s-plus-21.ISubject"
...
class LabelExpression(
    metaclass=jsii.JSIIMeta,
    jsii_type="cdk8s-plus-21.LabelExpression",
):
...
class LabelSelector(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-21.LabelSelector"):
    ...
    def of(
        cls,
        options: typing.Optional["LabelSelectorOptions"] = None,
    ) -> "LabelSelector":
        '''
        :param options: -
        '''
...
class LabelSelectorOptions(
    metaclass=jsii.JSIIMeta,
    jsii_type="cdk8s-plus-21.LabelSelectorOptions",
):
    ...
    def expressions(self) -> typing.Optional[typing.List[LabelExpression]]:
        ...
        return typing.cast(typing.Optional[typing.List[LabelExpression]], jsii.get(self, "expressions"))
...
@jsii.data_type(
    jsii_type="cdk8s-plus-21.LabelSelectorRequirement",
    jsii_struct_bases=[],
...
class LabeledNode(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-21.LabeledNode"):
...
class NamedNode(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-21.NamedNode"):
...
@jsii.data_type(
    jsii_type="cdk8s-plus-21.NamespaceSelectorConfig",
    jsii_struct_bases=[],
...
@jsii.implements(INamespaceSelector)
class Namespaces(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-21.Namespaces"):
    ...
    def __init__(
        ...
        :param labels: -
        '''
        jsii.create(self.__class__, self, [expressions, names, labels])

    @jsii.member(jsii_name="all") # type: ignore[misc]
    @builtins.classmethod
    def all(cls) -> "Namespaces":
        '''Select all namespaces.'''
        return typing.cast("Namespaces", jsii.sinvoke(cls, "all", []))
    ...
    def select(
        ...
        *,
        ...
        return typing.cast("Namespaces", jsii.sinvoke(cls, "select", [options]))
...
@jsii.data_type(
    jsii_type="cdk8s-plus-21.NamespacesSelectOptions",
    jsii_struct_bases=[],
...
class Node(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-21.Node"):
    '''Represents a node in the cluster.'''

    def __init__(self) -> None:
        jsii.create(self.__class__, self, [])

    @jsii.member(jsii_name="labeled") # type: ignore[misc]
    @builtins.classmethod
    ...
    @jsii.member(jsii_name="named") # type: ignore[misc]
    @builtins.classmethod
    ...
    @jsii.member(jsii_name="tainted") # type: ignore[misc]
    @builtins.classmethod
...
class NodeLabelQuery(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-21.NodeLabelQuery"):
...
class NodeTaintQuery(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-21.NodeTaintQuery"):
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="evictAfter")
    def evict_after(self) -> typing.Optional[cdk8s.Duration]:
        return typing.cast(typing.Optional[cdk8s.Duration], jsii.get(self, "evictAfter"))
...
@jsii.data_type(
    jsii_type="cdk8s-plus-21.NodeTaintQueryOptions",
    jsii_struct_bases=[],
...
class NonApiResource(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-21.NonApiResource"):
...
class PodDns(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-21.PodDns"):
...
@jsii.data_type(
    jsii_type="cdk8s-plus-21.PodDnsProps",
    jsii_struct_bases=[],
    name_mapping={
        "hostname": "hostname",
...
class PodScheduling(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-21.PodScheduling"):
...
@jsii.data_type(
    jsii_type="cdk8s-plus-21.PodSchedulingAttractOptions",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="cdk8s-plus-21.PodSchedulingColocateOptions",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="cdk8s-plus-21.PodSchedulingSeparateOptions",
    jsii_struct_bases=[],
    name_mapping={"topology": "topology", "weight": "weight"},
)
...
@jsii.data_type(
    jsii_type="cdk8s-plus-21.PodSelectOptions",
    jsii_struct_bases=[],
    name_mapping={
...
class PodSelectOptions:
    ...
    def __repr__(self) -> str:
        return "PodSelectOptions(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.data_type(
    jsii_type="cdk8s-plus-21.PodSelectorConfig",
    jsii_struct_bases=[],
...
class PodSelectorConfig:
    def __init__(
        ...
        *,
        ...
        namespaces: typing.Optional[NamespaceSelectorConfig] = None,
    ) -> None:
...
class Pods(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-21.Pods"):
    ...
    def __init__(
        ...
        :param namespaces: -
        '''
        jsii.create(self.__class__, self, [expressions, labels, namespaces])
    ...
    def select(
        ...
        *,
        ...
        return typing.cast("Pods", jsii.sinvoke(cls, "select", [options]))
...
class Role(Resource, metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-21.Role"):
...
class RoleBinding(
    Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="cdk8s-plus-21.RoleBinding",
):
...
@jsii.data_type(
    jsii_type="cdk8s-plus-21.RoleBindingProps",
...
@jsii.data_type(
    jsii_type="cdk8s-plus-21.RolePolicyRule",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="cdk8s-plus-21.RoleProps",
    jsii_struct_bases=[ResourceProps],
...
@jsii.enum(jsii_type="cdk8s-plus-21.TaintEffect")
...
class TaintedNode(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-21.TaintedNode"):
...
class Topology(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-21.Topology"):
...
class User(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-21.User"):
    '''Represents a user.'''
...
@jsii.data_type(
    jsii_type="cdk8s-plus-21.UserProps",
    jsii_struct_bases=[],
    name_mapping={"name": "name"},
)
class UserProps:
...
class WorkloadScheduling(
    PodScheduling,
    metaclass=jsii.JSIIMeta,
    jsii_type="cdk8s-plus-21.WorkloadScheduling",
):
...
@jsii.data_type(
    jsii_type="cdk8s-plus-21.WorkloadSchedulingSpreadOptions",
    jsii_struct_bases=[],
    name_mapping={"topology": "topology", "weight": "weight"},
)
...
class AbstractPod(
    Resource,
    metaclass=jsii.JSIIAbstractClass,
    jsii_type="cdk8s-plus-21.AbstractPod",
):
    def __init__(
        self,
        scope: constructs.Construct,
...
@jsii.data_type(
    jsii_type="cdk8s-plus-21.AbstractPodProps",
    jsii_struct_bases=[ResourceProps],
    name_mapping={
        "metadata": "metadata",
...
class ApiResource(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-21.ApiResource"):
...
class ClusterRoleBinding(
    Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="cdk8s-plus-21.ClusterRoleBinding",
):
...
@jsii.data_type(
    jsii_type="cdk8s-plus-21.ClusterRoleBindingProps",
    jsii_struct_bases=[ResourceProps],
    name_mapping={"metadata": "metadata", "role": "role"},
)
...
@jsii.data_type(
    jsii_type="cdk8s-plus-21.ClusterRoleProps",
    jsii_struct_bases=[ResourceProps],
    name_mapping={
        "metadata": "metadata",
...
@jsii.implements(ISubject)
class Group(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-21.Group"):
    '''Represents a group.'''
...
@jsii.interface(jsii_type="cdk8s-plus-21.IClusterRole")
...
class _IClusterRoleProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "cdk8s-plus-21.IClusterRole"
    pass
...
@jsii.implements(INamespaceSelector)
class Namespace(Resource, metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-21.Namespace"):
...
@jsii.data_type(
    jsii_type="cdk8s-plus-21.NamespaceProps",
    jsii_struct_bases=[ResourceProps],
    name_mapping={"metadata": "metadata"},
)
...
class Pod(AbstractPod, metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-21.Pod"):
...
class Workload(
    AbstractPod,
    metaclass=jsii.JSIIAbstractClass,
    jsii_type="cdk8s-plus-21.Workload",
):
...
@jsii.data_type(
    jsii_type="cdk8s-plus-21.WorkloadProps",
    jsii_struct_bases=[AbstractPodProps],
    name_mapping={
        "metadata": "metadata",
        "automount_service_account_token": "automountServiceAccountToken",
...
class ClusterRole(
    Resource,
    metaclass=jsii.JSIIMeta,
    jsii_type="cdk8s-plus-21.ClusterRole",
):
...
class DaemonSet(Workload, metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-21.DaemonSet"):
...
class Job(Workload, metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-21.Job"):
