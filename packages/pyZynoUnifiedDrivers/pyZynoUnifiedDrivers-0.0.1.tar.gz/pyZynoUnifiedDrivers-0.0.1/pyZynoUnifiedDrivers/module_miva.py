...
class SerialComm:
    ...
    def read_single_event_log(self, index):
        ...
        return_text = self.write('RE' + event_log_index)
...
#         print(len(return_text))
    ...
    def set_pump_sn(self, serial_number):
        ...
        return_text = self.write('WN' + serial_number)
        # print(len(return_text))
...
#                     occlusion_thresholds['down'] = int(return_text[6:10], 16)
    ...
    def set_battery_calib(self, calib_factor):
        ...
        return_text = self.write('WA' + calib_factor_hex)
    ...
    def send_command(self, cmd):
        ...
        if cmd in ['INFO']:
            ...
            sent_text = ':KEY:LIST?'
            return_text = self.write(sent_text)
            raw_key_lsit = []
            ...
            # :protocol:rate?
            # :key:list?
            return_text = self.write(cmd.upper())
    ...
    def press_key(self, key_type, key_duration):
        ...
        return_text = self.write(key_command)
    ...
    def send_rx_initialize(self, rx):
        ...
        return_text = self.write(li_command)
        print('{0:6s} : {1}'.format('return', return_text))
        # print(len(return_text))
    ...
    def write_pump_time(self, time_stamp=None):
        ...
        if time_stamp == None:
            ...
            return_text = self.write(wc_command)
            # print(return_text)
            # print(len(return_text))
