...
import signadot_sdk_snapshot.models
from signadot_sdk_snapshot import rest
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'Swagger-Codegen/0.2.4.dev5/python'
    ...
    def accept_version(self):
        ...
        return self.default_headers['Accept-Version']

    @accept_version.setter
    def accept_version(self, value):
        self.default_headers['Accept-Version'] = value
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(signadot_sdk_snapshot.models, klass)
