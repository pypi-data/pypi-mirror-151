...
VERSION : 1.0
FICHIER : Resource.py
    - Permet de stocker certaines données dune ressources 
'''
...
class Resource():
    ...
    def __getattr__(self, attr):
        ...
        match attr:
            ...
            case "fileName":
                return self.universalMetadata.fileName.name
            case "pathName":
                return self.universalMetadata.pathName.path
            case "sizeUncompressed":
                return self.universalMetadata.sizeUncompressed
            case "extension":
                return self.universalMetadata.extension.name
            case "creationDate":
