...
from .curve_generator.lines import _tpl_curve_generator_lines
...
class _tpl_curve:
  ...
  def _set_plottype(self, type: str = 'xy'):
    ...
    if type == 'xy' or type == 'only points' or type == 'scatter':
      gen_cls = _tpl_curve_generator
    elif type == 'bar' or type == 'ybar' or type == 'hist' or type == 'histogram':
      gen_cls = _tpl_curve_generator_ybar
    elif type == 'interval' or type == 'ybar interval':
      gen_cls = _tpl_curve_generator_ybarinterval
    elif type == 'lines' or type == 'line' or type == 'continuous':
      gen_cls = _tpl_curve_generator_lines
    else:
