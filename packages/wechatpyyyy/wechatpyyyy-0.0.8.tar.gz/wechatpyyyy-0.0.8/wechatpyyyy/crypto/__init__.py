...
from wechatpyyyy.utils import to_text, to_binary, WeChatSigner
from wechatpyyyy.exceptions import (
    InvalidAppIdException,
    InvalidMchIdException,
    InvalidSignatureException
)
from wechatpyyyy.crypto.base import BasePrpCrypto, WeChatCipher, BaseRefundCrypto
from wechatpyyyy.crypto.pkcs7 import PKCS7Encoder
...
class BaseWeChatCrypto(object):
    ...
    def _encrypt_message(self,
                         ...
                         timestamp=None,
                         crypto_class=None):
        from wechatpyyyy.replies import BaseReply
