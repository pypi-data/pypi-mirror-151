...
from wechatpyyyy.client import WeChatComponentClient
from wechatpyyyy.constants import WeChatErrorCode
from wechatpyyyy.crypto import WeChatCrypto
from wechatpyyyy.exceptions import APILimitedException, WeChatClientException, WeChatOAuthException, \
    WeChatComponentOAuthException
from wechatpyyyy.fields import DateTimeField, StringField
from wechatpyyyy.messages import MessageMetaClass
from wechatpyyyy.session.memorystorage import MemoryStorage
from wechatpyyyy.utils import get_querystring, json, to_binary, to_text, ObjectDict
...
class BaseWeChatComponent(object):
    API_BASE_URL = 'http://api.weixin.qq.com/cgi-bin'
    ...
    def __init__(self,
        ...
        if isinstance(session, six.string_types):
            ...
            from wechatpyyyy.session.shovestorage import ShoveStorage
