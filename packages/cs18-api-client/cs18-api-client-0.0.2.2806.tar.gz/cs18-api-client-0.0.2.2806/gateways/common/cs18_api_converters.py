...
from gateways.common.cs18_api_responses import (GetSpacesResponse, CreateAccountFinalizeResponse, ParameterStoreItem,
                                                ...
                                                GrainResponse, BlueprintRawResponse, BlueprintCandidateResponse)
...
class Converters:
    ...
    @staticmethod
    def create_blueprint_raw_response(blueprint: dict) -> BlueprintRawResponse:
        return BlueprintRawResponse(blueprint["content"])
    ...
    def create_blueprint_response(blueprint: dict) -> BlueprintResponse:
        ...
        return BlueprintResponse(
            ...
            spec_version=blueprint.get("spec_version"),
            grains=[
                Converters.create_grain_response(grain)
                for grain in blueprint.get("grains")
            ],
        )

    @staticmethod
    def create_blueprint_candidate_response(blueprint_candidate: dict) -> BlueprintCandidateResponse:
        return BlueprintCandidateResponse(
            name=blueprint_candidate["name"],
            repository_url=blueprint_candidate["repository_url"],
            path=blueprint_candidate["path"],
            candidate_type=blueprint_candidate["type"]
        )
    ...
    @staticmethod
    def create_grain_response(data: dict) -> Optional[GrainResponse]:
        if data is None:
            return None
        return GrainResponse(name=data['name'])
