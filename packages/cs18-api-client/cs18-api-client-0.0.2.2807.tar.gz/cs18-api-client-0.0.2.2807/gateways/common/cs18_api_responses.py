...
class AccountStatusUserDetails:
    def __init__(self, user_details: {}):
        ...
        self.space_roles = user_details["space_roles"]
...
class BlueprintCandidateResponse:
    def __init__(self, name: str, repository_url: str, path: str, candidate_type: str):
        self.name = name
