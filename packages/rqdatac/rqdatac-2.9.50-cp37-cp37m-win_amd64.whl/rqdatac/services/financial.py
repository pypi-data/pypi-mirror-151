...
@export_as_api
def get_financials(query, quarter, interval=None, expect_df=True, market="cn"):
    """获取季度报表数据
...
def get_pit_financials_ex(order_book_ids, fields, start_quarter, end_quarter,
    ...
    fields.extend(['order_book_id', 'info_date', 'end_date', 'if_adjusted'])
...
@export_as_api
def get_fundamentals(query, entry_date, interval=None, report_quarter=False, expect_df=True, market="cn"):
    """获取财务数据
