...
#
#   MHMuser Don't Need This Stuffs
#
...
from pyMHMuser._misc._decorators import compile_pattern, MHMup_cmd
...
ALIVE_NAME = MHMup_bot.me.first_name
BOTLOG_CHATID = BOTLOG = udB.get_key("LOG_CHANNEL")


bot = borg = catub = friday = MHMup_bot
catub.cat_cmd = MHMup_cmd
...
class Config((object)):
    if ENV:
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "MHMuser")
