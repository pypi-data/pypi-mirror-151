...
def load_addons(plugin_name):
    ...
    mod.asst = asst
    mod.tgbot = asst
    mod.MHMup_bot = MHMup_bot
    mod.ub = MHMup_bot
    mod.bot = MHMup_bot
    mod.MHMuser = MHMup_bot
    mod.borg = MHMup_bot
    mod.telebot = MHMup_bot
    mod.jarvis = MHMup_bot
    mod.friday = MHMup_bot
    mod.eod = eod
    mod.edit_delete = eod
    mod.LOGS = LOGS
    ...
    mod.MHMup_cmd = MHMup_cmd
    mod.on_cmd = MHMup_cmd
