...
class MHMuserClient(TelegramClient):
    def __init__(
        self,
        session,
        api_id=None,
    ...
    async def fast_uploader(self, file, **kwargs):
        ...
        from pyMHMuser.functions.FastTelethon import upload_file
        from pyMHMuser.functions.helper import progress
    ...
    async def fast_downloader(self, file, **kwargs):
        ...
        from pyMHMuser.functions.FastTelethon import download_file
        from pyMHMuser.functions.helper import progress
