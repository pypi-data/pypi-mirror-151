...
class KinematicChain:
    ...
    def __init__(self, list_segment, phi_ext,
        ...
        dictionary_rotation = {'zyx': r2mobile.zyx,
                                'zxy': r2mobile.zxy,
                                'xzy': r2mobile.xzy,
                                'yxy': r2mobile.yxy,
                                'yxz': r2mobile.yxz}
        ...
        for i in range(len(name_joint)):
            ...
            euler_rel[name_joint[i]] = np.rad2deg(
                dictionary_rotation[name_rotation[i]](homo_segment_rel[name_joint[i]].T_homo))
        for i in range(len(name_joint)):
            ...
            euler_rel_frame[name_joint[i]] = np.rad2deg(
                dictionary_rotation[name_rotation[i]](homo_segment_rel_frame[name_joint[i]].T_homo))
