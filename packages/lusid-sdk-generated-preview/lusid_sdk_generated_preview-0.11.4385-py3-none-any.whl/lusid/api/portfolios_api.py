...
class PortfoliosApi(object):
    ...
    def patch_portfolio(self, scope, code, operation, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] PatchPortfolio: Patch portfolio.  # noqa: E501
    ...
    def patch_portfolio_access_metadata(self, scope, code, operation, **kwargs):  # noqa: E501
        ...
        >>> thread = api.patch_portfolio_access_metadata(scope, code, operation, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.patch_portfolio_access_metadata_with_http_info(scope, code, operation, **kwargs)  # noqa: E501

    def patch_portfolio_access_metadata_with_http_info(self, scope, code, operation, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] PatchPortfolioAccessMetadata: Patch Access Metadata rules for a Portfolio.  # noqa: E501
        ...
        >>> thread = api.patch_portfolio_access_metadata_with_http_info(scope, code, operation, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('operation' not in local_var_params or  # noqa: E501
                                                        local_var_params['operation'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `operation` when calling `patch_portfolio_access_metadata`")  # noqa: E501
