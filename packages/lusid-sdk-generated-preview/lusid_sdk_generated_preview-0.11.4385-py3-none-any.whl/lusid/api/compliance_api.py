...
class ComplianceApi(object):
    ...
    def get_compliance_run(self, run_id, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] GetComplianceRun: Get the details of a single compliance run. -- DEPRECATING - POST TRADE ONLY  # noqa: E501
    ...
    def get_compliance_run_results_with_http_info(self, run_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/compliance/results/{runId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_compliance_runs(self, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] ListComplianceRuns: List historical compliance runs. -- DEPRECATING - POST TRADE ONLY  # noqa: E501
    ...
    def list_compliance_runs_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ResourceListOfComplianceRun, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def run_pre_trade_compliance_check(self, recipe_scope, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] RunPreTradeComplianceCheck: Kick off the pre-trade compliance check process  # noqa: E501

        Use this endpoint to run a pre-trade compliance check, using all existing pre-trade applicable compliance rules  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.run_pre_trade_compliance_check(recipe_scope, async_req=True)
        >>> result = thread.get()

        :param recipe_scope: Scope of recipe to be used - required (required)
        :type recipe_scope: str
        :param recipe_code: Code of recipe to be used - if not provided, default recipe code will be used
        :type recipe_code: str
        :param by_taxlots: calculate by taxlots or not - Default: False
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.run_pre_trade_compliance_check_with_http_info(recipe_scope, **kwargs)  # noqa: E501

    def run_pre_trade_compliance_check_with_http_info(self, recipe_scope, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] RunPreTradeComplianceCheck: Kick off the pre-trade compliance check process  # noqa: E501
        ...
        >>> thread = api.run_pre_trade_compliance_check_with_http_info(recipe_scope, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method run_pre_trade_compliance_check" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'recipe_scope' is set
        if self.api_client.client_side_validation and ('recipe_scope' not in local_var_params or  # noqa: E501
                                                        local_var_params['recipe_scope'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `recipe_scope` when calling `run_pre_trade_compliance_check`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('recipe_scope' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `recipe_scope` when calling `run_pre_trade_compliance_check`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('recipe_scope' in local_var_params and  # noqa: E501
                                                        len(local_var_params['recipe_scope']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `recipe_scope` when calling `run_pre_trade_compliance_check`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'recipe_scope' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['recipe_scope']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `recipe_scope` when calling `run_pre_trade_compliance_check`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        if self.api_client.client_side_validation and ('recipe_code' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `recipe_code` when calling `run_pre_trade_compliance_check`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('recipe_code' in local_var_params and  # noqa: E501
                                                        len(local_var_params['recipe_code']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `recipe_code` when calling `run_pre_trade_compliance_check`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'recipe_code' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['recipe_code']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `recipe_code` when calling `run_pre_trade_compliance_check`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/api/compliance/pretraderun', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
