...
class LegalEntitiesApi(object):
    ...
    def list_all_legal_entities(self, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] ListAllLegalEntities: List Legal Entities  # noqa: E501
    ...
    def patch_legal_entity_access_metadata(self, id_type_scope, id_type_code, code, operation, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] PatchLegalEntityAccessMetadata: Patch Access Metadata rules for a Legal Entity.  # noqa: E501
        ...
        >>> thread = api.patch_legal_entity_access_metadata(id_type_scope, id_type_code, code, operation, async_req=True)
        >>> result = thread.get()
        ...
        :param code: Code of the Legal Entity under specified identifier type's scope and code. (required)
        :type code: str
        :param operation: The Json Patch document (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.patch_legal_entity_access_metadata_with_http_info(id_type_scope, id_type_code, code, operation, **kwargs)  # noqa: E501

    def patch_legal_entity_access_metadata_with_http_info(self, id_type_scope, id_type_code, code, operation, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] PatchLegalEntityAccessMetadata: Patch Access Metadata rules for a Legal Entity.  # noqa: E501
        ...
        >>> thread = api.patch_legal_entity_access_metadata_with_http_info(id_type_scope, id_type_code, code, operation, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('operation' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `operation` when calling `patch_legal_entity_access_metadata`")  # noqa: E501
