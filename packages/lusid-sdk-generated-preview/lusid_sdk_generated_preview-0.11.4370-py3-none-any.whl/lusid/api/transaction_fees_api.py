...
class TransactionFeesApi(object):
    ...
    def delete_fee_rule(self, code, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] DeleteFeeRule: Deletes a fee rule.  # noqa: E501
        ...
        >>> thread = api.delete_fee_rule(code, async_req=True)
        >>> result = thread.get()
        ...
        return self.delete_fee_rule_with_http_info(code, **kwargs)  # noqa: E501

    def delete_fee_rule_with_http_info(self, code, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] DeleteFeeRule: Deletes a fee rule.  # noqa: E501
        ...
        >>> thread = api.delete_fee_rule_with_http_info(code, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('code' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `code` when calling `delete_fee_rule`")  # noqa: E501

        if self.api_client.client_side_validation and ('code' in local_var_params and  # noqa: E501
                                                        len(local_var_params['code']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `code` when calling `delete_fee_rule`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('code' in local_var_params and  # noqa: E501
                                                        len(local_var_params['code']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `code` when calling `delete_fee_rule`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'code' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['code']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `code` when calling `delete_fee_rule`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        collection_formats = {}
