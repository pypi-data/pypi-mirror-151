...
def get_allocation_stats():
    yey__syg = get_allocation_stats_arr(), get_allocation_stats_dec(
        ), get_allocation_stats_pq(), get_allocation_stats_qa()
    axxv__uoqt, ayvi__pts, npta__giru, wrkk__ciryf = 0, 0, 0, 0
    for sqke__vmcw in yey__syg:
        axxv__uoqt += sqke__vmcw[0]
        ayvi__pts += sqke__vmcw[1]
        npta__giru += sqke__vmcw[2]
        wrkk__ciryf += sqke__vmcw[3]
    return axxv__uoqt, ayvi__pts, npta__giru, wrkk__ciryf
