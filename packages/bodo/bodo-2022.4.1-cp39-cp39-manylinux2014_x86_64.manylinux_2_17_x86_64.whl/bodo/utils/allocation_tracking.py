...
def get_allocation_stats():
    obvd__png = get_allocation_stats_arr(), get_allocation_stats_dec(
        ), get_allocation_stats_pq(), get_allocation_stats_qa()
    jst__jqq, pinvm__lunyz, olgkc__uau, uznnx__ehlrw = 0, 0, 0, 0
    for xmb__nmhan in obvd__png:
        jst__jqq += xmb__nmhan[0]
        pinvm__lunyz += xmb__nmhan[1]
        olgkc__uau += xmb__nmhan[2]
        uznnx__ehlrw += xmb__nmhan[3]
    return jst__jqq, pinvm__lunyz, olgkc__uau, uznnx__ehlrw
