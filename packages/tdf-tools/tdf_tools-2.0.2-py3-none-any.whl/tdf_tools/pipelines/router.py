...
class Router:
    def __init__(self):
        self.__moduleNameList = InitialJsonConfig().moduleNameList
        self.__module_config = ModuleJsonConfig()
    ...
    def run(self):
        ...
        businessModuleList = []
        for item in self.__moduleNameList:
            if (
                self.__module_config.get_item(item).type == ModuleItemType.Module
                or self.__module_config.get_item(item).type == ModuleItemType.Lib
            ):
