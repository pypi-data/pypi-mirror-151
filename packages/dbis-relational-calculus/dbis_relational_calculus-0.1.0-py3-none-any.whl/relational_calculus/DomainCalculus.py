...
if __name__ == '__main__':
    add_table_scheme('Hauptstadt', ['name', 'bundesland'])
    add_table_scheme('Bundesland', ['land', 'name'])
    add_table_scheme('Stadt', ['name', 'istHauptstadt'])
    ...
    # print(domain_calculus.to_TupleCalculus())
    ...
    print('')
    print(domain_calculus.to_tuple_calculus())
    print('')
    print(domain_calculus.to_tuple_calculus().to_sql())
