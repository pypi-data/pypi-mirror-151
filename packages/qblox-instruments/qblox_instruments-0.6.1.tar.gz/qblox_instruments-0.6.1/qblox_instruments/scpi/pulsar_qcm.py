...
class PulsarQcm(Ieee488_2):
    ...
    def __init__(self, transport: Transport, debug: int=0):
        ...
        if self._debug == 0:
            ...
            build_ref = "fwVersion=0.7.1 fwBuild=18/05/2022-16:25:16 fwHash=0x3164AA4A fwDirty=0 kmodVersion=0.7.1 kmodBuild=20/05/2022-13:38:33 kmodHash=0x9A8D9543 kmodDirty=0 swVersion=0.7.1 swBuild=20/05/2022-13:38:33 swHash=0x9A8D9543 swDirty=0 cfgManVersion=0.2.0 cfgManBuild=20/05/2022-13:38:33 cfgManHash=0x9A8D9543 cfgManDirty=0"
            if build != build_ref:
