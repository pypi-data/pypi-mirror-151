...
class Cluster(Ieee488_2):
    ...
    def __init__(self, transport: Transport, debug: int=0):
        ...
        if self._debug == 0:
            ...
            build_ref = "fwVersion=0.2.1 fwBuild=18/05/2022-16:23:30 fwHash=0x424B34A1 fwDirty=0 kmodVersion=0.2.1 kmodBuild=20/05/2022-13:42:01 kmodHash=0x2366BCF7 kmodDirty=0 swVersion=0.2.1 swBuild=20/05/2022-13:42:01 swHash=0x2366BCF7 swDirty=0 cfgManVersion=0.2.0 cfgManBuild=20/05/2022-13:42:01 cfgManHash=0x2366BCF7 cfgManDirty=0"
            if build != build_ref:
