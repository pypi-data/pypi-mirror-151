...
class PulsarQrm(Ieee488_2):
    ...
    def __init__(self, transport: Transport, debug: int=0):
        ...
        super(PulsarQrm, self).__init__(transport)

        if self._debug == 0:
            # Check if device and build are compatible.
            _, device, *_, build = self._read("*IDN?").split(',')
            if device.replace("Cluster", "Pulsar") != 'Pulsar QRM':
                raise ConnectionError("This class expects a Pulsar QRM device, but found a {}. Please use the right device class.".format(device))
            build_ref = "fwVersion=0.7.1 fwBuild=18/05/2022-16:25:49 fwHash=0x5FCF1553 fwDirty=0 kmodVersion=0.7.1 kmodBuild=20/05/2022-13:39:26 kmodHash=0xAC6B2A0A kmodDirty=0 swVersion=0.7.1 swBuild=20/05/2022-13:39:26 swHash=0xAC6B2A0A swDirty=0 cfgManVersion=0.2.0 cfgManBuild=20/05/2022-13:39:26 cfgManHash=0xAC6B2A0A cfgManDirty=0"
            if build != build_ref:
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def _set_in_amp_gain_0(self, gain: int) -> None:
        """
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def _get_in_amp_gain_0(self) -> int:
        """
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def _set_in_amp_gain_1(self, gain: int) -> None:
        """
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def _get_in_amp_gain_1(self) -> int:
        """
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def _set_in_att_0(self, attenuation: int) -> None:
        """
        ...
        # SCPI call
        self._write('AFE:ATT:IN0 {}'.format(attenuation))

    # -------------------------------------------------------------------------
    @scpi_error_check
    def _get_in_att_0(self) -> int:
        """
        Get input attenuator value
        ...
        -------
        int
            Attenuation in dB in a range of 0 to 30dB in steps of 2dB.
        ...
        # SCPI call
        var0 = self._read('AFE:ATT:IN0?')

        return int(var0)

    # -------------------------------------------------------------------------
    @scpi_error_check
    def _set_acq_scope_config(self, config: bytes) -> None:
        """
        ...
        # Check input types.
        self._check_in_type(locals(), ['bytes'])

        # SCPI call
        self._write_bin('ACQ:SCOpe:CONFiguration '.format(), config)

    # -------------------------------------------------------------------------
    @scpi_error_check
    def _get_acq_scope_config(self) -> bytes:
        """
        ...
        # SCPI call
        var0 = self._read_bin('ACQ:SCOpe:CONFiguration?')

        return var0

    # -------------------------------------------------------------------------
    @scpi_error_check
    def _add_acq_weight(self, sequencer: int, name: str, size: int, is_integer: bool) -> None:
        """
        ...
        # SCPI call
        self._write('SEQuencer{}:ACQ:WLISt:WEIght:NEW "{}",{},{}'.format(sequencer, name, size, 0 if is_integer == False else 1))

    # -------------------------------------------------------------------------
    @scpi_error_check
    def _delete_acq_weight(self, sequencer: int, name: str) -> None:
        """
        ...
        # SCPI call
        self._write('SEQuencer{}:ACQ:WLISt:WEIght:DELete "{}"'.format(sequencer, name))

    # -------------------------------------------------------------------------
    @scpi_error_check
    def _set_acq_weight_data(self, sequencer: int, name: str, weight: List[float]) -> None:
        """
        ...
        # SCPI call
        self._write_bin('SEQuencer{}:ACQ:WLISt:WEIght:DATA "{}",'.format(sequencer, name), struct.pack('f'*len(weight), *weight))

    # -------------------------------------------------------------------------
    @scpi_error_check
    def _get_acq_weight_data(self, sequencer: int, name: str, start: int, size: int) -> List[float]:
        """
        ...
        # SCPI call
        var0 = self._read_bin('SEQuencer{}:ACQ:WLISt:WEIght:DATA? "{}",{},{}'.format(sequencer, name, start, size))

        return struct.unpack('f'*int(len(var0)/4), var0)

    # -------------------------------------------------------------------------
    @scpi_error_check
    def _set_acq_weight_index(self, sequencer: int, name: str, index: int) -> None:
        """
        ...
        # SCPI call
        self._write('SEQuencer{}:ACQ:WLISt:WEIght:INDex "{}",{}'.format(sequencer, name, index))

    # -------------------------------------------------------------------------
    @scpi_error_check
    def _get_acq_weight_index(self, sequencer: int, name: str) -> int:
        """
        ...
        # SCPI call
        var0 = self._read('SEQuencer{}:ACQ:WLISt:WEIght:INDex? "{}"'.format(sequencer, name))

        return int(var0)

    # -------------------------------------------------------------------------
    @scpi_error_check
    def _get_acq_weight_length(self, sequencer: int, name: str) -> int:
        """
        ...
        # SCPI call
        var0 = self._read('SEQuencer{}:ACQ:WLISt:WEIght:LENGth? "{}"'.format(sequencer, name))

        return int(var0)

    # -------------------------------------------------------------------------
    @scpi_error_check
    def _get_acq_weight_name(self, sequencer: int, index: int) -> str:
        """
        ...
        # SCPI call
        var0 = self._read('SEQuencer{}:ACQ:WLISt:WEIght:NAME? {}'.format(sequencer, index))

        return var0

    # -------------------------------------------------------------------------
    @scpi_error_check
    def _get_acq_num_weights(self, sequencer: int) -> int:
        """
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def _get_acq_weights(self, sequencer: int) -> List[bytes]:
        """
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def _add_acq_acquisition(self, sequencer: int, name: str, num_bins: int) -> None:
        """
        ...
        # SCPI call
        self._write('SEQuencer{}:ACQ:ALISt:ACQuisition:NEW "{}",{}'.format(sequencer, name, num_bins))

    # -------------------------------------------------------------------------
    @scpi_error_check
    def _delete_acq_acquisition(self, sequencer: int, name: str) -> None:
        """
        ...
        # SCPI call
        self._write('SEQuencer{}:ACQ:ALISt:ACQuisition:DELete "{}"'.format(sequencer, name))

    # -------------------------------------------------------------------------
    @scpi_error_check
    def _set_acq_acquisition_data(self, sequencer: int, name: str) -> None:
        """
        ...
        # SCPI call
        self._write('SEQuencer{}:ACQ:ALISt:ACQuisition:DATA "{}"'.format(sequencer, name))

    # -------------------------------------------------------------------------
    @scpi_error_check
    def _get_acq_acquisition_data(self, sequencer: int, name: str) -> List[bytes]:
        """
        ...
        # SCPI call
        var0 = self._read('SEQuencer{}:ACQ:ALISt:ACQuisition:DATA? "{}"'.format(sequencer, name))

        return var0

    # -------------------------------------------------------------------------
    @scpi_error_check
    def _set_acq_acquisition_index(self, sequencer: int, name: str, index: int) -> None:
        """
        ...
        # SCPI call
        self._write('SEQuencer{}:ACQ:ALISt:ACQuisition:INDex "{}",{}'.format(sequencer, name, index))

    # -------------------------------------------------------------------------
    @scpi_error_check
    def _get_acq_acquisition_index(self, sequencer: int, name: str) -> int:
        """
        ...
        # SCPI call
        var0 = self._read('SEQuencer{}:ACQ:ALISt:ACQuisition:INDex? "{}"'.format(sequencer, name))

        return int(var0)

    # -------------------------------------------------------------------------
    @scpi_error_check
    def _get_acq_acquisition_num_bins(self, sequencer: int, name: str) -> int:
        """
        ...
        # SCPI call
        var0 = self._read('SEQuencer{}:ACQ:ALISt:ACQuisition:BINs? "{}"'.format(sequencer, name))

        return int(var0)

    # -------------------------------------------------------------------------
    @scpi_error_check
    def _get_acq_acquisition_name(self, sequencer: int, index: int) -> str:
        """
        ...
        # SCPI call
        var0 = self._read('SEQuencer{}:ACQ:ALISt:ACQuisition:NAME? {}'.format(sequencer, index))

        return var0

    # -------------------------------------------------------------------------
    @scpi_error_check
    def _get_acq_num_acquisitions(self, sequencer: int) -> int:
        """
        Get number of acquisitions in acquisition list of indexed sequencer's acquisition path. If an invalid sequencer index is given, an error is set in system error.
        ...
        # SCPI call
        var0 = self._read('SEQuencer{}:ACQ:ALISt:SIZE?'.format(sequencer))

        return int(var0)

    # -------------------------------------------------------------------------
    @scpi_error_check
    def _get_acq_acquisitions(self, sequencer: int) -> List[bytes]:
        """
        Get all acquisitions in acquisition list of indexed sequencer's acquisition path. If an invalid sequencer index is given, an error is set in system error.
        ...
        # SCPI call
        var0 = self._read('SEQuencer{}:ACQ:ALISt?'.format(sequencer))

        return var0

    # -------------------------------------------------------------------------
    @scpi_error_check
    def start_adc_calib(self) -> None:
        """
        ...
        # SCPI call
        self._write('AFE:ADC:CALibration')
