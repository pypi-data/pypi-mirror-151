...
def small_set():
    ...
    mod = [
        ...
        ModuleInstall("pyrsistent", "pip", purpose="Pyrsistent is a number of persistent collections (by some referred to as functional data "
                      "structures). Persistent in the sense that they are immutable."),
        ...
        ModuleInstall("sphinxcontrib-devhelp", "pip", mname="sphinxcontrib.devhelp",
                      purpose="extension for Sphinx", usage="SPHINX"),
        ModuleInstall("sphinxcontrib-htmlhelp", "pip", mname="sphinxcontrib.htmlhelp",
                      purpose="extension for Sphinx", usage="SPHINX"),
        ModuleInstall("sphinxcontrib-jsmath", "pip", mname="sphinxcontrib.jsmath",
                      purpose="extension for Sphinx", usage="SPHINX"),
        ModuleInstall("sphinxcontrib-qthelp", "pip", mname="sphinxcontrib.qthelp",
                      purpose="extension for Sphinx", usage="SPHINX"),
        ModuleInstall("sphinxcontrib-serializinghtml", "pip", mname="sphinxcontrib.serializinghtml",
                      purpose="extension for Sphinx", usage="SPHINX"),
