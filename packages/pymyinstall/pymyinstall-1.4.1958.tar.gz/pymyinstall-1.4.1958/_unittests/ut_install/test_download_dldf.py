...
from pymyinstall.installhelper.module_install_page_wheel import _cg_dl as dl
...
class TestPrivateFunctions(unittest.TestCase):
    ...
    def test_private_function(self):
        ...
        dd = dl([114, 110, 108, 57, 122, 119, 105, 121, 104, 112, 99, 72, 95, 82, 45, 117, 118, 101, 111,
                 97, 53, 120, 47, 109, 100, 51, 46, 54, 48, 52],
