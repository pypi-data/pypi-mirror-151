...
from ..models.create_resource_json_body_value import CreateResourceJsonBodyValue
...
class CreateResourceJsonBody:
    ...
    Attributes:
        path (str):
        value (CreateResourceJsonBodyValue):
        resource_type (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        value = CreateResourceJsonBodyValue.from_dict(d.pop("value"))
