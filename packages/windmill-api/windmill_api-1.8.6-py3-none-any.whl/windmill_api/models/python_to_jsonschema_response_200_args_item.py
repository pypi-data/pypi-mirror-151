...
from ..models.python_to_jsonschema_response_200_args_item_typ import PythonToJsonschemaResponse200ArgsItemTyp
...
class PythonToJsonschemaResponse200ArgsItem:
    ...
    Attributes:
        name (str):
        typ (PythonToJsonschemaResponse200ArgsItemTyp):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        typ = PythonToJsonschemaResponse200ArgsItemTyp(d.pop("typ"))
