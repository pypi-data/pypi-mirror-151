...
from ..models.list_completed_jobs_response_200_item_raw_flow_failure_module_value import (
...
class ListCompletedJobsResponse200ItemRawFlowFailureModule:
    ...
    Attributes:
        ...
        value (ListCompletedJobsResponse200ItemRawFlowFailureModuleValue):
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        value = ListCompletedJobsResponse200ItemRawFlowFailureModuleValue.from_dict(d.pop("value"))
