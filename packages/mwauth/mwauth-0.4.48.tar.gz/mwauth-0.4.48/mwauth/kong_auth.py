...
class KongAuth(BaseAuth):
    ...
    def valid_sign(self,func):
        ...
        def _request_sign(*args, **kw):
            ...
            sign_source_str = f'{request.data.decode()}{g.current_user.uname}' \
            ...
            current_app.logger.info(f'sign_source_user:{sign_source_str},sign_md5:{sign_md5}')
            if sign_md5 == sign:
                return func(*args, **kw)
            else:
                ...
                current_app.logger.info(f'sign_source_jwt:{sign_source_str},sign_md5:{sign_md5}')
