...
class ImageSegmentationTestCase(unittest.TestCase):
    ...
    def test_perform(self):
        ...
        self.assertGreater(number_perform, 1, 'You should have called perform_segmentation model. If you have, make sure you used the right syntax')
    ...
    def test_print_segmented(self):
        self.assertIn('segmented_image.size', self.api_code, 'You should print the size of the segmented imageapi.py file. If you have, make sure it has the right syntax')
