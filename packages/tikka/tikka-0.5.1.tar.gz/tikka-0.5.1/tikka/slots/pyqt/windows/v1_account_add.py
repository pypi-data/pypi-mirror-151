...
from tikka.slots.pyqt.resources.gui.windows.v1_account_add_rc import (
    Ui_V1AccountAddDialog,
)


class V1AccountAddWindow(QDialog, Ui_V1AccountAddDialog):
    """
    V1AccountAddWindow class
    """

    def __init__(self, application: Application, parent: Optional[QWidget] = None):
        """
        Init add V1 account window
    ...
    def on_accepted_button(self):
        ...
        if wallet is None:
            ...
            wallet = self.application.wallets.create(
                address, keypair.seed_hex, password
            )
...
if __name__ == "__main__":
    ...
    V1AccountAddWindow(application_).exec_()
