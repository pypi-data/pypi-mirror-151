...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, application: Application, parent: Optional[QWidget] = None):
        ...
        # V1 accounts menu
        self.actionV1Add_account.triggered.connect(self.open_v1_add_account_window)
    ...
    def open_v1_add_account_window(self) -> None:
        """
        Open V1 add account window

        :return:
        """
        V1AccountAddWindow(self.application, self).exec_()
