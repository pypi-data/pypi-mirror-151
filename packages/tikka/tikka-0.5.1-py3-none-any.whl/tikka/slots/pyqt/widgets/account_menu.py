...
from tikka.slots.pyqt.windows.v1_account_add import V1AccountAddWindow
...
class AccountPopupMenu(QMenu):
    ...
    def __init__(
        ...
        withdraw_account_action = self.addAction(self._("Withdraw account"))
    ...
    def transfer(self):
        ...
        :return:
        """
        TransferWindow(self.application, self.account, self).exec_()
    ...
    def wallet_password_forgotten(self):
        ...
        # wallet V1
            ...
            V1AccountAddWindow(self.application).exec_()
    ...
    def confirm_withdraw_account(self):
        ...
        button = QMessageBox.question(
            self,
            self._("Withdraw account"),
            self._("Withdraw account {address}?").format(address=self.account.address),
        )
