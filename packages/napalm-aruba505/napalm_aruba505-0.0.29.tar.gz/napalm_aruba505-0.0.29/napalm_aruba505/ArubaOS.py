...
class ArubaOS505(NetworkDriver):
    ...
    def show_summary_sanitizer(self, data):
        ...
        :returns tuple with two values (fqdn, serial_number)
        """
        ...
        if data:
            ...
            for l in data_l:
                if "DNSDomain" in l:
                    fqdn = f"{self.hostname}.{l.split(':')[1]}"
                if "Serial Number" in l:
                    serial_number = l.split(':')[1]
        return fqdn, serial_number
    ...
    def get_facts(self):
        ...
        return {
            ...
            "fqdn": "dummy fqdn",
            "vendor": "dummy verndor",
            "model": "dummy model",
            "serial_number": "dummy serial_number",
