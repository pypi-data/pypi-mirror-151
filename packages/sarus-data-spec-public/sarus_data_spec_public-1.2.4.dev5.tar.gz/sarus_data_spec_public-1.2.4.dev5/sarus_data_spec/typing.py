...
try:
    ...
    print('sklearn not found, sklearn models not available')
...
class Dataset(DataSpec[sp.Dataset], t.Protocol):
    ...
    def to_arrow(self) -> t.Iterator[pa.RecordBatch]:
        ...

    async def async_to_arrow(self) -> t.AsyncIterator[pa.RecordBatch]:
        ...
