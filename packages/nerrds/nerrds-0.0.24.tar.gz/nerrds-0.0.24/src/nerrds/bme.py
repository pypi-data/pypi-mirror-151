...
sys.path.insert(1, '/home/nmrbox/0013/nfowler/pipeline/test_script_parallel/scripts/BME/')  # obv need to be able to read this from installation

import BME # enough? need BME tools too


# make dir for running BME
