...
def get_schema():
    return (
        ...
        # Reserved for internal use, stores the docums.yml config file.
        ...
        # The Docums theme for the documentation.
        ('theme', config_options.Theme(default='docums')),
        ...
        # this should look like, ['UA-215113700-1', 'khanhduy1407.github.io/docums']
        ('google_analytics', config_options.Deprecated(
            message=(
                'The configuration option {} has been deprecated and '
                'will be removed in a future release of Docums. See the '
        ...
        # enabling strict mode causes Docums to stop the build when a problem is
        ...
        # Docums itself. A good example here would be including the current
        # project version.
