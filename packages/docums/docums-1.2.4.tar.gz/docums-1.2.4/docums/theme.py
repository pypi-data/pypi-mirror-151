...
from docums.utils import filters
from docums.config.base import ValidationError
from docums import localization
...
class Theme:
    ...
    def __init__(self, name=None, **user_config):
        ...
        # Docums provided static templates are always included
        package_dir = os.path.abspath(os.path.dirname(__file__))
        docums_templates = os.path.join(package_dir, 'templates')
        self.static_templates = set(os.listdir(docums_templates))
        ...
        # Include templates provided directly by Docums (outside any theme)
        self.dirs.append(docums_templates)
    ...
    def _load_theme_config(self, name):
        ...
        try:
            file_path = os.path.join(theme_dir, 'docums_theme.yml')
