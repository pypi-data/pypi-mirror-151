...
from docums.commands.build import build
from docums.config import load_config
from docums.exceptions import Abort
from docums.livereload import LiveReloadServer
...
def serve(config_file=None, dev_addr=None, strict=None, theme=None,
    ...
    """
    Start the Docums development server
    ...
    # string is returned. And it makes Docums temp dirs easier to identify.
    site_dir = tempfile.mkdtemp(prefix='docums_')
