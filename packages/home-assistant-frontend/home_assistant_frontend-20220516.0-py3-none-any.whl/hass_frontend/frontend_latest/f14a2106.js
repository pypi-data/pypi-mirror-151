      ...
      <hui-generic-entity-row .hass=${this.hass} .config=${this._config}>
        ${"slider"===e.attributes.mode?i.dy`
              <div class="flex">
                ...
                ></ha-slider>
                <span class="state">
                  ${(0,o.D)(this.hass.localize,e,this.hass.locale,e.state)}
                </span>
              </div>
            `:i.dy`
