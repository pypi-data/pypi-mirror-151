...
>
  ...
  ${e.icon}
    ...
    `}},{kind:"method",key:"_renderTab",value:function(){switch(this._curTab){case"tab-settings":return this._entry?this._settingsElementTag?r.dy`
      ...
      `]}}]}}),r.oi)},27322:(e,t,i)=>{"use strict";i.d(t,{R:()=>r});const r=(e,t)=>`https://${e.config.version.includes("b")?"rc":e.config.version.includes("dev")?"next":"www"}.home-assistant.io${t}`},86853:(e,t,i)=>{var r={"./entity-settings-helper-tab":[85511,41985,51644,49842,1548,49075,8167,12545,13701,6677,6131],"./entity-settings-helper-tab.ts":[85511,41985,51644,49842,1548,49075,8167,12545,13701,6677,6131]};function n(e){if(!i.o(r,e))return Promise.resolve().then((()=>{var t=new Error("Cannot find module '"+e+"'");throw t.code="MODULE_NOT_FOUND",t}));var t=r[e],n=t[0];return Promise.all(t.slice(1).map(i.e)).then((()=>i(n)))}n.keys=()=>Object.keys(r),n.id=86853,e.exports=n}}]);
//# sourceMappingURL=edab4a49.js.map