...
from webform.models.prmodel import Family
...
class F5406:
        ...
        return [
            {
                "action_type": "Input",
                "label": "Full name",
                "value": person.personal.first_name + " " + person.personal.last_name
                if person
                else family_member.first_name + " " + family_member.last_name,
    ...
    def sectionC(self, person: PrModel):
        ...
        return [
            {
                "action_type": Action.WebPage.value,
                "page_name": "Imm5406 additional family information Section B: Siblings",
                "actions": actions,
                "id": "body > pra-root > pra-localized-app > main > div > pra-imm5406 > lib-navigation-buttons > div > button.btn.btn-primary",
            }
        ]
