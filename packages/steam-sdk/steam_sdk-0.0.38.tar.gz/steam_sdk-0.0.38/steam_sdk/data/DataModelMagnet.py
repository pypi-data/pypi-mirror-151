...
class GeometryGenerationOptionsProteCCT(BaseModel):
    ...
    windingOrder: str = None  # Note: it will be written in a single cell in the ProteCCT file
...
class DataModelMagnet(BaseModel):
    ...
    # def data_model_to_yaml(self, name_output_file: str, list_exceptions: list = []):
    #     """
    #         Write the DataModelMagnet object to yaml with pre-set format used across STEAM yaml files.
    #         In particular:
    ...
    #     #################################################################################################
    #     # Helper functions
    #     def my_represent_none(self2, data):
    #         '''
    #             TODO: Add description
    #             TODO: Delete argument "data"
    #         '''
    #         return self2.represent_scalar('tag:yaml.org,2002:null', 'null')
    #
    #     def flist(x):
    #         '''
