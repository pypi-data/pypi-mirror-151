...
setup(
    ...
    description='building your blog including file server and database',  # Optional
    ...
    url='https://www.hohohaha.cn',  # Optional

    # This should be your name or the name of the organization which owns the
    # project.
    author='xiabo',  # Optional

    # This should be a valid email address corresponding to the author listed
    # above.
    author_email='blcuxiabo@126.com',  # Optional
    ...
    # data_files=[('chemmorpheme', ['data/chemmorpheme.dat']),('chemtagged', ['data/chemtagged.dat']),('testset', ['data/testset.txt'])],  # Optional
