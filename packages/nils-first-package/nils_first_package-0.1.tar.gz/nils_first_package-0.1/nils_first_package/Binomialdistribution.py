...
class Binomial(Distribution):
    ...
    def __init__(self, p, n):
        ...
        #       function from the Distribution class
    ...
    # : write a replace_stats_with_data() method according to the specifications below. The read_data_file() from the 
    # Generaldistribution class can read in a data
    ...
    def replace_stats_with_data(self):
        ...
        """
        # self.data = super().read_data_file()
    ...
    # : write a method plot_bar() that outputs a bar chart of the data set according to the following specifications.
    def plot_bar(self):
        ...
        """
        plt.hist(self.data)
        plt.xlabel('value of the bins the data is in')
    ...
    def pdf(self, k):
        ...
        """ 
        combinations = math.factorial(self.n) / (math.factorial(k) * math.factorial(self.n - k))
        self.pdf_value = combinations * (self.p ** k) * ((1 - self.p) ** (self.n - k))
    ...
    def __add__(self, other):
        ...
        new_dist_p = self.p
        new_dist_n = self.n + other.n

        new_dist = Binomial(new_dist_p, new_dist_n)
