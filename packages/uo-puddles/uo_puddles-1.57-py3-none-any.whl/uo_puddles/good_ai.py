...
def up_set_column(table, column_name, new_values):
  ...
  last_col = table.columns[len(table.columns)-1]
  new_cols = [col for col in new_table.columns if col != last_col] + [last_col]
