...
from kolibri.data.resources.download import checksums
from kolibri.data.resources.download import downloader
from kolibri.data.resources.download import extractor
from kolibri.data.resources.download import kaggle
from kolibri.data.resources.download import resource as resource_lib
from kolibri.data.resources.download import util
from kdmt import types
from kdmt.misc import build_synchronize_decorator, dedent
...
class DownloadManager(object):
  ...
  def __init__(
    ...
    self._manual_dir_instructions = dedent(manual_dir_instructions)
