...
from cloudam_stream.core.payload import Message
import pickle
...
def get_actor_params(actor: Actor, actor_desc: json) -> Args:
    ...
    for param in params_json:
        ...
        param = param_class(name=param_name, description=param_description, value=param_value)
        setattr(args, param_variable, param)
    return args
