...
def client(
    ...
    """
    Initializes a Kaskada Client. Used for overloading default production parameters.
    Creating a client will update the default module default client.
    ...
    global KASKADA_DEFAULT_CLIENT
    KASKADA_DEFAULT_CLIENT = Client.authorized(
        client_id, client_secret, exchange_endpoint, audience, endpoint, is_secure
    )
    return KASKADA_DEFAULT_CLIENT
