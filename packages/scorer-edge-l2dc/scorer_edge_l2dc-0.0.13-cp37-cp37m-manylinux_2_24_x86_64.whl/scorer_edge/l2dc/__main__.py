...
examples:
  ...
  cmake -S src/ -B build/ -DScorerEdgeL2dc_ROOT=$(python3 -m %(prog)s --cmake-dir)
  cmake -DCMAKE_PREFIX_PATH=$(python3 -m %(prog)s --cmake-prefix)
'''

    ap = argparse.ArgumentParser(prog='scorer_edge.l2dc',
