...
def run_tests(infra_file_path, test_type, infra_key, results_file_path, reach_tests_previous_results_path=None, junos_ping_target=None):
    ...
    if test_type == 'reachability':
        ...
        result = junos_ping(host, device_name, address)
