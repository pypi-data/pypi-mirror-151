...
def get_junos_lo_configs_from_inv(nornir_inv, dev_name):
    ...
    device_configs = junos_pyez_get_configs(nornir=nornir_inv, dev_name=dev_name, get_print=False, format=format)
    # Get device configes in set mode
    device_configs_set = junos_pyez_get_configs(nornir=nornir_inv, dev_name=dev_name, get_print=False, format='set')
