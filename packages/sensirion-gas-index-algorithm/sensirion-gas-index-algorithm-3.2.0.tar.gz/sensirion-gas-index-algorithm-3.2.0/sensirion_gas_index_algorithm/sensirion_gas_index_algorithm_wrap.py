...
class GasIndexAlgorithmParams(object):
    ...
    m_sampling_interval = property(_sensirion_gas_index_algorithm_wrap.GasIndexAlgorithmParams_m_sampling_interval_get, _sensirion_gas_index_algorithm_wrap.GasIndexAlgorithmParams_m_sampling_interval_set)

    def __init__(self, algorithm_type: "int32_t", sampling_interval: "int32_t"):
    ...
    def init(self, algorithm_type: "int32_t", sampling_interval: "int32_t") -> "void":
    ...
    def set_states(self, state0: "int32_t", state1: "int32_t") -> "void":
...
def GasIndexAlgorithm_init_ext(params: "GasIndexAlgorithmParams", algorithm_type: "int32_t", samp_int: "int32_t") -> "void":
    return _sensirion_gas_index_algorithm_wrap.GasIndexAlgorithm_init_ext(params, algorithm_type, samp_int)
...
def GasIndexAlgorithm_get_states(params: "GasIndexAlgorithmParams") -> "int32_t *, int32_t *":
    return _sensirion_gas_index_algorithm_wrap.GasIndexAlgorithm_get_states(params)

def GasIndexAlgorithm_set_states(params: "GasIndexAlgorithmParams", state0: "int32_t", state1: "int32_t") -> "void":
...
def GasIndexAlgorithm_get_sampling_interval(params: "GasIndexAlgorithmParams") -> "int32_t *":
...
cvar = _sensirion_gas_index_algorithm_wrap.cvar
default_sampling_interval = cvar.default_sampling_interval
