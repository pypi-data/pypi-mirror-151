def cond (figure,errorratetotal,x,y,conditionx,conditiony,limitx,limity): 
    ...
    positive_errorrate_whole = abs(((xpos_whole/(len(df_visible[x])))*100)-100)
    ...
    negative_errorrate_whole = abs(((xneg_whole/(len(df_invisible[x])))*100)-100)
    ...
    positive_errorrate_nakedeye = abs(((abs(len(df_visible[x])-len(dfy_visible[x]))/(len(df_visible[x])))*100-100))
    ...
    negative_errorrate_nakedeye = abs((abs((len(df_invisible[x])-len(dfy_invisible[x]))/(len(df_invisible[x])))*100-100))
    ...
    positive_errorrate_opticalaided = abs(((abs(len(df_visible[x])-len(dfy_visible[x]))/(len(df_visible[x])))*100-100))
    ...
    negative_errorrate_opticalaided = abs(((abs(len(df_invisible[x])-len(dfy_invisible[x]))/(len(df_invisible[x])))*100-100))
