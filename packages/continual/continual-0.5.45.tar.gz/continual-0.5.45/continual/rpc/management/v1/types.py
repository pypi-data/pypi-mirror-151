...
class ExtensionSchema:
    ...
    def class_(self) -> str:
        ...
        return self._attributes["class_"]


    @class_.setter
    def class_(self, value: str) -> None:
        _set_attribute(self._attributes, "ExtensionSchema", "class_", value, str, "")


    @property
    def module(self) -> str:
        """Optional module name that contains implementation"""
        return self._attributes["module"]


    @module.setter
    def module(self, value: str) -> None:
        _set_attribute(self._attributes, "ExtensionSchema", "module", value, str, "")
...
class TrainConfig:
    ...
    @property
    def algorithm_configs(self) -> Dict[str, AlgorithmConfig]:
        """Algorithm configs."""
        return self._attributes["algorithm_configs"]


    @algorithm_configs.setter
    def algorithm_configs(self, value: Dict[str, AlgorithmConfig]) -> None:
        _set_attribute(self._attributes, "TrainConfig", "algorithm_configs", value, Dict[str, AlgorithmConfig], "")
