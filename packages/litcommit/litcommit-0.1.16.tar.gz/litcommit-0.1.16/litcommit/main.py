...
from libs import iterate_over_diffs
from libs import put_into_df
from libs import create_prompt
...
def commit():
    ...
    resp = requests.post('https://api.litcommit.com/predict/commit', json={"prompt": prompt}) 
    # Then commit those
