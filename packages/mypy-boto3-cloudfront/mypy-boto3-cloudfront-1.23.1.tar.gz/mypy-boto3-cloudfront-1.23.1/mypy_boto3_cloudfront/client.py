...
class CloudFrontClient(BaseClient):
    ...
    def delete_cache_policy(self, *, Id: str, IfMatch: str = ...) -> None:
        """
    ...
    def delete_key_group(self, *, Id: str, IfMatch: str = ...) -> None:
        """
        Deletes a key group.
    ...
    def delete_origin_request_policy(self, *, Id: str, IfMatch: str = ...) -> None:
        """
    ...
    def delete_realtime_log_config(self, *, Name: str = ..., ARN: str = ...) -> None:
        """
    ...
    def delete_response_headers_policy(self, *, Id: str, IfMatch: str = ...) -> None:
        """
