...
class Search():
    ...
    def fit_mxl(self, dat, test_df, as_vars, is_vars, rand_vars, bcvars, corvars,
        ...
        try:
            ...
            logel.debug("model convergence", model.convergence)
        ...
        while itr < max_itr:
            ...
            if itr == max_itr:  # Plot on final iteration
                ...
                if self.multi_objective:  # Plot for MOOF
                    ...
                    lns4 = ax.plot(pareto_bic, pareto_val, color="r", label="Pareto Front")
                    ...
                    # TODO: REMOVE 100000?
                    current_bic_points = [har_mem_ii[0] for ii, har_mem_ii in enumerate(har_mem) if har_mem_ii[0] != -1000000.0]
                    # idx = [ii for ii, bic in enumerate(current_bic_points) if bic != -10000000.0]
                    # current_bic_points = [bic_point for bic_point in current_bic_points if bic_point != -1000000.0]  # lazy way to remove both
                    # e[!= 1000000]
                    # current_bic_points = current_bic_points[current_bic_points_idx]
