        ...
        while itr < max_itr:
            ...
            if itr == max_itr:  # Plot on final iteration
                if self.multi_objective:  # Plot for MOOF
                    ...
                    lns1 = ax.scatter(all_bic, all_val)
                    ...
                    lns2 = ax.scatter(init_bic, init_val)
                    ...
                    lns3 = ax.scatter(pareto_bic, pareto_val)
                    lns4 = ax.plot(pareto_bic, pareto_val)
                    lns = lns1 + lns2 + lns3 + lns4
                    labs = [l_pot.get_label() for l_pot in lns]
                    ax.set_xlabel("BIC - training dataset")
                    ax.set_ylabel("MAE - testing dataset")
                    ax.legend(lns, labs, loc='upper center', bbox_to_anchor=(0.5, -0.1))  # TODO! FIX
