...
from cgelib.alignment.KMA.alignment_files import Iterator_ResFile, Iterator_FragmentFile, Iterator_ConsensusFile, Iterator_AlignmentFile, Iterator_MatrixFile, Iterator_VCFFile, Iterator_MapstatFile, Iterator_SPAFile
from cgelib.sequence.SeqHit import KMAHit
from cgelib.utils.file_mixin import CGELibFileError, ResultFile
from cgelib.utils.format_mixin import FormatVariable
from cgelib.sequence.Feature import AlnFeature
    ...
    def iterate_hits(self):
        ...
        while iter_true:
            ...
            for kma_file in self.files:
                if kma_file is "VCF" and len(self.files) > 1:
