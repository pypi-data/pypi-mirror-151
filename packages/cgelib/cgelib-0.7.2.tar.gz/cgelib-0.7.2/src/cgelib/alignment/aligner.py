...
import glob
import json
from cgelib.utils.savers_mixin import SaveJson
...
from cgelib.sequence.SeqHit import AlnHit
from cgelib.applications.command import CommandResume
from cgelib.alignment.blast.alignment_files import Iterator_BlastSepFile
...
class _Aligner:
    ...
    def __init__(self, aligner=None, commandline_exec=None, result_file=None):
        ...
        self.result_dict = Result.init_software_result(name="cgelib",
                                                       gitdir=None,
                                                       type="python_module")
