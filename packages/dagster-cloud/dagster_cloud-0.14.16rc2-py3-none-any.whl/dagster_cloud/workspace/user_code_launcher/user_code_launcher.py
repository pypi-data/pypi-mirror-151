...
class DagsterCloudUserCodeLauncher(
    ...
    def _update_workspace_entry(
        ...
        excluded_handles: Optional[List[ServerHandle]] = None,
    ):
            ...
            with open(dst, "rb") as f:
                ...
                if self.is_dev_sandbox():
                    connection_info = self.get_sandbox_connection_info(
                        workspace_entry.location_name, excluded_handles
                    )
    ...
    def _update_location_data(
        ...
        try:
            ...
            self._update_workspace_entry(loaded_workspace_entry, excluded_handles)
        except Exception:
    ...
    def get_sandbox_connection_info(
        self, location_name: str, excluded_handles: Optional[List[ServerHandle]] = None
    ) -> DagsterCloudSandboxConnectionInfo:
        pass
        ...
        for to_update_key in to_update_keys:
            ...
            if to_update_key in upload_locations:
                ...
                self._update_location_data(
                    ...
                    existing_server_handles[to_update_key],
                )
