...
mod.add_function('tokenizer_Merge_CTor', retval('int64_t'), [])
mod.add_function('tokenizer_Merge_Merge_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('tokenizer_Merge_Count_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('tokenizer_Merge_Count_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
mod.add_function('tokenizer_WordCount_CTor', retval('int64_t'), [])
mod.add_function('tokenizer_WordCount_Pieces_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('tokenizer_WordCount_Pieces_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
mod.add_function('tokenizer_WordCount_Count_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('tokenizer_WordCount_Count_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
...
add_checked_function(mod, 'tokenizer_CountReader', retval('int64_t'), [param('int64_t', 'reader')])
add_checked_function(mod, 'tokenizer_CountString', retval('int64_t'), [param('char*', 's')])
add_checked_function(mod, 'tokenizer_MergeCounts', None, [param('int64_t', 'a'), param('int64_t', 'b'), param('bool', 'goRun')])
