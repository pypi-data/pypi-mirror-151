...
@jsii.data_type(
    jsii_type="@aws-cdk/aws-cognito.BaseUrlOptions",
    jsii_struct_bases=[],
...
class UserPool(
    ...
    def __init__(
        ...
        *,
        ...
        custom_sender_kms_key: typing.Optional[aws_cdk.aws_kms.IKey] = None,
...
class UserPoolEmail(
    ...
    jsii_type="@aws-cdk/aws-cognito.UserPoolEmail",
):
    ...
    def with_ses(
        ...
        *,
        ...
        :param ses_verified_domain: SES Verified custom domain to be used to verify the identity. Default: - no domain
        '''
...
class UserPoolProps:
    ...
    @builtins.property
    def custom_sender_kms_key(self) -> typing.Optional[aws_cdk.aws_kms.IKey]:
...
@jsii.data_type(
    jsii_type="@aws-cdk/aws-cognito.UserPoolSESOptions",
    jsii_struct_bases=[],
    name_mapping={
...
class UserPoolTriggers:
    def __init__(
        ...
        *,
        ...
        custom_email_sender: typing.Optional[aws_cdk.aws_lambda.IFunction] = None,
        custom_message: typing.Optional[aws_cdk.aws_lambda.IFunction] = None,
        custom_sms_sender: typing.Optional[aws_cdk.aws_lambda.IFunction] = None,
    ...
    @builtins.property
    def custom_email_sender(self) -> typing.Optional[aws_cdk.aws_lambda.IFunction]:
        '''Amazon Cognito invokes this trigger to send email notifications to users.
    ...
    @builtins.property
    def custom_sms_sender(self) -> typing.Optional[aws_cdk.aws_lambda.IFunction]:
