...
def export(history):
    ...
    f = "accuracy_15_min_{}.png".format(str(datetime.datetime.now()))
    plt.savefig(os.path.join(os.getcwd(), "output", "graphs", f))
    ...
    f = "loss_15_min_{}.png".format(str(datetime.datetime.now()))
    plt.savefig(os.path.join(os.getcwd(), "output", "graphs", f))