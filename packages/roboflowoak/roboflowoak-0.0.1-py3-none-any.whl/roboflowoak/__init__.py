...
class RoboflowOak:
    def __init__(self, model, version, api_key, rgb=False, depth=False, device=None, device_name="device", blocking=True, legacy=False):
        self.project = model
...
class OAKThread(threading.Thread, RoboflowOak):
    def __init__(self, threadID, name, counter, onDetect, project, version, api_key, rgb=True, depth=False, device=None, blocking=True, legacy=False):
        RoboflowOak.__init__(self, project, version, api_key, rgb, depth, device, blocking, legacy)
