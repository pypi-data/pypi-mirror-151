                ...
                while True:
                    ...
                    if status:
                        if "error" in status[0]:
                            print("DEBUG: RAISING FlureeTransactionFailure")
                        ...
                        print("DEBUG: Returning status:", status[0])
                        return status[0]
                    if try_count >= 50:
                        print("DEBUG: RAISING FlureeTransactionFailure, too many tries")
                        raise FlureeTransactionFailure("Transaction took too long")
                    await asyncio.sleep(0.1)
