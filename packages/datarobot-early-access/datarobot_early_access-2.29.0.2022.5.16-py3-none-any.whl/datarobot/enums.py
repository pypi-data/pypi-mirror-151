...
class _SHARED_TARGET_TYPE(object):
...
class FeatureDiscoveryMode(object):
    DEFAULT = "default"
    MANUAL = "manual"
    ALL = (DEFAULT, MANUAL)
...
class UnsupervisedTypeEnum(object):
    ANOMALY = "anomaly"
    CLUSTERING = "clustering"


class FairnessMetricsSet(object):
...
class ImageResampleMethod(object):
    NEAREST = NONE = 0
    LANCZOS = ANTIALIAS = 1
    BILINEAR = LINEAR = 2
    BICUBIC = CUBIC = 3
