...
class Article(Entity):
    ...
    def last_update(self) -> str:
        ...
        if 'last_update' in self._metadata and 'date' in self._metadata['last_update']:
            return self._metadata['last_update']['date']
        elif 'update_date' in self._metadata and 'date' in self._metadata['update_date']:
            return self._metadata['update_date']['date']
        else:
            return ''
    ...
    def creation_date(self) -> str:
        ...
        if 'creation_date' in self._metadata and 'date' in self._metadata['creation_date']:
            return self._metadata['creation_date']['date']
        else:
            return ''
    ...
    def notification_date(self) -> str:
        ...
        if 'notification_date' in self._metadata and 'date' in self._metadata['notification_date']:
            return self._metadata['notification_date']['date']
        else:
            return ''
    ...
    def excerpt(self) -> str:
        if 'sections' in self._metadata and 'excerpt' in self._metadata['sections']:
