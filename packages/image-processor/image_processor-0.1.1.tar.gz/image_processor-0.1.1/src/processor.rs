...
pub fn resize_image(resize_to: f32, input_path: String, output_path: String) {
    ...
    let width: f32 = image_diamensions.0 as f32 * resize_to;
    let height: f32 = image_diamensions.1 as f32 * resize_to;
