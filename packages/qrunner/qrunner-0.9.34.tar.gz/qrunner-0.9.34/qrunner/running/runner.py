...
class TestMain(object):
    ...
    def __init__(self,
        ...
        """
        :param platform str: 平台，如browser、android、ios、api
        ...
        :param browser_name str: 浏览器类型，如chrome、其他暂不支持
        ...
        if self.headers is not None:
            conf.set_name('common', 'headers', headers)
        if login_key is not None:
            conf.set_name('api', 'login_key', login_key)
        ...
        # 用例完成后操作
        conf.set_name('common', 'headers', {})  # 清除登录态
