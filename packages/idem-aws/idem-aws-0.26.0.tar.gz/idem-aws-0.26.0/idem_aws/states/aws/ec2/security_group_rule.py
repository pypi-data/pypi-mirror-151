...
async def present(
    ...
    cidr_ipv4_desc: str = None,
    cidr_ipv6_desc: str = None,
    prefix_list_id_desc: str = None,
) -> Dict[str, Any]:
    r"""
    **Autogenerated function**
          ...
          aws.ec2.security_group_rule.present:
            ...
            - tags:
                - Key: 'string'
                  Value: 'string'
            - description: 'string'
            - cidr_ipv4_desc: 'string'
            - cidr_ipv6_desc: 'string'
            - prefix_list_id_desc: 'string'
        ...
        .. code-block:: sls
            ...
            my-sg-rule:
              aws.ec2.security_group_rule.present:
                ...
                - cidr_ipv4_desc: 'This is new cidr_ipv4_desc'
                - cidr_ipv6_desc: 'This is new cidr_ipv6_desc'
                - prefix_list_id_desc: 'This is new prefix_list_id_desc'
    """
    ...
    if before and before["result"] and before["ret"]["SecurityGroupRules"]:
        ...
        update_ret = (
            await hub.exec.aws.ec2.security_group_rule.update_security_group_rule(
                ctx,
        ...
        if ctx.get("test", False):
            result["new_state"] = hub.tool.aws.test_state_utils.generate_test_state(
                ...
                desired_state={
                    ...
                    "tags": tags,
                    "description": description,
                    "cidr_ipv4_desc": cidr_ipv4_desc,
                    "cidr_ipv6_desc": cidr_ipv6_desc,
                    "prefix_list_id_desc": prefix_list_id_desc,
                },
            )
        ...
        try:
            ...
            if cidr_ipv4:
                IpRanges = {}
                if cidr_ipv4_desc:
                    IpRanges["Description"] = cidr_ipv4_desc
                if cidr_ipv4:
            ...
            if cidr_ipv6:
                Ipv6Ranges = {}
                if cidr_ipv6_desc:
                    Ipv6Ranges["Description"] = cidr_ipv6_desc
                if cidr_ipv6:
                    Ipv6Ranges["CidrIpv6"] = cidr_ipv6
                ip_perm["Ipv6Ranges"] = [Ipv6Ranges]
            if prefix_list_id:
                prefix_list = {}
                if prefix_list_id_desc:
                    prefix_list["Description"] = prefix_list_id_desc
                if prefix_list_id:
...
async def absent(
    ...
    **Autogenerated function**
    ...
    if (not resource_id) or (not group_id):
        ...
        return result
    resource = hub.tool.boto3.resource.create(ctx, "ec2", "SecurityGroup", group_id)
    before = await hub.exec.boto3.client.ec2.describe_security_group_rules(
        ctx, SecurityGroupRuleIds=[resource_id]
    )
