...
async def present(
    ...
    **Autogenerated function**
    ...
    if before and before["ret"].get("DBSubnetGroups"):
        ...
        old_tags = await hub.exec.aws.neptune.tag.get_tags_for_resource(
        ...
        resource_translated = hub.tool.aws.neptune.conversion_utils.convert_raw_db_subnet_group_to_present(
        ...
        if (
            ...
            resource_updated = True
            update_ret = await hub.exec.aws.neptune.tag.update_tags(
                ctx=ctx,
...
async def absent(hub, ctx, name: str, resource_id: str = None) -> Dict[str, Any]:
    ...
    **Autogenerated function**
    ...
    result[
        "old_state"
    ] = hub.tool.aws.neptune.conversion_utils.convert_raw_db_subnet_group_to_present(
