...
URL = "https://github.com/zackees/vids-db-server"
EMAIL = "dont@email.me"
AUTHOR = "Zach Vorhies"
...
def get_version() -> str:
    with open(os.path.join(HERE, "vids_db_server", "version.py"), encoding="utf-8", mode="rt") as fd:
...
setup(
    ...
    entry_points={
        "console_scripts": [
            "vids_db_server = vids_db_server.cmd:main",
        ],
    },
