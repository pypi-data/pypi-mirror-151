...
# FIXME TODO when main error occurs
#sapirunner_rbfan-6aARaqVjA_1  | ValueError: Port could not be cast to integer value as '172.17.0.1:10443'
#sapirunner_rbfan-6aARaqVjA_1  | Error in atexit._run_exitfuncs:
#sapirunner_rbfan-6aARaqVjA_1  | Traceback (most recent call last):
#sapirunner_rbfan-6aARaqVjA_1  |   File "/usr/local/lib/python3.8/dist-packages/sapiadapter/s_cleanup.py", line 27, in cleanup
#sapirunner_rbfan-6aARaqVjA_1  |     s_db.filepath_delete( )
#sapirunner_rbfan-6aARaqVjA_1  |   File "/usr/local/lib/python3.8/dist-packages/sapiadapter/s_db.py", line 57, in filepath_delete
#sapirunner_rbfan-6aARaqVjA_1  |     fp = filepath_get( )
#sapirunner_rbfan-6aARaqVjA_1  |   File "/usr/local/lib/python3.8/dist-packages/sapiadapter/s_db.py", line 49, in filepath_get
#sapirunner_rbfan-6aARaqVjA_1  |     dbcon = sqlite3.connect( fp )
#sapirunner_rbfan-6aARaqVjA_1  | sqlite3.OperationalError: unable to open database file
...
def files_create( fp , trimpath = "" ) :
    ...
    if( trimpath != "" ) :
        #s_log.write( "trimpath=" + trimpath )
        fp_processed = fp.lstrip( trimpath )
