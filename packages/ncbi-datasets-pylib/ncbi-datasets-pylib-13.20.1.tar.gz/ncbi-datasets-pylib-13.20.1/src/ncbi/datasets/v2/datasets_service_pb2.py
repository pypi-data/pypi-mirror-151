...
_ASSEMBLYDATASET = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\302\360\031\311\t\n\233\003\010\001\0225/v2alpha/genome/accession/{accessions}/dataset_report*!Get dataset reports by accessions2\233\001Get dataset reports by accessions.  By default, in paged JSON format, but also available as tabular (accept: x-tabular) or json-lines (accept: x-jsonlines):\025genome_dataset_reportB\006GenomeJ\010hydratedJ\013include_tsvJ\006taxonsZ\033v2reportsAssemblyDataReporth\001r\020application/jsonr\031text/tab-separated-valuesr\025application/x-tabular\n\231\003\010\001\022-/v2alpha/genome/taxon/{taxons}/dataset_report*\035Get dataset reports by taxons2\227\001Get dataset reports by taxons.  By default, in paged JSON format, but also available as tabular (accept: x-tabular) or json-lines (accept: x-jsonlines):\037genome_dataset_reports_by_taxonB\006GenomeJ\010hydratedJ\013include_tsvJ\naccessionsZ\033v2reportsAssemblyDataReporth\001r\020application/jsonr\031text/tab-separated-valuesr\025application/x-tabular\n\214\003\010\002\022\036/v2alpha/genome/dataset_report*!Get dataset reports by accessions2\233\001Get a dataset report by accession.  By default, in paged JSON format, but also available as tabular (accept: x-tabular) or json-lines (accept: x-jsonlines):\035genome_dataset_report_by_postB\006GenomeJ\010hydratedJ\013include_tsvJ\006taxonsZ\033v2reportsAssemblyDataReporth\001r\020application/jsonr\031text/tab-separated-valuesr\025application/x-tabular',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
...
_VIRUSDOWNLOAD = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\302\360\031\372\001\n\367\001\010\001\022,/v2alpha/virus/taxon/{taxon}/genome/download*.Download a coronavirus genome dataset by taxon2.Download a coronavirus genome dataset by taxon:\025virus_genome_downloadB\005VirusJ\taccessionJ\025accessions.accessionsJ\014table_fieldsJ\006formatr\017application/zip',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_protobuf_dot_wrappers__pb2._BYTESVALUE,
    serialized_options=b'\302\360\031\373\001\n\370\001\010\001\0226/v2alpha/virus/taxon/sars2/protein/{proteins}/download*<Download SARS-CoV-2 protein and CDS datasets by protein name2&Download a SARS-CoV-2 protein datasets:\026sars2_protein_downloadB\005VirusJ\020exclude_sequenceJ\014table_fieldsJ\006formatr\017application/zip',
    create_key=_descriptor._internal_create_key,
  ),
])
...
_GENEDATASET = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\302\360\031\320\021\n\264\003\010\001\022\033/v2alpha/gene/id/{gene_ids}*\032Get gene reports by GeneID2\225\001Get a gene summary by GeneID. By default, in paged JSON format, but also available as tabular (accept: x-tabular) or json-lines (accept: x-jsonlines):\022gene_reports_by_idB\004GeneJ\027symbols_for_taxon.taxonJ\031symbols_for_taxon.symbolsJ\021symbols_for_taxonJ\naccessionsJ\005taxonJ\005queryJ\005typesZ\027v2reportsGeneDataReporth\001r\020application/jsonr\031text/tab-separated-valuesr\025application/x-tabular\n\330\003\010\001\022$/v2alpha/gene/accession/{accessions}*%Get gene metadata by RefSeq Accession2\237\001Get a gene summary by RefSeq Accession. By default, in paged JSON format, but also available as tabular (accept: x-tabular) or json-lines (accept: x-jsonlines):\032gene_metadata_by_accessionB\004GeneJ\027symbols_for_taxon.taxonJ\031symbols_for_taxon.symbolsJ\021symbols_for_taxonJ\010gene_idsJ\005taxonJ\005queryJ\005typesZ\027v2reportsGeneDataReporth\001r\020application/jsonr\031text/tab-separated-valuesr\025application/x-tabular\n\217\004\010\001\022P/v2alpha/gene/symbol/{symbols_for_taxon.symbols}/taxon/{symbols_for_taxon.taxon}* Get gene metadata by gene symbol2\235\001Get a gene summary by by gene symbol. By default, in paged JSON format, but also available as tabular (accept: x-tabular) or json-lines (accept: x-jsonlines):\037gene_metadata_by_tax_and_symbolB\004GeneJ\naccessionsJ\010gene_idsJ\005taxonJ\005queryJ\005typesR$\n\031symbols_for_taxon.symbols\022\007symbolsR \n\027symbols_for_taxon.taxon\022\005taxonZ\027v2reportsGeneDataReporth\001r\020application/jsonr\031text/tab-separated-valuesr\025application/x-tabular\n\360\003\010\001\022\033/v2alpha/gene/taxon/{taxon}*(Get gene reports by taxonomic identifier2\313\001Get a gene summary for a specified NCBI Taxonomy ID or name (common or scientific). By default, in paged JSON format, but also available as tabular (accept: x-tabular) or json-lines (accept: x-jsonlines):\025gene_reports_by_taxonB\004GeneJ\027symbols_for_taxon.taxonJ\031symbols_for_taxon.symbolsJ\021symbols_for_taxonJ\naccessionsJ\010gene_idsZ\027v2reportsGeneDataReporth\001r\020application/jsonr\031text/tab-separated-valuesr\025application/x-tabular\n\266\002\010\002\022\r/v2alpha/gene*\031Get gene metadata as JSON2\213\001Get a gene summary. By default, in paged JSON format, but also available as tabular (accept: x-tabular) or json-lines (accept: x-jsonlines):\025gene_metadata_by_postB\004GeneZ\027v2reportsGeneDataReporth\001r\020application/jsonr\031text/tab-separated-valuesr\025application/x-tabular',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='GetDownloadSummary',
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=ncbi_dot_datasets_dot_v2_dot_reports_dot_gene__pb2._ORTHOLOGSET,
    serialized_options=b'\302\360\031\272\001\n\267\001\010\001\022$/v2alpha/gene/id/{gene_id}/orthologs*\035Get gene orthologs by gene ID2RGet detailed gene metadata for an ortholog set by gene ID in a JSON output format.:\024gene_orthologs_by_idB\004Gene',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='GetGeneLinks',
...
_VIRUSDATASET = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    input_type=ncbi_dot_datasets_dot_v2_dot_datasets__pb2._VIRUSDATASETREQUEST,
    output_type=ncbi_dot_datasets_dot_v2_dot_datasets__pb2._DOWNLOADSUMMARY,
    serialized_options=b'\302\360\031\375\001\n\372\001\010\001\022#/v2alpha/virus/taxon/{taxon}/genome*3Get summary data for Coronaviridae genomes by taxon2^Get summary data and download by command line instructions for Coronaviridae genomes by taxon.:\024virus_genome_summaryB\005VirusJ\taccessionJ\014table_fieldsJ\006format',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\302\360\031\204\002\n\201\002\010\001\022)/v2alpha/virus/taxon/{taxon}/genome/table*/Get viral genomic metadata in a tabular format.2PGet viral genomic metadata in tabular format for Coronaviridae genomes by taxon.:\022virus_genome_tableB\005VirusJ\020exclude_sequenceJ\027include_annotation_typeJ\taccession',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\302\360\031\201\t\n\221\003\010\001\0222/v2alpha/virus/taxon/{filter.taxon}/dataset_report*\033Get virus metadata by taxon2\224\001Get virus metadata by taxon. By default, in paged JSON format, but also available as tabular (accept: x-tabular) or json-lines (accept: x-jsonlines):\026virus_reports_by_taxonB\005VirusJ\021filter.accessionsR\025\n\014filter.taxon\022\005taxonZ\026v2reportsVirusAssemblyh\001r\020application/jsonr\031text/tab-separated-valuesr\025application/x-tabular\n\252\003\010\001\022;/v2alpha/virus/accession/{filter.accessions}/dataset_report*\037Get virus metadata by accession2\227\001Get virus metadata by accesion. By default, in paged JSON format, but also available as tabular (accept: x-tabular) or json-lines (accept: x-jsonlines):\032virus_reports_by_acessionsB\005VirusJ\014filter.taxonR\037\n\021filter.accessions\022\naccessionsZ\026v2reportsVirusAssemblyh\001r\020application/jsonr\031text/tab-separated-valuesr\025application/x-tabular\n\275\002\010\002\022\016/v2alpha/virus*\032Get virus metadata by POST2\213\001Get virus metadata. By default, in paged JSON format, but also available as tabular (accept: x-tabular) or json-lines (accept: x-jsonlines):\025virus_reports_by_postB\005VirusZ\033v2alphareportsVirusAssemblyh\001r\020application/jsonr\031text/tab-separated-valuesr\025application/x-tabular',
    create_key=_descriptor._internal_create_key,
  ),
])
