...
from vgs_api_client import rest
from vgs_api_client.configuration import Configuration
from vgs_api_client.exceptions import ApiTypeError, ApiValueError, ApiException
from vgs_api_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'vgs-api-client/0.0.1-dev202205210037/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AliasesApi()
        api_instance.create_aliases  # this is an instance of the class Endpoint
        api_instance.create_aliases()  # this invokes api_instance.create_aliases.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_aliases.callable or self.callable in this class
