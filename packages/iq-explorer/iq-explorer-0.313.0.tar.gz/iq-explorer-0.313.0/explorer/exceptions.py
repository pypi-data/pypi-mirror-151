...
This module defines exceptions for Explorer operations. It follows the structure
defined in pep-0249.
"""
...
class ExplorerAuthError(Exception):
    pass
...
class ExplorerQueryError(Exception):
    ...
    @property
    def message(self):
        return self._error.get("message", "Explorer did no return an error message")
...
class ExplorerExternalError(ExplorerQueryError):
    pass


class ExplorerInternalError(ExplorerQueryError):
    pass


class ExplorerUserError(ExplorerQueryError):
    pass
