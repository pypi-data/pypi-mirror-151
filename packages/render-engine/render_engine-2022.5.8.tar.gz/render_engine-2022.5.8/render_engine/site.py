...
class Site:
    ...
    def render_collection(self, collection: typing.Type[Collection]) -> None:
        ...
        collection_path = self.output_path / _collection.output_path
        ...
        if hasattr(_collection, "feed"):
            ...
            feed.render(path=self.output_path, **self.site_vars, **collection_vars)
    ...
    def render_page(self, page) -> None:
        ...
        with p:
            ...
            _page.render(path=self.output_path, **page.__dict__)

    def render_static(self, directory) -> None:
        """Copies a Static Directory to the output folder"""
        return shutil.copytree(directory, self.output_path / directory, dirs_exist_ok=True)
