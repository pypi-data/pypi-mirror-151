...
import argparse
import json
from bioblu.bioblu.ds_manage import image_cutting
...
# python3 create_tiles.py -s /media/findux/DATA/Documents/Malta_II/surveys/2022-05-03_Ramla/DJI_0154-002_24_frame_interval/tiling_test/ -th 3 -tv 2 -a 7 --save-tiles --save-csv --location "Ramla" -gps "False"