...
def main(**kwargs):
    kwargs["materials_dict"] = ds_annotations.create_materials_dict(kwargs["materials_dict"])
...
if __name__ == "__main__":
    ...
    parser.add_argument("-mats", "--materials", type=str, default=None, dest="materials_dict", nargs="+", help="Materials (in order of class indices)")
    ...
    parser.add_argument("-i", "--iterations", type=int, default=10_000, dest="iterations", help="Number of iterations.")
    ...
    parser.add_argument("--img-size", type=int, nargs=2, default=(1600, 1900), dest="img_size_minmax")
    ...
    parser.add_argument("-w", "--workers", type=int, default=2, dest="number_of_workers")
    parser.add_argument("-ni", "--imgs-per-batch", type=int, default=2, dest="imgs_per_batch")
    parser.add_argument("-lr", "--base-lr", type=float, default=0.00025, dest="base_lr", help="Base learning rate.")
    parser.add_argument("-ld", "--lr-decay", default=list(), dest="lr_decay", help="Learning rate decay.")
    ...
    parser.add_argument("-iou", "--roi-heads-iou-thresh", type=float, default=0.05, dest="roi_heads_iou_thresh")
    parser.add_argument("--roi-heads-nms-thresh", type=float, default=0.5, dest="roi_heads_nms_thresh")
    parser.add_argument("-ct", "--roi-conf-train", type=float, default=0.05, dest="roi_heads_score_thresh_train")
    parser.add_argument("-cv", "--roi-conf-test", type=float, default=0.05, dest="roi_heads_score_thresh_test")
    parser.add_argument("--rpn-nms-thresh", type=float, default=0.7, dest="rpn_nms_thresh")
    parser.add_argument("--rpn-batch-size-per-img", type=int, default=256, dest="rpn_batch_size_per_img")
    parser.add_argument("--retinanet-score-thresh-test", type=float, default=0.05, dest="retinanet_score_thresh_test")
    parser.add_argument("--retinanet-nms-thresh-test", type=float, default=0.5, dest="retinanet_nms_thresh_test")
    parser.add_argument("--retinanet-iou-threshs", type=float, nargs=2, default=list((0.4, 0.5)), dest="retinanet_iou_threshs")
    parser.add_argument("-c", "--color-mode", type=str, default="BGR", dest="color_mode")
