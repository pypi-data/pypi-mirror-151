...
from bioblu.ds_manage import geoprocessing, image_cutting, ds_annotations
...
class GeoprocessingTests(unittest.TestCase):
    ...
    def test_extract_coordinates(self):
        img_path = "/bioblu/unittests/DJI_0503_resized.JPG"
        coords = geoprocessing.extract_coordinates_from_img(img_path)
...
class ImageCuttingTests(unittest.TestCase):
    def test_calculate_center(self):
        self.assertEqual(image_cutting.calculate_center((400, 200)), (200, 100))
        self.assertEqual(image_cutting.calculate_center((703, 200)), (351, 100))
        self.assertEqual(image_cutting.calculate_center((923, 305)), (461, 152))
