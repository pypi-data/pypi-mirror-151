...
from tensorflow_probability.substrates.jax.distributions import cholesky_util
...
from tensorflow_probability.substrates.jax.math.psd_kernels.internal import util as psd_kernels_util
  ...
  def posterior_predictive(
    ...
    Returns:
      gprm: An instance of `Distribution` that represents the posterior
        predictive.
    """
    from tensorflow_probability.substrates.jax.distributions import gaussian_process_regression_model as gprm  # pylint:disable=g-import-not-at-top
