...
parser.add_argument('-data_dir', metavar='DIR', default='/mnt/f/NaroNet/Datasets/STK11_TP53vsSTK11/', 
...
parser.add_argument('-n_crops_per_image', default=15, type=int,                    
                    help='Number of images used in each iteration')    
parser.add_argument('-patch_size', default=60, type=int,                 
                    help='Number of images used in each iteration')     
parser.add_argument('-stride', default=0, type=int,                 
                    help='Number of images used in each iteration')                         
parser.add_argument('-alpha_L', default=1.15, type=int,                 
                    help='ALPHA_L')                   
