...
class BaseRealTimeHandler(System.Object, QuantConnect.Scheduling.IEventSchedule, metaclass=abc.ABCMeta):
    ...
    def AddAlgorithmEndOfDayEvent(self, start: typing.Union[datetime.datetime, datetime.date], end: typing.Union[datetime.datetime, datetime.date], currentUtcTime: typing.Optional[datetime.datetime] = None) -> None:
        """
        Creates a new ScheduledEvent that will fire before market close by the specified time
        ...
        """
        warnings.warn("This method is deprecated. It will add ScheduledEvents for the deprecated IAlgorithm.OnEndOfDay()", DeprecationWarning)

    def AddSecurityDependentEndOfDayEvents(self, securities: System.Collections.Generic.IEnumerable[QuantConnect.Securities.Security], start: typing.Union[datetime.datetime, datetime.date], end: typing.Union[datetime.datetime, datetime.date], currentUtcTime: typing.Optional[datetime.datetime] = None) -> None:
        """
    ...
    def Setup(self, start: typing.Union[datetime.datetime, datetime.date], end: typing.Union[datetime.datetime, datetime.date], language: QuantConnect.Language, currentUtcTime: typing.Optional[datetime.datetime] = None) -> None:
        """
        Initializes the real time handler for the specified algorithm and job.
        Adds EndOfDayEvents
