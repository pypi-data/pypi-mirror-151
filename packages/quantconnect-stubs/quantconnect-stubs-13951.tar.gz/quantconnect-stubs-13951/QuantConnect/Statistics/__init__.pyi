...
class KellyCriterionManager(System.Object):
    ...
    def AddNewValue(self, newValue: float, time: typing.Union[datetime.datetime, datetime.date]) -> None:
        """
