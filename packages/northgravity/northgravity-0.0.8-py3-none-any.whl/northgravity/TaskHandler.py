...
from . import PIPELINE_ID, LOGGER_NAME
...
class TaskHandler:
    ...
    def upload_to_output_parameter(self, output_name, file, group_name, file_upload_name=None, file_type='SOURCE', partial_update=False):
        '''
