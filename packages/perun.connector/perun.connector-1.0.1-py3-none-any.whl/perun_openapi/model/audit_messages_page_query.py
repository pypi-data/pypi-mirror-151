...
class AuditMessagesPageQuery(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, page_size, offset, order, *args, **kwargs):  # noqa: E501
        """AuditMessagesPageQuery - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, page_size, offset, order, *args, **kwargs):  # noqa: E501
        """AuditMessagesPageQuery - a model defined in OpenAPI
