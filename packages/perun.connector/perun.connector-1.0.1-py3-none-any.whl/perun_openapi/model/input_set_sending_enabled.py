...
class InputSetSendingEnabled(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'mails': ([ApplicationMail],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, mails, enabled, *args, **kwargs):  # noqa: E501
        """InputSetSendingEnabled - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, mails, enabled, *args, **kwargs):  # noqa: E501
        """InputSetSendingEnabled - a model defined in OpenAPI
