...
class InputDeleteGroups(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, groups, force_delete, *args, **kwargs):  # noqa: E501
        """InputDeleteGroups - a model defined in OpenAPI

        Args:
            groups ([int]):
            force_delete (bool): boolean for force delete
    ...
    @convert_js_args_to_python_args
    def __init__(self, groups, force_delete, *args, **kwargs):  # noqa: E501
        """InputDeleteGroups - a model defined in OpenAPI
