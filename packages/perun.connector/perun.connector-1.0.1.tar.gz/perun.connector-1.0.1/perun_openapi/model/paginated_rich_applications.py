...
def lazy_import():
    ...
    globals()['RichApplication'] = RichApplication


class PaginatedRichApplications(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'data': ([RichApplication],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, offset, page_size, total_count, data, *args, **kwargs):  # noqa: E501
        """PaginatedRichApplications - a model defined in OpenAPI

        Args:
            offset (int):
            page_size (int):
            total_count (int):
            data ([RichApplication]):
