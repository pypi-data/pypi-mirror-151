...
class InputCreateMemberForUser(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, vo, user, *args, **kwargs):  # noqa: E501
        """InputCreateMemberForUser - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, vo, user, *args, **kwargs):  # noqa: E501
        """InputCreateMemberForUser - a model defined in OpenAPI
