...
class Sponsor(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, user, user_ext_sources, user_attributes, validity_to, active, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            validity_to (str): Date in format yyyy-MM-dd}
            active (bool):
    ...
    @convert_js_args_to_python_args
    def __init__(self, user, user_ext_sources, user_attributes, validity_to, active, *args, **kwargs):  # noqa: E501
        """Sponsor - a model defined in OpenAPI
