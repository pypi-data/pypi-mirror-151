...
class InputSetUserAttributes(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, user, attributes, *args, **kwargs):  # noqa: E501
        """InputSetUserAttributes - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, user, attributes, *args, **kwargs):  # noqa: E501
        """InputSetUserAttributes - a model defined in OpenAPI
