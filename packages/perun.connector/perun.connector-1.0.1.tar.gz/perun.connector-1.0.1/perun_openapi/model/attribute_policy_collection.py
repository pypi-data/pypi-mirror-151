...
class AttributePolicyCollection(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'id': (int,),  # noqa: E501
            'attribute_id': (int,),  # noqa: E501
            'action': (AttributeAction,),  # noqa: E501
            'policies': ([AttributePolicy],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, attribute_id, action, policies, *args, **kwargs):  # noqa: E501
        """AttributePolicyCollection - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, attribute_id, action, policies, *args, **kwargs):  # noqa: E501
        """AttributePolicyCollection - a model defined in OpenAPI
