...
class AddUserExtSourceInput(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, user, user_ext_source, *args, **kwargs):  # noqa: E501
        """AddUserExtSourceInput - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, user, user_ext_source, *args, **kwargs):  # noqa: E501
        """AddUserExtSourceInput - a model defined in OpenAPI
