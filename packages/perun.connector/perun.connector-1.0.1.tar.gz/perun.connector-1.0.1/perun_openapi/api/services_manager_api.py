...
class ServicesManagerApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_assigned_services_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/json/servicesManager/getAssignedServices',
        ...
        self.get_data_with_groups_endpoint = _Endpoint(
            settings={
                'response_type': (ServiceAttributes,),
                'auth': [
                    'ApiKeyAuth',
                    'BasicAuth',
                    'BearerAuth'
                ],
                'endpoint_path': '/json/servicesManager/getDataWithGroups',
                'operation_id': 'get_data_with_groups',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'attribute_map': {
                    'service': 'service',
                    'facility': 'facility',
                    'filter_expired_members': 'filterExpiredMembers',
                },
                'location_map': {
                    'service': 'query',
                    'facility': 'query',
                    'filter_expired_members': 'query',
                },
                'collection_format_map': {
                }
            },
        ...
        self.get_data_with_vos_endpoint = _Endpoint(
            settings={
                'response_type': (ServiceAttributes,),
                'auth': [
                    'ApiKeyAuth',
                ...
                'endpoint_path': '/json/servicesManager/getDataWithVos',
                'operation_id': 'get_data_with_vos',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_flat_data_endpoint = _Endpoint(
            settings={
                'response_type': (ServiceAttributes,),
                'auth': [
                    'ApiKeyAuth',
                ...
                'endpoint_path': '/json/servicesManager/getFlatData',
                'operation_id': 'get_flat_data',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_hierarchical_data_endpoint = _Endpoint(
            settings={
                'response_type': (ServiceAttributes,),
                'auth': [
                    'ApiKeyAuth',
                ...
                'endpoint_path': '/json/servicesManager/getHierarchicalData',
                'operation_id': 'get_hierarchical_data',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_data_with_groups(
        self,
        service,
        facility,
        **kwargs
    ):
        """Generates the list of attributes per each member associated with the resources and groups.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_data_with_groups(service, facility, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            filter_expired_members (bool): if true the method does not take members expired in groups into account. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['facility'] = \
            facility
        return self.get_data_with_groups_endpoint.call_with_http_info(**kwargs)

    def get_data_with_vos(
        self,
        service,
        facility,
        **kwargs
    ):
        """Generates the list of attributes per each member associated with the resources and groups in vos.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_data_with_vos(service, facility, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['facility'] = \
            facility
        return self.get_data_with_vos_endpoint.call_with_http_info(**kwargs)
    ...
    def get_flat_data(
        ...
        **kwargs
        ...
        """Generates the list of attributes per each user and per each resource. Never return member or member-resource attribute.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_flat_data(service, facility, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['facility'] = \
            facility
        return self.get_flat_data_endpoint.call_with_http_info(**kwargs)
    ...
    def get_hierarchical_data(
        ...
        **kwargs
        ...
        """Generates the list of attributes per each member associated with the resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_hierarchical_data(service, facility, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['facility'] = \
            facility
        return self.get_hierarchical_data_endpoint.call_with_http_info(**kwargs)
