...
class InputAddDestinationToMultipleServices(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, services, facility, destination, type, *args, **kwargs):  # noqa: E501
        """InputAddDestinationToMultipleServices - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, services, facility, destination, type, *args, **kwargs):  # noqa: E501
        """InputAddDestinationToMultipleServices - a model defined in OpenAPI
