...
class InputSetFacilityResourceGroupUserMemberAttributes(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, facility, resource, group, user, member, attributes, *args, **kwargs):  # noqa: E501
        """InputSetFacilityResourceGroupUserMemberAttributes - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, facility, resource, group, user, member, attributes, *args, **kwargs):  # noqa: E501
        """InputSetFacilityResourceGroupUserMemberAttributes - a model defined in OpenAPI
