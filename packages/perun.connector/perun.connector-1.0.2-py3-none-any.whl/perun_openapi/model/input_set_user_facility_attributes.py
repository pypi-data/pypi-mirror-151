...
class InputSetUserFacilityAttributes(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, user, facility, attributes, *args, **kwargs):  # noqa: E501
        """InputSetUserFacilityAttributes - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, user, facility, attributes, *args, **kwargs):  # noqa: E501
        """InputSetUserFacilityAttributes - a model defined in OpenAPI
