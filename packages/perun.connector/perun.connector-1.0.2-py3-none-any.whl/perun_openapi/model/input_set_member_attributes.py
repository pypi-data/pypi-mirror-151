...
class InputSetMemberAttributes(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, member, attributes, *args, **kwargs):  # noqa: E501
        """InputSetMemberAttributes - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, member, attributes, *args, **kwargs):  # noqa: E501
        """InputSetMemberAttributes - a model defined in OpenAPI
