...
class MembersManagerApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_sponsored_members_endpoint = _Endpoint(
            ...
            params_map={
                'all': [
                    'input_create_sponsored_member1',
                ],
                'required': [
                    'input_create_sponsored_member1',
                ],
            ...
            root_map={
                ...
                'location_map': {
                    'input_create_sponsored_member1': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def create_sponsored_members(
        ...
        **kwargs
        ...
        >>> thread = api.create_sponsored_members(input_create_sponsored_member1, async_req=True)
        >>> result = thread.get()

        Args:
            input_create_sponsored_member1 (InputCreateSponsoredMember1):
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['input_create_sponsored_member1'] = \
            input_create_sponsored_member1
    ...
    def move_membership(
        ...
        **kwargs
        ...
        """Moves membership in VO from source user to target user - moves the source user's memberships in non-synchronized groups, member related attributes, bans and sponsorships in the VO. Removes the source user's member object.  # noqa: E501
