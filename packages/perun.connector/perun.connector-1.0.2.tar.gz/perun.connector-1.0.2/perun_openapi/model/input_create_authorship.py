...
class InputCreateAuthorship(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'authorship': (Authorship,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, authorship, *args, **kwargs):  # noqa: E501
        """InputCreateAuthorship - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, authorship, *args, **kwargs):  # noqa: E501
        """InputCreateAuthorship - a model defined in OpenAPI
