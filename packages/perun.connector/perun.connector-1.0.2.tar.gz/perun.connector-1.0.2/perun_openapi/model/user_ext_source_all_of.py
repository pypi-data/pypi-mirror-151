...
class UserExtSourceAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, login, ext_source, *args, **kwargs):  # noqa: E501
        """UserExtSourceAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, login, ext_source, *args, **kwargs):  # noqa: E501
        """UserExtSourceAllOf - a model defined in OpenAPI
