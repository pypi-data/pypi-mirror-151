...
def get_provider_info():
    return {
        ...
        'operators': [
            ...
            {
                'integration-name': 'AWS Lambda',
                'python-modules': ['airflow.providers.amazon.aws.operators.aws_lambda'],
            },
            {
                'integration-name': 'Amazon Simple Storage Service (S3)',
                'python-modules': [
        ...
        'hooks': [
            ...
            {
                'integration-name': 'Amazon EMR on EKS',
                'python-modules': ['airflow.providers.amazon.aws.hooks.emr_containers'],
            },
            {
                'integration-name': 'Amazon Glacier',
        ...
        'connection-types': [
            {'hook-class-name': 'airflow.providers.amazon.aws.hooks.s3.S3Hook', 'connection-type': 's3'},
            {
