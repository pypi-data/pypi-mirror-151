...
from .models import DataMessage, ReceiptMessage, TypingMessage



class MessageFilter:
    """"""
    def __init__(self, category=None, content=None, source=None):
        """"""
    ...
    def check(self, message):
        ...
        if self.source is not None and self.check_source(message) is False:
            return False
        if self.category is None or self.category == ['all', 'any']:
            return True
    ...
    def check_receipt(self, message):
        """"""
    ...
    def check_attachment(self, message):
        """"""
...
class AND:
    ...
    def check(self, message):
        """"""
        for messagefilter in self.filters:
            if messagefilter.check(message) is False:
                return False
        return True
...
class OR:
    ...
    def check(self, message):
        """"""
        for messagefilter in self.filters:
            if messagefilter.check(message) is True:
                return True
        return False

class NOT:
    """"""
    def __init__(self, messagefilter):
        """"""
