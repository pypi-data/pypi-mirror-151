...
def add_counts_between_related_df(df1, df2, left_on="", right_on="", on=""):
    ...
    Args:
        df1 (DataFrame): Pandas DataFrame, primary table
        df2 (DataFrame): Pandas DataFrame, referenced table
        ...
        Defaults to None. Use on, or left_on and right_on have to provide a value

    Returns:
        True: if sucessful
        
        The calling DataFrames will be mutated to create a new column
