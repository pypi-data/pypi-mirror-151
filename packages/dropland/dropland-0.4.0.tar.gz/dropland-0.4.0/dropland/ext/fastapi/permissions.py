...
from dropland.permissions import BasePermission, PermissionChecker
...
class PermDepends(params.Depends, PermissionChecker):
    def __init__(self, permissions_callables: List[Callable[..., bool]]):
        params.Depends.__init__(self, dependency=self.__call__)
        PermissionChecker.__init__(self, permissions_callables)
