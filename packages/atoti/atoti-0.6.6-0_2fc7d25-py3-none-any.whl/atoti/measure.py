...
from atoti_core import BaseMeasure, Identity, deprecated, keyword_only_dataclass
...
class Measure(MeasureDescription, BaseMeasure):
    ...
    Measures can be compared to other objects, such as a literal value, a :class:`atoti.Level`, or another measure.
    ...
    def _set_folder(self, value: Optional[str]) -> None:
        ...
        self._java_api.set_measure_folder(
            cube_name=self._cube_name, measure_name=self.name, folder=value
        )
    ...
    def formatter(self, value: Optional[str]) -> None:
        ...
        self._java_api.set_measure_formatter(
            cube_name=self._cube_name, measure_name=self.name, formatter=value
        )
        self._java_api.publish_measures(self._cube_name)
    ...
    def visible(self, value: bool) -> None:
        ...
        self._java_api.set_visible(
            cube_name=self._cube_name, measure_name=self.name, visible=value
        )
        self._java_api.publish_measures(self._cube_name)
    ...
    def _set_description(self, value: Optional[str]) -> None:
        ...
        self._java_api.set_measure_description(
            cube_name=self._cube_name, measure_name=self.name, description=value
        )
        self._java_api.publish_measures(self._cube_name)
    ...
    def _required_levels(self) -> Sequence[str]:
        ...
        return self._java_api.get_required_levels(self._cube_name, self.name)
