...
class BrandingConfig(Config):
    """The UI elements to `customize the app <../../../how_tos/customization/customize_the_app.html>`__ by replacing the atoti branding with another one (also called white-labeling).
