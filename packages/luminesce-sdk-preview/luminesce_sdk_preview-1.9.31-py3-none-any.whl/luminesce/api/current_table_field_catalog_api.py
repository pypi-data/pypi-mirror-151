...
class CurrentTableFieldCatalogApi(object):
    ...
    def get_catalog(self, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] GetCatalog: Shows Table and Field level information on Providers that are currently running that you have access to (in Json format)  # noqa: E501
