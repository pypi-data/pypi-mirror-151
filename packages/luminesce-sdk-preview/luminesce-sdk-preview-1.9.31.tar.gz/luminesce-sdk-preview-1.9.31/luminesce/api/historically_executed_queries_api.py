...
class HistoricallyExecutedQueriesApi(object):
    ...
    def cancel_history(self, execution_id, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] CancelHistory: Cancels (if running) or clears the data from (if completed) a previously started History query  # noqa: E501
    ...
    def fetch_history_result_json(self, execution_id, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] FetchHistoryResultJson: Fetches the result from a previously started query, in JSON format.  # noqa: E501
    ...
    def fetch_query_result_histogram(self, execution_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.fetch_query_result_histogram(execution_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.fetch_query_result_histogram_with_http_info(execution_id, **kwargs)  # noqa: E501

    def fetch_query_result_histogram_with_http_info(self, execution_id, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] FetchQueryResultHistogram: Fetches the result from a previously started query, converts it to a histogram (counts in buckets).  # noqa: E501
        ...
        >>> thread = api.fetch_query_result_histogram_with_http_info(execution_id, async_req=True)
        >>> result = thread.get()
    ...
    def get_history(self, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] GetHistory: Shows queries executed in a given historical time window (in Json format).  # noqa: E501
    ...
    def get_progress_of_history(self, execution_id, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] GetProgressOfHistory: View progress information (up until this point) of a history query  # noqa: E501
