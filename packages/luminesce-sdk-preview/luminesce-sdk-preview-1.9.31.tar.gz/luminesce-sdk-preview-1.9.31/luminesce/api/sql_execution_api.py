...
"""
    ...
    The version of the OpenAPI document: 1.9.31
...
class SqlExecutionApi(object):
    ...
    def get_by_query_csv(self, query, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] GetByQueryCsv: Executes Sql, returned in CSV format, where the sql is simply in the url.  # noqa: E501
        ...
        :param query: HoneycombSql to Execute (must be one line only) (required)
        :type query: str
    ...
    def get_by_query_excel(self, query, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] GetByQueryExcel: Executes Sql, returned in Excel (xlsx) format (as a file to be downloaded) format, where the sql is simply in the url.  # noqa: E501
    ...
    def get_by_query_json(self, query, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] GetByQueryJson: Executes Sql, returned in JSON format, where the sql is simply in the url.  # noqa: E501
    ...
    def get_by_query_pipe(self, query, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] GetByQueryPipe: Executes Sql, returned in pipe-delimited format, where the sql is simply in the url.  # noqa: E501
    ...
    def get_by_query_sqlite(self, query, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] GetByQuerySqlite: Executes Sql, returned in SqLite DB (sqlite3) format (as a file to be downloaded) format, where the sql is simply in the url.  # noqa: E501
    ...
    def put_by_query_csv(self, body, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] PutByQueryCsv: Executes Sql, returned in CSV format, where the sql is the post-body url.  # noqa: E501
        ...
        :param body: HoneycombSql to Execute (may be multi-line) (required)
        :type body: str
        :param query_name: Name to apply to the query in logs and `Sys.Logs.HcQueryStart`
        :type query_name: str
        :param download: Makes this a file-download request (as opposed to returning the data in the response-body)
    ...
    def put_by_query_csv_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        header_params['X-LUSID-SDK-Version'] = '1.9.31'
    ...
    def put_by_query_excel(self, body, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] PutByQueryExcel: Executes Sql, returned in Excel (xlsx) format (as a file to be downloaded), where the sql is the post-body url.  # noqa: E501
    ...
    def put_by_query_json(self, body, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] PutByQueryJson: Executes Sql, returned in JSON format, where the sql is the post-body url.  # noqa: E501
    ...
    def put_by_query_pipe(self, body, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] PutByQueryPipe: Executes Sql, returned in pipe-delimited format, where the sql is the post-body url.  # noqa: E501
    ...
    def put_by_query_sqlite(self, body, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] PutByQuerySqlite: Executes Sql, returned in SqLite DB (sqlite3) format (as a file to be downloaded), where the sql is the post-body url.  # noqa: E501
    ...
    def put_query_to_format(self, body, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] PutQueryToFormat: Executes Sql, returned in JSON format, where the sql is the post-body url.  # noqa: E501
        ...
        :param body: HoneycombSql to Pretty-Print. Even if it doesn't parse an attempt will be made to format it (required)
        :type body: str
