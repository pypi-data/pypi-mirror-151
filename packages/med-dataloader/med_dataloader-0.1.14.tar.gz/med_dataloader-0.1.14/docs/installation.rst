...
The sources for Medical Images Dataloader can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/mrossi93/med_dataloader
.. _tarball: https://github.com/mrossi93/med_dataloader/tarball/master
