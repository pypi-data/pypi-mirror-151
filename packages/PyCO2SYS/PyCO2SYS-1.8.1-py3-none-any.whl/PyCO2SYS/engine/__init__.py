...
def _outputs_nograd(args, opt_buffers_mode):
...
def _outputdict(
    args, core_in, core_out, others_in, others_out, totals, Kis, Kos, opt_buffers_mode
):
    ...
    outputs_nograd = _outputs_nograd(args, opt_buffers_mode)
