...
class Token:
    ...
    def __hash__(self) -> int:
        return hash((self.kind, self.start, self.end, self.line, self.column, self.value))
    ...
    def __getstate__(self) -> Dict[str, Any]:
        ...
        """
        return {key: getattr(self, key) for key in self.__slots__ if key not in {"prev", "next"}}
...
class Node:
    ...
    def __deepcopy__(self, memo: Dict) -> "Node":
        ...
        return self.__class__(**{key: deepcopy(getattr(self, key), memo) for key in self.keys})
