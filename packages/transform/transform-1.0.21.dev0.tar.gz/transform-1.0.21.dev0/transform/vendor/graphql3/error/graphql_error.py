...
class GraphQLError(Exception):
    ...
    def __init__(
        ...
        if positions and source:
            locations: Optional[List["SourceLocation"]] = [source.get_location(pos) for pos in positions]
        else:
    ...
    def __eq__(self, other: Any) -> bool:
        return (
            ...
            and all(getattr(self, slot) == getattr(other, slot) for slot in self.__slots__ if slot != "original_error")
        ) or (
