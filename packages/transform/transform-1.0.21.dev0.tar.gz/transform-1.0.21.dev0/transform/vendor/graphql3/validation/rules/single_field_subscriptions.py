        ...
        if subscription_type:
            ...
            if len(fields) > 1:
                ...
                extra_field_selection = [
                    ...
                    for field in (fields if isinstance(fields, list) else [cast(FieldNode, fields)])
                ]
                self.report_error(
                    GraphQLError(
                        ("Anonymous Subscription" if operation_name is None else f"Subscription '{operation_name}'")
