...
def collect_fields(
    ...
    collect_fields_impl(schema, fragments, variable_values, runtime_type, selection_set, fields, set())
    return fields
...
def collect_fields_impl(
    ...
    for selection in selection_set.selections:
        if isinstance(selection, FieldNode):
            ...
            if not should_include_node(variable_values, selection) or not does_fragment_condition_match(
