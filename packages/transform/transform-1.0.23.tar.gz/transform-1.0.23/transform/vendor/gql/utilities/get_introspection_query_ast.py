...
from graphql3 import DocumentNode, GraphQLSchema

from transform.vendor.gql.dsl import DSLFragment, DSLMetaField, DSLQuery, DSLSchema, dsl_gql
...
def get_introspection_query_ast(
    ...
    Equivalent to the get_introspection_query function from graphql3-core
    ...
    enum_values = ds.__Type.enumValues(includeDeprecated=True).select(ds.__EnumValue.name)
