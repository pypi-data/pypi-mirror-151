...
class Source:
    ...
    def __init__(
        ...
        if location_offset.line <= 0:
            raise ValueError("line in location_offset is 1-indexed and must be positive.")
        if location_offset.column <= 0:
            raise ValueError("column in location_offset is 1-indexed and must be positive.")
