...
class MapAsyncIterator:
    ...
    async def __anext__(self) -> Any:
        ...
        if self.is_closed:
            ...
            try:
                pending: Set[Task] = (await wait([aclose, anext], return_when=FIRST_COMPLETED))[1]
        ...
        if athrow:
            ...
            if value is None:
                if traceback is None:
                    raise type_
                value = type_ if isinstance(value, BaseException) else cast(Type[BaseException], type_)()
