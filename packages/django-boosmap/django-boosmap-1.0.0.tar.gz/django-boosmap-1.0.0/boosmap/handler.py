...
from boosmap.connector import Connector, ConnectorException
from boosmap.settings import api_settings

logger = logging.getLogger(__name__)


class BoosmapHandler:
    """
    ...
    def get_status(self, raw_data):
        """
            ...
            status: [
                'Ingresado', 'Aceptado', 'En punto de retiro', 'En despacho',
                'Entregado', 'Sin moradores', 'Pedido Anulado Cliente',
                'Rechazado Cliente', 'Error Dirección', 'Devolución Exitosa',
                'Extraviado', 'Pedido Anulado', 'Cancelado'
            ]
