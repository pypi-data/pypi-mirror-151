...
if os.environ.get("READTHEDOCS", False) == "True":
    ...
    INSTALL_REQUIRES = ["tethys-data-models>=0.4.9", "requests", "tethysts>=0.4.18", "rioxarray", "numexpr", "dask", "numcodecs", "hydrointerp", "geojson"]
...
setup(
    ...
    package_data={  # Optional
        main_package: ["*.yml", datasets + "/*.zst", 'grid/processors/era5_land/era5_mappings.csv'],
    },
