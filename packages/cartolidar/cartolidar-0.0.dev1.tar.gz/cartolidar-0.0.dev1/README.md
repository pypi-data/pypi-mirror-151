...
Python tools for Lidar processing focused on Spanish PNOA Lidar datasets (https://pnoa.ign.es/el-proyecto-pnoa-lidar)
...
DLV: variable Lidar que describe algún aspecto de la estructura de una
     formación arbolada, arbustiva o de matorral.
-------------------------------------------------------------------------------
