import time
from typing import Any, Generator, List, Callable
...
from .models import JobCreateModel, JobModel, JobResultPath, State, TaskStatusModel, JobSubmitModel
...
class AWJobsClient(E360ServiceClient):
    ...
    def submit_job_by_id(self, job_id: str, model: JobSubmitModel = None, **kwargs: Any) -> bool:
        url = f"{job_id}/submit/"
        submit_model = model.dict(by_alias=True) if model else None
        response = self.client.post(
    ...
    def submit_job_payload(self, model: JobCreateModel, submit_model: JobSubmitModel = None, **kwargs: Any) -> JobModel:
        """
