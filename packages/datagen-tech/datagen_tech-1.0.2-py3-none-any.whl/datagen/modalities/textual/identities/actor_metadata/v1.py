...
class Glasses(Accessory):
    ...
    @property
    @deprecated(reason="Property name changed to 'reflectivity', please use new name instead")
    def metallic_intensity(self) -> float:
        return self.reflectivity


class AccessoryField(Field):
    ACCESSORY_TYPE_TO_CLASS = {"GLASSES": Glasses}

    def _deserialize(self, accessory_dict: dict, attr, data, **kwargs) -> Accessory:
        accessory_type = accessory_dict.pop("type")
        return self.ACCESSORY_TYPE_TO_CLASS[accessory_type].Schema().load(accessory_dict)
