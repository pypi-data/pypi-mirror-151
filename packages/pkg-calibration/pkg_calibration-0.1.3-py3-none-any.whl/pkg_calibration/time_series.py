...
class TimeSeries:
    ...
    def __init__(self):
        doc = Document("/Users/fatusgauthier/Desktop/Projects/GIT/pkg_calibration/src/brent.numbers")
        sheets = doc.sheets()
    ...
    def realized_vol_forward(self, index, line, nb_days, date_from, date_to, delta_t=1):
        ...
        """
        return self.realized_daily_move(index, line, nb_days, date_from, date_to, delta_t)
    ...
    def realized_ts_vol_forward(self, index, line, nb_days, date_from, date_to, delta_t=1, tenor=1):
        ...
        date_from_prices = pd.Timestamp(date_from) - BusinessDay(n=max(_nb_days) + 15)
