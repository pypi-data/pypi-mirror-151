...
class InterventionDefinition(object):
    ...
    def __init__(self, id=None, person_set=None, model_populations=None, dataset_id=None, dataset=None, created_at=None, created_by=None, updated_at=None, archived_at=None, last_updated_by=None, version=None):  # noqa: E501
