...
class UserFavorite(object):
    ...
    def __init__(self, id=None, user_id=None, favorite_model_id=None, favorite_project_id=None, last_updated_by=None, created_by=None, created_at=None, updated_at=None, archived_at=None, version=None):  # noqa: E501
