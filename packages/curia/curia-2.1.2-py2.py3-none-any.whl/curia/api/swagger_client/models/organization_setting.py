...
class OrganizationSetting(object):
    ...
    def __init__(self, id=None, pipeline_version=None, risk_version=None, impactability_version=None, primary_database=None, features_database=None, organization_id=None, last_updated_by=None, created_by=None, created_at=None, updated_at=None, archived_at=None, version=None):  # noqa: E501
