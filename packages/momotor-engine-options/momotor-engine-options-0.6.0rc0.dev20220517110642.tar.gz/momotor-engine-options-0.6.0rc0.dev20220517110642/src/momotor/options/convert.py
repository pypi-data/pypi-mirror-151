...
def convert_size(t: typing.Union[str, int, None]) -> typing.Optional[int]:
    ...
    +----------------+---+-------+----------------+----+------+
    | 1000\ :sup:`2` | M | mega  | 1024\ :sup:`2` | Mi | mebi |
    +----------------+---+-------+----------------+----+------+
    | 1000\ :sup:`3` | G | giga  | 1024\ :sup:`3` | Gi | gibi |
    +----------------+---+-------+----------------+----+------+
    | 1000\ :sup:`4` | T | tera  | 1024\ :sup:`4` | Ti | tebi |
    +----------------+---+-------+----------------+----+------+
    | 1000\ :sup:`5` | P | peta  | 1024\ :sup:`5` | Pi | pebi |
    +----------------+---+-------+----------------+----+------+
    | 1000\ :sup:`6` | E | exa   | 1024\ :sup:`6` | Ei | exbi |
    +----------------+---+-------+----------------+----+------+
    | 1000\ :sup:`7` | Z | zetta | 1024\ :sup:`7` | Zi | zebi |
    +----------------+---+-------+----------------+----+------+
    | 1000\ :sup:`8` | Y | yotta | 1024\ :sup:`8` | Yi | yobi |
    +----------------+---+-------+----------------+----+------+
...
def convert_intlist(il: str) -> typing.Tuple[int, ...]:
    """ Convert a string containing a comma-separated string of integer values into a tuple of integers.
