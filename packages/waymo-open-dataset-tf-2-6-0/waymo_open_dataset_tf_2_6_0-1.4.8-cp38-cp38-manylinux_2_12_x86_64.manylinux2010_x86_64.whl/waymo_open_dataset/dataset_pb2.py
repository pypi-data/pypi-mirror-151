...
_RANGEIMAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='range_image_flow_compressed', full_name='waymo.open_dataset.RangeImage.range_image_flow_compressed', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='segmentation_label_compressed', full_name='waymo.open_dataset.RangeImage.segmentation_label_compressed', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='range_image', full_name='waymo.open_dataset.RangeImage.range_image', index=5,
