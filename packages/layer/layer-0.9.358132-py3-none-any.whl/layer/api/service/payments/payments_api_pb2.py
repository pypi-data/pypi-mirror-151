...
from layer.api.entity import billing_info_pb2 as api_dot_entity_dot_billing__info__pb2
from layer.api.entity import payment_info_pb2 as api_dot_entity_dot_payment__info__pb2
from layer.api import ids_pb2 as api_dot_ids__pb2
from layer.api.value import payment_status_type_pb2 as api_dot_value_dot_payment__status__type__pb2


DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n\'api/service/payments/payments_api.proto\x12\x03\x61pi\x1a\x1d\x61pi/entity/billing_info.proto\x1a\x1d\x61pi/entity/payment_info.proto\x1a\rapi/ids.proto\x1a#api/value/payment_status_type.proto\"h\n\x1b\x43reateStripeCustomerRequest\x12\r\n\x05\x65mail\x18\x01 \x01(\t\x12\x0c\n\x04name\x18\x02 \x01(\t\x12,\n\x0forganization_id\x18\x03 \x01(\x0b\x32\x13.api.OrganizationId\"/\n\x1c\x43reateStripeCustomerResponse\x12\x0f\n\x07message\x18\x01 \x01(\t\"\x1f\n\x1dGetStripeSetupIntentIdRequest\"Z\n\x1eGetStripeSetupIntentIdResponse\x12\x38\n\x16stripe_setup_intent_id\x18\x01 \x01(\x0b\x32\x18.api.StripeSetupIntentId\"`\n SaveStripePaymentMethodIdRequest\x12<\n\x18stripe_payment_method_id\x18\x01 \x01(\x0b\x32\x1a.api.StripePaymentMethodId\"K\n!SaveStripePaymentMethodIdResponse\x12&\n\x0c\x62illing_info\x18\x01 \x01(\x0b\x32\x10.api.BillingInfo\"[\n\x1bGetStripeBillingInfoRequest\x12<\n\x18stripe_payment_method_id\x18\x01 \x01(\x0b\x32\x1a.api.StripePaymentMethodId\"F\n\x1cGetStripeBillingInfoResponse\x12&\n\x0c\x62illing_info\x18\x01 \x01(\x0b\x32\x10.api.BillingInfo\"!\n\x1fGetStripePaymentMethodIdRequest\"`\n GetStripePaymentMethodIdResponse\x12<\n\x18stripe_payment_method_id\x18\x01 \x01(\x0b\x32\x1a.api.StripePaymentMethodId\"\"\n DeleteStripePaymentMethodRequest\"4\n!DeleteStripePaymentMethodResponse\x12\x0f\n\x07message\x18\x01 \x01(\t\"\x1e\n\x1cGetStripePaymentsListRequest\"C\n\x1dGetStripePaymentsListResponse\x12\"\n\x08payments\x18\x01 \x03(\x0b\x32\x10.api.PaymentInfo\"H\n\x1eUpdateStripeBillingInfoRequest\x12&\n\x0c\x62illing_info\x18\x01 \x01(\x0b\x32\x10.api.BillingInfo\"2\n\x1fUpdateStripeBillingInfoResponse\x12\x0f\n\x07message\x18\x01 \x01(\t\"\x1b\n\x19GetLastPaymentInfoRequest\"c\n\x1aGetLastPaymentInfoResponse\x12.\n\x0epayment_status\x18\x01 \x01(\x0e\x32\x16.api.PaymentStatusType\x12\x15\n\rerror_message\x18\x02 \x01(\t2\x88\x07\n\x0bPaymentsAPI\x12[\n\x14\x43reateStripeCustomer\x12 .api.CreateStripeCustomerRequest\x1a!.api.CreateStripeCustomerResponse\x12\x61\n\x16GetStripeSetupIntentId\x12\".api.GetStripeSetupIntentIdRequest\x1a#.api.GetStripeSetupIntentIdResponse\x12j\n\x19SaveStripePaymentMethodId\x12%.api.SaveStripePaymentMethodIdRequest\x1a&.api.SaveStripePaymentMethodIdResponse\x12[\n\x14GetStripeBillingInfo\x12 .api.GetStripeBillingInfoRequest\x1a!.api.GetStripeBillingInfoResponse\x12g\n\x18GetStripePaymentMethodId\x12$.api.GetStripePaymentMethodIdRequest\x1a%.api.GetStripePaymentMethodIdResponse\x12j\n\x19\x44\x65leteStripePaymentMethod\x12%.api.DeleteStripePaymentMethodRequest\x1a&.api.DeleteStripePaymentMethodResponse\x12^\n\x15GetStripePaymentsList\x12!.api.GetStripePaymentsListRequest\x1a\".api.GetStripePaymentsListResponse\x12\x64\n\x17UpdateStripeBillingInfo\x12#.api.UpdateStripeBillingInfoRequest\x1a$.api.UpdateStripeBillingInfoResponse\x12U\n\x12GetLastPaymentInfo\x12\x1e.api.GetLastPaymentInfoRequest\x1a\x1f.api.GetLastPaymentInfoResponseB#\n\rcom.layer.apiB\x10PaymentsApiProtoP\x01\x62\x06proto3')
...
_GETSTRIPESETUPINTENTIDREQUEST = DESCRIPTOR.message_types_by_name['GetStripeSetupIntentIdRequest']
_GETSTRIPESETUPINTENTIDRESPONSE = DESCRIPTOR.message_types_by_name['GetStripeSetupIntentIdResponse']
...
GetStripeSetupIntentIdRequest = _reflection.GeneratedProtocolMessageType('GetStripeSetupIntentIdRequest', (_message.Message,), {
  'DESCRIPTOR' : _GETSTRIPESETUPINTENTIDREQUEST,
  '__module__' : 'api.service.payments.payments_api_pb2'
  # @@protoc_insertion_point(class_scope:api.GetStripeSetupIntentIdRequest)
  })
_sym_db.RegisterMessage(GetStripeSetupIntentIdRequest)

GetStripeSetupIntentIdResponse = _reflection.GeneratedProtocolMessageType('GetStripeSetupIntentIdResponse', (_message.Message,), {
  'DESCRIPTOR' : _GETSTRIPESETUPINTENTIDRESPONSE,
  '__module__' : 'api.service.payments.payments_api_pb2'
  # @@protoc_insertion_point(class_scope:api.GetStripeSetupIntentIdResponse)
  })
_sym_db.RegisterMessage(GetStripeSetupIntentIdResponse)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _CREATESTRIPECUSTOMERREQUEST._serialized_start=162
  _CREATESTRIPECUSTOMERREQUEST._serialized_end=266
  _CREATESTRIPECUSTOMERRESPONSE._serialized_start=268
  _CREATESTRIPECUSTOMERRESPONSE._serialized_end=315
  _GETSTRIPESETUPINTENTIDREQUEST._serialized_start=317
  _GETSTRIPESETUPINTENTIDREQUEST._serialized_end=348
  _GETSTRIPESETUPINTENTIDRESPONSE._serialized_start=350
  _GETSTRIPESETUPINTENTIDRESPONSE._serialized_end=440
  _SAVESTRIPEPAYMENTMETHODIDREQUEST._serialized_start=442
  _SAVESTRIPEPAYMENTMETHODIDREQUEST._serialized_end=538
  _SAVESTRIPEPAYMENTMETHODIDRESPONSE._serialized_start=540
  _SAVESTRIPEPAYMENTMETHODIDRESPONSE._serialized_end=615
  _GETSTRIPEBILLINGINFOREQUEST._serialized_start=617
  _GETSTRIPEBILLINGINFOREQUEST._serialized_end=708
  _GETSTRIPEBILLINGINFORESPONSE._serialized_start=710
  _GETSTRIPEBILLINGINFORESPONSE._serialized_end=780
  _GETSTRIPEPAYMENTMETHODIDREQUEST._serialized_start=782
  _GETSTRIPEPAYMENTMETHODIDREQUEST._serialized_end=815
  _GETSTRIPEPAYMENTMETHODIDRESPONSE._serialized_start=817
  _GETSTRIPEPAYMENTMETHODIDRESPONSE._serialized_end=913
  _DELETESTRIPEPAYMENTMETHODREQUEST._serialized_start=915
  _DELETESTRIPEPAYMENTMETHODREQUEST._serialized_end=949
  _DELETESTRIPEPAYMENTMETHODRESPONSE._serialized_start=951
  _DELETESTRIPEPAYMENTMETHODRESPONSE._serialized_end=1003
  _GETSTRIPEPAYMENTSLISTREQUEST._serialized_start=1005
  _GETSTRIPEPAYMENTSLISTREQUEST._serialized_end=1035
  _GETSTRIPEPAYMENTSLISTRESPONSE._serialized_start=1037
  _GETSTRIPEPAYMENTSLISTRESPONSE._serialized_end=1104
  _UPDATESTRIPEBILLINGINFOREQUEST._serialized_start=1106
  _UPDATESTRIPEBILLINGINFOREQUEST._serialized_end=1178
  _UPDATESTRIPEBILLINGINFORESPONSE._serialized_start=1180
  _UPDATESTRIPEBILLINGINFORESPONSE._serialized_end=1230
  _GETLASTPAYMENTINFOREQUEST._serialized_start=1232
  _GETLASTPAYMENTINFOREQUEST._serialized_end=1259
  _GETLASTPAYMENTINFORESPONSE._serialized_start=1261
  _GETLASTPAYMENTINFORESPONSE._serialized_end=1360
  _PAYMENTSAPI._serialized_start=1363
  _PAYMENTSAPI._serialized_end=2267
