...
class Dataset(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["created_by_id",b"created_by_id","default_build_id",b"default_build_id","derived_dataset_build_details",b"derived_dataset_build_details","id",b"id","organization_id",b"organization_id","owners",b"owners","project_id",b"project_id","python_dataset",b"python_dataset"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["created_by_id",b"created_by_id","created_timestamp",b"created_timestamp","default_build_id",b"default_build_id","derived_dataset_build_details",b"derived_dataset_build_details","description",b"description","downloads",b"downloads","format",b"format","id",b"id","likes",b"likes","name",b"name","organization_id",b"organization_id","owners",b"owners","project_id",b"project_id","project_name",b"project_name","python_dataset",b"python_dataset","type",b"type","updated_timestamp",b"updated_timestamp"]) -> None: ...
