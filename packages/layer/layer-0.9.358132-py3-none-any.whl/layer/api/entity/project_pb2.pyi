...
class Project(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["created_by_id",b"created_by_id","created_time",b"created_time","id",b"id","organization_id",b"organization_id","updated_time",b"updated_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["color",b"color","created_by_id",b"created_by_id","created_time",b"created_time","description",b"description","id",b"id","likes",b"likes","name",b"name","organization_id",b"organization_id","readme",b"readme","updated_time",b"updated_time","views",b"views","visibility",b"visibility"]) -> None: ...
