...
from layer.api.service.payments import payments_api_pb2 as api_dot_service_dot_payments_dot_payments__api__pb2
...
class PaymentsAPIStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetStripeSetupIntentId = channel.unary_unary(
                '/api.PaymentsAPI/GetStripeSetupIntentId',
                request_serializer=api_dot_service_dot_payments_dot_payments__api__pb2.GetStripeSetupIntentIdRequest.SerializeToString,
                response_deserializer=api_dot_service_dot_payments_dot_payments__api__pb2.GetStripeSetupIntentIdResponse.FromString,
                )
...
class PaymentsAPIServicer(object):
    ...
    def GetStripeSetupIntentId(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_PaymentsAPIServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetStripeSetupIntentId': grpc.unary_unary_rpc_method_handler(
                    servicer.GetStripeSetupIntentId,
                    request_deserializer=api_dot_service_dot_payments_dot_payments__api__pb2.GetStripeSetupIntentIdRequest.FromString,
                    response_serializer=api_dot_service_dot_payments_dot_payments__api__pb2.GetStripeSetupIntentIdResponse.SerializeToString,
            ),
...
class PaymentsAPI(object):
    ...
    @staticmethod
    def GetStripeSetupIntentId(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/api.PaymentsAPI/GetStripeSetupIntentId',
            api_dot_service_dot_payments_dot_payments__api__pb2.GetStripeSetupIntentIdRequest.SerializeToString,
            api_dot_service_dot_payments_dot_payments__api__pb2.GetStripeSetupIntentIdResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
