...
class Model(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["compute_fabric_id",b"compute_fabric_id","created_by_id",b"created_by_id","default_train_id",b"default_train_id","id",b"id","organization_id",b"organization_id","owners",b"owners","project_id",b"project_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["compute_fabric_id",b"compute_fabric_id","created_by_id",b"created_by_id","date_created",b"date_created","default_train_id",b"default_train_id","description",b"description","downloads",b"downloads","id",b"id","likes",b"likes","name",b"name","organization_id",b"organization_id","owners",b"owners","project_id",b"project_id","version_ids",b"version_ids"]) -> None: ...
