...
class GetPipelineRunLogsPerEntityRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    class DatasetEntity(google.protobuf.message.Message):
        DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    class ModelEntity(google.protobuf.message.Message):
        DESCRIPTOR: google.protobuf.descriptor.Descriptor
        NAME_FIELD_NUMBER: builtins.int
        name: typing.Text
        def __init__(self,
    ...
    def run_id(self) -> api.ids_pb2.RunId: ...
    @property
    def dataset(self) -> global___GetPipelineRunLogsPerEntityRequest.DatasetEntity: ...
    @property
    def model(self) -> global___GetPipelineRunLogsPerEntityRequest.ModelEntity: ...
    continuation_token: typing.Text
    def __init__(self,
        *,
        run_id: typing.Optional[api.ids_pb2.RunId] = ...,
        dataset: typing.Optional[global___GetPipelineRunLogsPerEntityRequest.DatasetEntity] = ...,
        model: typing.Optional[global___GetPipelineRunLogsPerEntityRequest.ModelEntity] = ...,
        continuation_token: typing.Text = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["dataset",b"dataset","entity_name",b"entity_name","model",b"model","run_id",b"run_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["continuation_token",b"continuation_token","dataset",b"dataset","entity_name",b"entity_name","model",b"model","run_id",b"run_id"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["entity_name",b"entity_name"]) -> typing.Optional[typing_extensions.Literal["dataset","model"]]: ...
