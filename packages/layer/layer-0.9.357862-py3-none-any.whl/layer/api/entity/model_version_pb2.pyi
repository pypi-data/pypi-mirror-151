...
class ModelVersion(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["default_train_id",b"default_train_id","id",b"id","latest_train_id",b"latest_train_id","model_id",b"model_id","organization_id",b"organization_id","project_id",b"project_id","training_files_hash",b"training_files_hash"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["default_train_id",b"default_train_id","description",b"description","fabric",b"fabric","flavor",b"flavor","id",b"id","is_default",b"is_default","latest_train_id",b"latest_train_id","model_id",b"model_id","model_train_ids",b"model_train_ids","name",b"name","organization_id",b"organization_id","project_id",b"project_id","training_files_hash",b"training_files_hash"]) -> None: ...
