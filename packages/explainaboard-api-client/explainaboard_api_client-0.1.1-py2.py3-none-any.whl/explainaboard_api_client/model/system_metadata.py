...
class SystemMetadata(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, task, model_name, metric_names, source_language, target_language, paper_info, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, task, model_name, metric_names, source_language, target_language, paper_info, *args, **kwargs):  # noqa: E501
        """SystemMetadata - a model defined in OpenAPI
