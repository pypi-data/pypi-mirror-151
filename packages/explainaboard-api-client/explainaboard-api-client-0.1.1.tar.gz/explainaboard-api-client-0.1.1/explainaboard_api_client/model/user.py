...
class User(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, email, preferred_username, username, api_key, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, email, preferred_username, username, api_key, *args, **kwargs):  # noqa: E501
        """User - a model defined in OpenAPI
