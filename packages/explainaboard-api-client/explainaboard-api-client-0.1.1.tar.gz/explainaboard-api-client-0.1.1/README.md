...
with explainaboard_api_client.ApiClient(configuration) as api_client:
    ...
    dataset_id = "61611c3a414abfb115397ca5" # str | 

    try:
        # Returns dataset metadata by id
        api_response = api_instance.datasets_dataset_id_get(dataset_id)
        pprint(api_response)
    except explainaboard_api_client.ApiException as e:
        print("Exception when calling DefaultApi->datasets_dataset_id_get: %s\n" % e)
```
