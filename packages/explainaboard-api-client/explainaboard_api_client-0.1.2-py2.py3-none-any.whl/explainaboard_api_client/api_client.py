...
from explainaboard_api_client import rest
from explainaboard_api_client.configuration import Configuration
from explainaboard_api_client.exceptions import ApiTypeError, ApiValueError, ApiException
from explainaboard_api_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.datasets_dataset_id_get  # this is an instance of the class Endpoint
        api_instance.datasets_dataset_id_get()  # this invokes api_instance.datasets_dataset_id_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.datasets_dataset_id_get.callable or self.callable in this class
