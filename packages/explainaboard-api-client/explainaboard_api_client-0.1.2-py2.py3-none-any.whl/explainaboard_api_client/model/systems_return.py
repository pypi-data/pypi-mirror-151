...
class SystemsReturn(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, systems, total, *args, **kwargs):  # noqa: E501
        """SystemsReturn - a model defined in OpenAPI

        Args:
            systems ([System]):
            total (int): total number of matching systems
    ...
    @convert_js_args_to_python_args
    def __init__(self, systems, total, *args, **kwargs):  # noqa: E501
        """SystemsReturn - a model defined in OpenAPI
