...
class DefaultApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.datasets_dataset_id_get_endpoint = _Endpoint(
            settings={
                'response_type': (DatasetMetadata,),
                'auth': [],
                'endpoint_path': '/datasets/{dataset_id}',
                'operation_id': 'datasets_dataset_id_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.systems_analyses_post_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/systems/analyses',
        ...
        self.systems_system_id_delete_endpoint = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [
                    'ApiKeyAuth',
                ...
                'endpoint_path': '/systems/{system_id}',
                'operation_id': 'systems_system_id_delete',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.systems_system_id_get_endpoint = _Endpoint(
            settings={
                'response_type': (System,),
                'auth': [
                    'ApiKeyAuth',
                ...
                'endpoint_path': '/systems/{system_id}',
                'operation_id': 'systems_system_id_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.systems_system_id_outputs_get_endpoint = _Endpoint(
            settings={
                'response_type': (SystemOutputsReturn,),
                'auth': [
                    'ApiKeyAuth',
                    'BearerAuth'
                ],
                'endpoint_path': '/systems/{system_id}/outputs',
                'operation_id': 'systems_system_id_outputs_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def datasets_dataset_id_get(
        ...
        **kwargs
        ...
        >>> thread = api.datasets_dataset_id_get(dataset_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['dataset_id'] = \
            dataset_id
        return self.datasets_dataset_id_get_endpoint.call_with_http_info(**kwargs)
    ...
    def systems_get(
        ...
        **kwargs
        ...
        Keyword Args:
            ...
            page (int): page number (0 indexed). [optional] if omitted the server will use the default value of 0
            page_size (int): number of items per page. [optional] if omitted the server will use the default value of 20
            sort_field (str): supports `created_at` (default) and metric names.. [optional]
    ...
    def systems_system_id_delete(
        ...
        **kwargs
        ...
        >>> thread = api.systems_system_id_delete(system_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['system_id'] = \
            system_id
        return self.systems_system_id_delete_endpoint.call_with_http_info(**kwargs)

    def systems_system_id_get(
        self,
        system_id: str,
        **kwargs
    ):
        ...
        >>> thread = api.systems_system_id_get(system_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['system_id'] = \
            system_id
        return self.systems_system_id_get_endpoint.call_with_http_info(**kwargs)
    ...
    def systems_system_id_outputs_get(
        ...
        **kwargs
        ...
        >>> thread = api.systems_system_id_outputs_get(system_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            output_ids (str): multiple output_ids, comma-separated. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['system_id'] = \
            system_id
        return self.systems_system_id_outputs_get_endpoint.call_with_http_info(**kwargs)
