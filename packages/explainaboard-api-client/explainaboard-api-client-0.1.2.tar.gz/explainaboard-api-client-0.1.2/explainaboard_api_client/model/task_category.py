...
class TaskCategory(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, description, tasks, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, description, tasks, *args, **kwargs):  # noqa: E501
        """TaskCategory - a model defined in OpenAPI
