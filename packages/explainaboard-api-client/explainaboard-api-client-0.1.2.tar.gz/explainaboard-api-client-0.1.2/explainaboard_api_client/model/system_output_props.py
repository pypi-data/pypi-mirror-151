...
class SystemOutputProps(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, data, file_type, *args, **kwargs):  # noqa: E501
        """SystemOutputProps - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, data, file_type, *args, **kwargs):  # noqa: E501
        """SystemOutputProps - a model defined in OpenAPI
