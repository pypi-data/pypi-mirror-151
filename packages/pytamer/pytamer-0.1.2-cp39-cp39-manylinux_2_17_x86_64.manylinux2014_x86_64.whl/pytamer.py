...
def tamer_do_tsimple_planning(problem):
    return _pytamer.tamer_do_tsimple_planning(problem)
tamer_do_tsimple_planning = _pytamer.tamer_do_tsimple_planning
...
def tamer_do_ftp_planning(problem):
    return _pytamer.tamer_do_ftp_planning(problem)
tamer_do_ftp_planning = _pytamer.tamer_do_ftp_planning
