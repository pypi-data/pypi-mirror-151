...
class NetworkValidationClient(object):
    ...
    def __init__(self, config, **kwargs):
        ...
        self.base_client = BaseClient("network_validation", config, signer, data_connectivity_type_mapping, **base_client_init_kwargs)
    ...
    def get_network_connectivity_status_collection(self, registry_id, endpoint_key, **kwargs):
        ...
        :example:
        Click `here <https://docs.cloud.oracle.com/en-us/iaas/tools/python-sdk-examples/2.68.0/dataconnectivity/get_network_connectivity_status_collection.py.html>`__ to see an example of how to use get_network_connectivity_status_collection API.
        """
        ...
        if extra_kwargs:
            raise ValueError(
                "get_network_connectivity_status_collection got unknown kwargs: {!r}".format(extra_kwargs))
