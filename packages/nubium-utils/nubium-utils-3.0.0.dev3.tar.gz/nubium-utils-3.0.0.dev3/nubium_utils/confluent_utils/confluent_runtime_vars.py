...
def default_env_vars():
    ...
    return {
        ...
        'NU_CONSUMER_TIMEOUT_LIMIT_MINUTES': environ.get('NU_CONSUMER_TIMEOUT_LIMIT_MINUTES', '1'),
        ...
        'NU_CONSUMER_DEFAULT_BATCH_CONSUME_MAX_TIME_SECONDS': environ.get('NU_CONSUMER_DEFAULT_BATCH_CONSUME_MAX_TIME_SECONDS', '30'),
        ...
        'NU_CONSUMER_HEARTBEAT_TIMEOUT_SECONDS': str(environ.get('NU_CONSUMER_HEARTBEAT_TIMEOUT_SECONDS', '30')),
        'NU_CONSUMER_MESSAGE_BATCH_MAX_MB': str(int(float(environ.get('NU_CONSUMER_MESSAGE_BATCH_MAX_MB', '2')) * 2 ** 20)),
        'NU_CONSUMER_MESSAGE_TOTAL_MAX_MB': str(int(float(environ.get('NU_CONSUMER_MESSAGE_TOTAL_MAX_MB', '3')) * 2 ** 20)),
        'NU_CONSUMER_MESSAGE_QUEUE_MAX_MB': str(int(float(environ.get('NU_CONSUMER_MESSAGE_QUEUE_MAX_MB', '10')) * 2 ** 10)),
}
