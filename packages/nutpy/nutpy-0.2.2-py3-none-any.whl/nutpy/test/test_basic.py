...
def test_Nut_update():
    """
    Test that Nut class can be updated
    """
    ...
    result = nut_test.update(SSP=SSP)

    assert result == 0

    assert_allclose(SSP, nut_test.SSP)
...
def test_profile_MAT_trace():
    ...
    _, MAT = vs.analytical_profile(SSP=[45., 50., 10., 93., 7.5],
                                   Nr=100,
                                   tf=1,
                                   quantity='MAT',
                                   fig_flag=False,
...
def test_profile_MAX_trace():
    ...
    _, MAX = vs.analytical_profile(SSP=[45., 50., 10., 93., 7.5],
                                   Nr=100,
                                   tf=1,
                                   quantity='MAX',
                                   fig_flag=False,
...
def test_map_TAT_trace():
    ...
    _, TAT = vs.analytical_map(SSP=[45., 50., 10., 93., 7.5],
                               N=100,
                               tf=1,
                               quantity='TAT',
                               fig_flag=False,
...
def test_map_MAT_trace():
    ...
    _, MAT = vs.analytical_map(SSP=[45., 50., 10., 93., 7.5],
                               N=100,
                               tf=1,
                               quantity='MAT',
                               fig_flag=False,
...
def test_map_MAX_trace():
    ...
    _, MAX = vs.analytical_map(SSP=[45., 50., 10., 93., 7.5],
                               N=100,
                               tf=1,
                               quantity='MAX',
                               fig_flag=False,
...
def test_attitude_emulation():
    ...
    q_nut = nut_test.sat.attitude_df.values[[-1], :].T
