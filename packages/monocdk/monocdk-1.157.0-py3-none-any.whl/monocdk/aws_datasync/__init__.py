...
class CfnLocationFSxOpenZFS(
    ...
    def __init__(
        ...
        *,
        fsx_filesystem_arn: builtins.str,
        protocol: typing.Union["CfnLocationFSxOpenZFS.ProtocolProperty", _IResolvable_a771d0ef],
        security_group_arns: typing.Sequence[builtins.str],
        subdirectory: typing.Optional[builtins.str] = None,
        tags: typing.Optional[typing.Sequence[_CfnTag_95fbdc29]] = None,
    ) -> None:
    ...
    class NFSProperty:
        def __init__(
            self,
            *,
            mount_options: typing.Union["CfnLocationFSxOpenZFS.MountOptionsProperty", _IResolvable_a771d0ef],
        ) -> None:
    ...
    class ProtocolProperty:
        def __init__(
            self,
            *,
            nfs: typing.Optional[typing.Union["CfnLocationFSxOpenZFS.NFSProperty", _IResolvable_a771d0ef]] = None,
        ) -> None:
