...
class DeployAssert(
    _Construct_e78e779f,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk.integ_tests.DeployAssert",
):
...
@jsii.data_type(
    jsii_type="monocdk.integ_tests.DeployAssertProps",
    jsii_struct_bases=[],
    name_mapping={},
)
...
class IntegTestCaseStack(
    ...
    def __init__(
        ...
        *,
        ...
        env: typing.Optional[_Environment_0cfdf5e4] = None,
...
@jsii.data_type(
    jsii_type="monocdk.integ_tests.ResultsCollectionRequest",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="monocdk.integ_tests.ResultsCollectionResult",
    jsii_struct_bases=[],
