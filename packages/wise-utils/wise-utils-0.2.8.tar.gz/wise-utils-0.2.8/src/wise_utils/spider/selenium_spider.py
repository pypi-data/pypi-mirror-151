...
class SeleniumBaseSpider(BaseSpider):
    ...
    def create_undetected_browser(self, chrome_version, chrome_options=None):
    ...
    def get_undetected_chrome_options(self):
        """获取undetected_chrome_options"""
        chrome_options = uc.ChromeOptions()
        chrome_options.from_options(self.get_chrome_options())
        return chrome_options
