...
def forecast_data_prep(store_id_list, type_list, reset_date, db, schema,
    ...
    sales_query = """
        ...
        and "drug-id" in (26787, 1717, 408534, 408624, 21, 605, 400661, 399409, 399093, 385489, 384949) -- FOR TEST (LINE TO DELETE)
    ...
    print(f"sales_history: {sales_history.info()}")
    calendar_query = """
