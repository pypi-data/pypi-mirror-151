...
generic_affinity['updated-at'] = datetime.datetime.now(tz=gettz('Asia/Kolkata')).strftime('%Y-%m-%d %H:%M:%S')
...
patient_generic_affinity['updated-at'] = datetime.datetime.now(tz=gettz('Asia/Kolkata')).strftime('%Y-%m-%d %H:%M:%S')
patient_generic_affinity['created-by'] = 'etl-automation'
patient_generic_affinity['updated-by'] = 'etl-automation'
