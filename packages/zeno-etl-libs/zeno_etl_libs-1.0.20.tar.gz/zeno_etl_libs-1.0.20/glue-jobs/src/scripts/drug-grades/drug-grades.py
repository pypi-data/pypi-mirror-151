...
parser.add_argument('-sd', '--datem', default='', type=str, required=False)
...
logger.info('Shape of stores data',str(df_bb.shape))
...
cluster_lvl1_output_pivot_name = 'drug_grades/{}.csv'.format(cluster_lvl1_output_pivot)
...
cluster_lvl2_output_pivot_name = 'drug_grades/{}.csv'.format(cluster_lvl2_output_pivot)
...
cluster_all_pivote_name = 'drug_grades/{}.csv'.format(cluster_all_pivote)
...
cluster_all_name = 'drug_grades/{}.csv'.format(cluster_all)
...
cluster_all_pivote1_name = 'drug_grades/{}.csv'.format(cluster_all_pivote1)
