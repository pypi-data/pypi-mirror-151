...
# Find window date that is 15 days after the calling date

calling_dashboard_data['window_date'] = calling_dashboard_data['call_date'] + timedelta(days=15)
