...
def main(db, table_suffix):
    ...
    gross_update_query = f"""update
                            ...
                            join "prod2-generico"."{stores_master_table_name}" as msm on
                                s."store-id" = msm."id"
                            where
                                ( c."updated-at" > s."updated-at"
                                or p."updated-at" > s."updated-at"
                                or pso2."updated-at" > s."updated-at"
                                or msm."updated-at" > s."updated-at")
