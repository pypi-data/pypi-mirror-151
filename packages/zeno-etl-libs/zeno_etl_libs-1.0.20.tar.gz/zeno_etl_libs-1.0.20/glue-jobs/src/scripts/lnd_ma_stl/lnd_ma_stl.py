...
training_calender['course0_1_2_3_4'] = training_calender[['courses','courses.1','courses.2','courses.3','courses.4']].apply(
...
training_calender = training_calender.rename(columns={'course0_1_2_3_4': 'course'})
