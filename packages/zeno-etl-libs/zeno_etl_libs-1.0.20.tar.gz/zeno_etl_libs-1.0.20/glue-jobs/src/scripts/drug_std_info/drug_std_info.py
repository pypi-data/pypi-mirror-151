...
def main(debug_mode, rs_db, read_schema, write_schema, table_name, logger):
    s3 = S3()
...
if __name__ == '__main__':
    ...
    main(debug_mode=debug_mode, rs_db=rs_db, read_schema=read_schema, write_schema=write_schema,
         table_name=table_name, logger=logger)
