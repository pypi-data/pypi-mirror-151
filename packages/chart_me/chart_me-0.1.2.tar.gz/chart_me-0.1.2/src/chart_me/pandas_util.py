...
def pd_truncate_date(df: pd.DataFrame, col:str) -> pd.Series:
    ...
    Helpful urls: https://predictivehacks.com/?all-tips=how-to-truncate-dates-to-month-in-pandas
    Helpful urls: https://pandas.pydata.org/docs/reference/api/pandas.Series.dt.to_period.html
