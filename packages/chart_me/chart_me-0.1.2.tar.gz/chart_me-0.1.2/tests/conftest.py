...
def ct_df_check_infer_dtypes():
    data = {
        ...
        "datie_dates":[datetime(2020,1,1), datetime(2021,2,3), datetime(2021,2,13), datetime(2021,4,13), datetime(2021,3,13)],
        "datie_dates_null":[datetime(2020,1,1), datetime(2021,2,3), datetime(2021,2,13), None, None],
...
def ct_df_override_dtypes():
    data = {
        "stringy_dates": ['2021-01-01', '2021-02-02', '2021-02-03', '2021-02-04', '2021-02-05'],
        "inty_integers_w_nulls": [1, 2, 3, None, None],
        "floaty_integers": [1.0, 2.0, 3.0, 4.0, 3.0]   ,
        "string_not_dates": ['2021-01-01', '2021-02-02', '2021-02-03', '2021-02-04', 'xyz-yan']   
    }
    df = pd.DataFrame(data)
    return df
