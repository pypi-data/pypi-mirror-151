...
Set the environment variables: SF_USERNAME (SnowFlake username), SF_PASSWORD (SnowFlake password), SF_ROLE (the role you want to use) and SF_ACCOUNT (SnowFlake account identifier).
Then simply do:
