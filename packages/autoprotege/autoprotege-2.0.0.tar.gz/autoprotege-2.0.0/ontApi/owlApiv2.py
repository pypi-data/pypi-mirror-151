...
from autoprotege.ontModel.oneClass import *
from autoprotege.ontModel.objectProperty import *
from autoprotege.ontModel.dataProperty import *
from autoprotege.ontModel.individual import *
