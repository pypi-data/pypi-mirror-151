...
setup(
  name = 'm2onethesaurus',         # How you named your package folder (MyLib)
  packages = ['m2onethesaurus'],   # Chose the same as "name"
  version = '0.1',      # Start with a small number and increase it with every change you make
  license='MIT',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  description = 'Input multiple words, get one back',   # Give a short description about your library
