...
async def execute_winscp(winscp_exe: str, key_file: str, server: str, cmd_list: list[str], show_cmd: bool = True):
    logFile = beni.getpath_user('executeWinScp.log')
    beni.remove(logFile)
    ary = [
        'option batch abort',
...
async def execute_try(*args: str, output: str = '', error: str = ''):
