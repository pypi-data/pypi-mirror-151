...
_EXECUTIONINVOCATION = _descriptor.Descriptor(
  ...
  nested_types=[_EXECUTIONINVOCATION_EXECUTIONPROPERTIESENTRY, _EXECUTIONINVOCATION_EXECUTIONPROPERTIESWITHSCHEMAENTRY, _EXECUTIONINVOCATION_INPUTDICTENTRY, _EXECUTIONINVOCATION_OUTPUTDICTENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
