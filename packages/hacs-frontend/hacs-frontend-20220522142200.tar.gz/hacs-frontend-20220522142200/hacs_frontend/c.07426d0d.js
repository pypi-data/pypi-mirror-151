      ...
      >
        <div class="content">
          ${"version"===this._repository.version_or_commit?n`
              ...
              `:""}
          ${this._repository.can_install?"":n`<ha-alert alert-type="error" .rtl=${b(this.hass)}>
          ...
          ${null!==(o=this._error)&&void 0!==o&&o.message?n`<ha-alert alert-type="error" .rtl=${b(this.hass)}>
                ${this._error.message}
              </ha-alert>`:""}
        </div>
        <mwc-button
