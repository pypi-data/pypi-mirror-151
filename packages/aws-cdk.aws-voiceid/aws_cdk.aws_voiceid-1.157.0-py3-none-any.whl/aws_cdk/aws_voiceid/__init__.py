...
class CfnDomain(
    ...
    def __init__(
        ...
        *,
        name: builtins.str,
        server_side_encryption_configuration: typing.Union["CfnDomain.ServerSideEncryptionConfigurationProperty", aws_cdk.core.IResolvable],
        ...
        :param server_side_encryption_configuration: The server-side encryption configuration containing the KMS Key Identifier you want VoiceID to use to encrypt your data.
    ...
    class ServerSideEncryptionConfigurationProperty:
        def __init__(self, *, kms_key_id: builtins.str) -> None:
            ...
            :param kms_key_id: The identifier of the KMS Key you want VoiceID to use to encrypt your data.
