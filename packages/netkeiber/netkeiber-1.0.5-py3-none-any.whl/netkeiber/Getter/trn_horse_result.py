...
class getter_trn_horse_result(baseGetter):
    ...
    #rsHorseResult = recset[trn_horse_result](trn_horse_result)
    """ 競走馬成績レコードセット """
    ...
    class beautifulSoup(browserContainer.beautifulSoup):
        ...
        def __init__(self, _config: netkeiberConfig):
            ...
            self.config = _config
            #self.bc = getter_trn_horse_result
            ...
            if horseResultTables:
                ...
                for index in range(len(horseResultTables)):
                    ...
                    try:
                        ...
                        # ペース
                        #paces = self.bc.getPace(self.bc, drow[self.horseResultCol.paces.value].text)
                        ...
                        #horseResult.fields(trn_horse_result.updinfo.key).value = self.bc.getUpdInfo(self.bc)
