...
class getter_trn_race_id(baseGetter):
    ...
    def getData(self, *args, **kwargs):
        ...
        for index, item in dfRaceIdCal.iterrows():
            ...
            #self.getRaceIdToDataFrame(open_id=item[trn_race_id.open_id.name], racecourse_id=item[trn_race_id.racecourse_id.name])
                ...
                for index in range(len(tables)):
                    try:
                        ...
                        for index in range(len(jyo_name)):
                            ...
                            #raceIdCalInfo.fields(trn_race_id.updinfo.key).value = self.bc.getUpdInfo(self.bc)
            ...
            if tables:
                ...
                for index in range(len(tables)):
                    ...
                    try:
                        ...
                        #raceIdInfo.fields(trn_race_id.updinfo.key).value = self.bc.getUpdInfo(self.bc)
                ...
                # レコードセットマージ
                self.bc.rsRaceId.merge(raceIdInfo)
