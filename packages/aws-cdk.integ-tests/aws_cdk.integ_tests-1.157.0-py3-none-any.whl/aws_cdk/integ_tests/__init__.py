...
integ.assert.aws_api_call("S3", "getObject")
```
...
assert = DeployAssert(app)
AwsApiCall(assert, "GetObject",
    service="S3",
    api="getObject"
)
```
...
assert = DeployAssert(app)
assert.aws_api_call("SQS", "receiveMessage", {
    "QueueUrl": "url"
})
```
...
integ.assert.invoke_function(
    function_name=fn.function_name,
    invocation_type=InvocationType.EVENT,
    payload=JSON.stringify({"status": "OK"})
)

message = integ.assert.aws_api_call("SQS", "receiveMessage", {
    "QueueUrl": queue.queue_url,
    "WaitTimeSeconds": 20
})

EqualsAssertion(integ.assert, "ReceiveMessage",
    actual=ActualResult.from_aws_api_call(message, "Messages.0.Body"),
    expected=ExpectedResult.object_like({
        "request_context": {
            "condition": "Success"
        },
        "request_payload": {
...
message.assert(ExpectedResult.object_like({
...
invoke = integ.assert.invoke_function(
    function_name=lambda_function.function_name
)
invoke.assert(ExpectedResult.object_like({
    "Payload": "200"
}))
```
...
# Start an execution
start = test_case.assert.aws_api_call("StepFunctions", "startExecution", {
    "state_machine_arn": sm.state_machine_arn
})

# describe the results of the execution
describe = test_case.assert.aws_api_call("StepFunctions", "describeExecution", {
    "execution_arn": start.get_att_string("executionArn")
})

# assert the results
describe.assert(ExpectedResult.object_like({
    "status": "SUCCEEDED"
}))
```
'''
...
class ActualResult(
    ...
    @jsii.member(jsii_name="fromAwsApiCall") # type: ignore[misc]
    ...
    @jsii.member(jsii_name="fromCustomResource") # type: ignore[misc]
    @builtins.classmethod
    def from_custom_resource(
        cls,
        custom_resource: aws_cdk.core.CustomResource,
        attribute: builtins.str,
    ) -> "ActualResult":
...
class AssertionsProvider(
    ...
    def handler_role_arn(self) -> aws_cdk.core.Reference:
        '''(experimental) A reference to the provider Lambda Function execution Role ARN.

        :stability: experimental
        '''
        return typing.cast(aws_cdk.core.Reference, jsii.get(self, "handlerRoleArn"))
...
class AwsApiCall(
    ...
    Example::
        ...
        assert = DeployAssert(app)
        assert.aws_api_call("SQS", "sendMessage", {
            "QueueUrl": "url",
            "MessageBody": "hello"
        })
        message = assert.aws_api_call("SQS", "receiveMessage", {
            "QueueUrl": "url"
        })
        message.assert(ExpectedResult.object_like({
            "Messages": [{"Body": "hello"}]
    ...
    def assert_(self, expected: "ExpectedResult") -> None:
        ...
        Example::
            ...
            invoke = LambdaInvokeFunction(assert, "Invoke",
                function_name="my-func"
            )
            invoke.assert(ExpectedResult.object_like({"Payload": "OK"}))
        '''
        return typing.cast(None, jsii.invoke(self, "assert", [expected]))
    ...
    def assert_at_path(self, path: builtins.str, expected: "ExpectedResult") -> None:
        ...
        Example::
            ...
            message = AwsApiCall(assert, "ReceiveMessage",
                service="SQS",
                api="receiveMessage"
            )
    ...
    def get_att(self, attribute_name: builtins.str) -> aws_cdk.core.Reference:
        ...
        :stability: experimental
        '''
        return typing.cast(aws_cdk.core.Reference, jsii.invoke(self, "getAtt", [attribute_name]))
...
class DeployAssert(
    aws_cdk.core.Construct,
    metaclass=jsii.JSIIMeta,
    jsii_type="@aws-cdk/integ-tests.DeployAssert",
):
    '''(experimental) Construct that allows for registering a list of assertions that should be performed on a construct.
    ...
    @jsii.member(jsii_name="isDeployAssert") # type: ignore[misc]
    @builtins.classmethod
    def is_deploy_assert(cls, x: typing.Any) -> builtins.bool:
        '''(experimental) Returns whether the construct is a DeployAssert construct.

        :param x: -

        :stability: experimental
        '''
        return typing.cast(builtins.bool, jsii.sinvoke(cls, "isDeployAssert", [x]))

    @jsii.member(jsii_name="of") # type: ignore[misc]
    @builtins.classmethod
    def of(cls, construct: constructs.IConstruct) -> "DeployAssert":
        '''(experimental) Finds a DeployAssert construct in the given scope.

        :param construct: -

        :stability: experimental
        '''
        return typing.cast("DeployAssert", jsii.sinvoke(cls, "of", [construct]))
    ...
    def assert_(
        ...
        Example::
            ...
            # deploy_assert: DeployAssert
            # api_call: AwsApiCall
            
            deploy_assert.assert("invoke",
                ExpectedResult.object_like({"Payload": "OK"}),
                ActualResult.from_aws_api_call(api_call, "Body"))
        '''
        return typing.cast(None, jsii.invoke(self, "assert", [id, expected, actual]))
    ...
    def aws_api_call(
        ...
        '''
        return typing.cast(AwsApiCall, jsii.invoke(self, "awsApiCall", [service, api, parameters]))
    ...
    def invoke_function(
        ...
        *,
        ...
        return typing.cast("LambdaInvokeFunction", jsii.invoke(self, "invokeFunction", [props]))


@jsii.data_type(
    jsii_type="@aws-cdk/integ-tests.DeployAssertProps",
    jsii_struct_bases=[],
    name_mapping={},
)
class DeployAssertProps:
    def __init__(self) -> None:
        '''(experimental) Options for DeployAssert.
        ...
        Example::
            ...
            deploy_assert_props = integ_tests.DeployAssertProps()
        '''
        self._values: typing.Dict[str, typing.Any] = {}
    ...
    def __repr__(self) -> str:
        return "DeployAssertProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class IntegTest(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        test_cases: typing.Sequence[aws_cdk.core.Stack],
    ...
    @builtins.property # type: ignore[misc]
    @jsii.member(jsii_name="assert")
    def assert_(self) -> DeployAssert:
        '''(experimental) Make assertions on resources in this test case.

        :stability: experimental
        '''
        return typing.cast(DeployAssert, jsii.get(self, "assert"))
...
class IntegTestCase(
    ...
    def manifest(self) -> aws_cdk.cloud_assembly_schema.IntegManifest:
        ...
        :stability: experimental
        '''
        return typing.cast(aws_cdk.cloud_assembly_schema.IntegManifest, jsii.get(self, "manifest"))
...
class IntegTestCaseStack(
    ...
    @jsii.member(jsii_name="isIntegTestCaseStack") # type: ignore[misc]
    @builtins.classmethod
...
@jsii.data_type(
    ...
    jsii_struct_bases=[
        aws_cdk.cloud_assembly_schema.TestOptions, aws_cdk.core.StackProps
    ],
    name_mapping={
        "allow_destroy": "allowDestroy",
        "cdk_command_options": "cdkCommandOptions",
...
class IntegTestProps(aws_cdk.cloud_assembly_schema.TestOptions):
    def __init__(
        self,
        *,
        allow_destroy: typing.Optional[typing.Sequence[builtins.str]] = None,
    ...
    @builtins.property
    def test_cases(self) -> typing.List[aws_cdk.core.Stack]:
...
@jsii.data_type(
    jsii_type="@aws-cdk/integ-tests.ResultsCollectionRequest",
    jsii_struct_bases=[],
    name_mapping={"assertion_results": "assertionResults"},
)
class ResultsCollectionRequest:
    def __init__(
        self,
        *,
        assertion_results: typing.Sequence[AssertionResultData],
    ) -> None:
        '''(experimental) Represents a collection of assertion request results.

        :param assertion_results: (experimental) The results of all the assertions that have been registered.
        ...
        Example::
            ...
            results_collection_request = integ_tests.ResultsCollectionRequest(
                assertion_results=[integ_tests.AssertionResultData(
                    status=integ_tests.Status.PASS,
    ...
    @builtins.property
    def assertion_results(self) -> typing.List[AssertionResultData]:
        '''(experimental) The results of all the assertions that have been registered.

        :stability: experimental
        '''
        result = self._values.get("assertion_results")
        assert result is not None, "Required property 'assertion_results' is missing"
        return typing.cast(typing.List[AssertionResultData], result)
    ...
    def __repr__(self) -> str:
        return "ResultsCollectionRequest(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


@jsii.data_type(
    jsii_type="@aws-cdk/integ-tests.ResultsCollectionResult",
    jsii_struct_bases=[],
    name_mapping={"message": "message"},
)
class ResultsCollectionResult:
    def __init__(self, *, message: builtins.str) -> None:
        '''(experimental) The result of a results request.

        :param message: (experimental) A message containing the results of the assertion.
        ...
        Example::
            ...
            results_collection_result = integ_tests.ResultsCollectionResult(
                message="message"
            )
        '''
        self._values: typing.Dict[str, typing.Any] = {
    ...
    def message(self) -> builtins.str:
        '''(experimental) A message containing the results of the assertion.
    ...
    def __repr__(self) -> str:
        return "ResultsCollectionResult(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
__all__ = [
    ...
    "LogType",
    "Match",
    "ResultsCollectionRequest",
    "ResultsCollectionResult",
    "Status",
]
