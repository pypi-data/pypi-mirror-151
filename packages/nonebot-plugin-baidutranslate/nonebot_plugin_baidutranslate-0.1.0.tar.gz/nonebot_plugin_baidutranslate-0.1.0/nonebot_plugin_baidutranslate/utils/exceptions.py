...
class BaiduNoBalanceException(BaiduBaseException):
    ...
    def __init__(self, code: str = "54004",
                 msg: str = "请前往 https://api.fanyi.baidu.com/api/trans/product/desktop 为账户充值 ..."):
        super().__init__(code, msg)
        self.code = code
        self.msg = msg
...
class BaiduIllegalClientIPException(BaiduBaseException):
    ...
    def __init__(self, code: str = "58000",
                 msg: str = "检查个人资料里填写的IP地址是否正确，可前往 https://api.fanyi.baidu.com/access/0/3 修改 ..."):
        super().__init__(code, msg)
        self.code = code
        self.msg = msg
...
if __name__ == "__main__":
    ...
    code = choice(list(EXCEPTIONS.keys()))
    print(code)
