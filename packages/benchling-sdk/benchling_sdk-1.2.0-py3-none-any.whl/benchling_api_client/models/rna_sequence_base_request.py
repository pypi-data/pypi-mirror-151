...
T = TypeVar("T", bound="RnaSequenceBaseRequest")
...
class RnaSequenceBaseRequest:
    ...
    def __repr__(self):
        ...
        return "RnaSequenceBaseRequest({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rna_sequence_base_request.additional_properties = d
        return rna_sequence_base_request
