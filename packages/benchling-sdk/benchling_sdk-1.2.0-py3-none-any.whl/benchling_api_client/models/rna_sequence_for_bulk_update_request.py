...
T = TypeVar("T", bound="RnaSequenceForBulkUpdateRequest")


@attr.s(auto_attribs=True, repr=False)
class RnaSequenceForBulkUpdateRequest:
    """  """
    ...
    def __repr__(self):
        ...
        return "RnaSequenceForBulkUpdateRequest({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rna_sequence_for_bulk_update_request = cls(
            id=id,
            aliases=aliases,
        ...
        return rna_sequence_for_bulk_update_request
