...
T = TypeVar("T", bound="RnaSequenceBaseForCreateRequest")


@attr.s(auto_attribs=True, repr=False)
class RnaSequenceBaseForCreateRequest:
    """  """
    ...
    def __repr__(self):
        ...
        return "RnaSequenceBaseForCreateRequest({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rna_sequence_base_for_create_request = cls(
            aliases=aliases,
        ...
        return rna_sequence_base_for_create_request
