...
T = TypeVar("T", bound="RnaSequenceCreateRequest")


@attr.s(auto_attribs=True, repr=False)
class RnaSequenceCreateRequest:
    """  """
    ...
    def __repr__(self):
        ...
        return "RnaSequenceCreateRequest({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        entity_registry_id = (
            get_entity_registry_id() if "entityRegistryId" in d else cast(Union[Unset, str], UNSET)
        )
        ...
        naming_strategy = (
            get_naming_strategy() if "namingStrategy" in d else cast(Union[Unset, NamingStrategy], UNSET)
        )
        ...
        rna_sequence_create_request = cls(
        ...
        return rna_sequence_create_request
