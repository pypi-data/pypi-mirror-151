...
import json
import domipy
from domipy.module_directory import MODULE_DIRECTORY
...
class Module(object):
    ...
    def get_status(self):
        message = domipy.ModuleStatusRequest(self.get_module_code(), self.get_serial_number())
    ...
    def _load(self):
        message = domipy.ModuleStatusRequest(self.get_module_code(), self._serial_number)
        self._controller.send(message)
