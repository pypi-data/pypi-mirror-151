...
SAGE_SPKG_FINALIZE([argcomplete], [standard], [normal], [SAGE_VENV])
...
SAGE_SPKG_FINALIZE([barvinok], [optional], [normal], [SAGE_LOCAL])
...
SAGE_SPKG_FINALIZE([jupyter_packaging], [optional], [pip], [SAGE_VENV])
...
SAGE_SPKG_FINALIZE([jupyterlab_widgets], [optional], [pip], [SAGE_VENV])
...
SAGE_SPKG_FINALIZE([ninja_build], [optional], [normal], [SAGE_LOCAL])
...
SAGE_SPKG_FINALIZE([polylib], [optional], [normal], [SAGE_LOCAL])
...
SAGE_SPKG_FINALIZE([r], [standard], [normal], [SAGE_LOCAL])
SAGE_SPKG_FINALIZE([r_jupyter], [optional], [script], [SAGE_LOCAL])
...
SAGE_SPKG_FINALIZE([sagemath_categories], [experimental], [script], [SAGE_LOCAL])
...
SAGE_SPKG_FINALIZE([sagemath_objects], [experimental], [script], [SAGE_LOCAL])
SAGE_SPKG_FINALIZE([sagenb_export], [standard], [normal], [SAGE_VENV])
SAGE_SPKG_FINALIZE([sagetex], [standard], [normal], [SAGE_VENV])
SAGE_SPKG_FINALIZE([scipoptsuite], [experimental], [normal], [SAGE_LOCAL])
...
SAGE_SPKG_FINALIZE([sip], [optional], [normal], [SAGE_LOCAL])
...
SAGE_SPKG_FINALIZE([testpath], [standard], [normal], [SAGE_VENV])
...
SAGE_SPKG_FINALIZE([zn_poly], [standard], [normal], [SAGE_LOCAL])
