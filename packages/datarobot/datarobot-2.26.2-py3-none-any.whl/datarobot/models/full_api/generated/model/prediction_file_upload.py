...
class PredictionFileUpload(APIObject):
    """
    Attributes
    ----------
    file:file_type
    ...
    relax_known_in_advance_features_check:str [optional]
    ...
    _converter = t.Dict(
        {
            ...
            t.Key("relax_known_in_advance_features_check", optional=True):  t.String(),
