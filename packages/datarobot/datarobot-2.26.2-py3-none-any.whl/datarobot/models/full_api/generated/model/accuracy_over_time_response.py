...
from datarobot.models.full_api.generated.model.accuracy_over_time_bucket import AccuracyOverTimeBucket

class AccuracyOverTimeResponse(APIObject):
    """
    Attributes
    ----------
    baseline:AccuracyOverTimeBucket
        
    buckets:[AccuracyOverTimeBucket]
    ...
    summary:AccuracyOverTimeBucket
