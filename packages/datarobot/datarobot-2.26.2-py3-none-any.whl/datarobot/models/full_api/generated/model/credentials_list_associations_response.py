...
from datarobot.models.full_api.generated.model.credentials_associations_data import CredentialsAssociationsData

class CredentialsListAssociationsResponse(APIObject):
    """
    Attributes
    ----------
    data:[CredentialsAssociationsData]
