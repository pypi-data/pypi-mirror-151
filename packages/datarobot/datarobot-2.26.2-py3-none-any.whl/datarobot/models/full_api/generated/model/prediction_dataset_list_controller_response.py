...
class PredictionDatasetListControllerResponse(APIObject):
    """
    Attributes
    ----------
    count:int
         The number of items returned on this page.
    data:[PredictionDatasetRetrieveResponse]
         Each has the same schema as if retrieving the dataset individually from :http:get:`/api/v2/projects/(projectId)/predictionDatasets/(datasetId)/`
    next:str, none_type
