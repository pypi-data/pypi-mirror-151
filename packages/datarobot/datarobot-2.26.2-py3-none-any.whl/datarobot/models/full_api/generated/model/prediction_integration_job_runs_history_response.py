...
from datarobot.models.full_api.generated.model.job_run_details import JobRunDetails

class PredictionIntegrationJobRunsHistoryResponse(APIObject):
    """
    Attributes
    ----------
    data:[JobRunDetails]
         An array of job runs
    next:str, none_type
