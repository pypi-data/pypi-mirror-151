...
from datarobot.models.full_api.generated.model.custom_model_deployment_response import CustomModelDeploymentResponse

class CustomModelDeploymentListResponse(APIObject):
    """
    Attributes
    ----------
    data:[CustomModelDeploymentResponse]
