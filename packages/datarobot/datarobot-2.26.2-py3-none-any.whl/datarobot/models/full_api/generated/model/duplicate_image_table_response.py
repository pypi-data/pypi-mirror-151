...
from datarobot.models.full_api.generated.model.duplicate_image_item import DuplicateImageItem

class DuplicateImageTableResponse(APIObject):
    """
    Attributes
    ----------
    data:[DuplicateImageItem]
