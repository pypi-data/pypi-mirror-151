...
from datarobot.models.full_api.generated.model.dataset_access_control_response import DatasetAccessControlResponse

class DatasetAccessControlListResponse(APIObject):
    """
    Attributes
    ----------
    data:[DatasetAccessControlResponse]
