...
from datarobot.models.full_api.generated.model.application_type_usecases import ApplicationTypeUsecases

class ApplicationTypeUsecasesListResponse(APIObject):
    """
    Attributes
    ----------
    count:int
         Number of items
    data:[ApplicationTypeUsecases]
         Information about usecases.
    next:str, none_type
