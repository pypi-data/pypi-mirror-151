...
from datarobot.models.full_api.generated.model.preview_permadelete_status import PreviewPermadeleteStatus

class UsersPermadeletePreviewJobStatusResponse(APIObject):
    """
    Attributes
    ----------
    created:datetime
         The time the status record was created.
    data:PreviewPermadeleteStatus
