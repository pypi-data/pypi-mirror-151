...
from datarobot.models.full_api.generated.model.change_request_info_response import ChangeRequestInfoResponse

class ChangeRequestInfoListResponse(APIObject):
    """
    Attributes
    ----------
    data:[ChangeRequestInfoResponse]
