...
from datarobot.models.full_api.generated.model.external_scores_list_data import ExternalScoresListData

class ExternalScoresListResponse(APIObject):
    """
    Attributes
    ----------
    count:int
         Number of items returned on this page.
    data:[ExternalScoresListData]
