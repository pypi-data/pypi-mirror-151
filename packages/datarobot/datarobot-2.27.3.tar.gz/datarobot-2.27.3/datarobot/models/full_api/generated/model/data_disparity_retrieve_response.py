...
from datarobot.models.full_api.generated.model.data_disparity_insights import DataDisparityInsights

class DataDisparityRetrieveResponse(APIObject):
    """
    Attributes
    ----------
    data:DataDisparityInsights
