...
from datarobot.models.full_api.generated.model.use_case_activity import UseCaseActivity

class UseCaseActivityListResponse(APIObject):
    """
    Attributes
    ----------
    count:int
         The number of items returned on this page
    data:[UseCaseActivity]
         The activities of a use case
    next:str, none_type
