...
from datarobot.models.full_api.generated.model.image_augmentation_retrieve_samples_item import ImageAugmentationRetrieveSamplesItem

class ImageAugmentationRetrieveSamplesResponse(APIObject):
    """
    Attributes
    ----------
    data:[ImageAugmentationRetrieveSamplesItem]
         Augmentation samples list
    next:str, none_type
