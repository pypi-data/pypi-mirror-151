...
from datarobot.models.full_api.generated.model.shap_matrix_list_data_field import ShapMatrixListDataField

class ShapMatrixListResponse(APIObject):
    """
    Attributes
    ----------
    data:[ShapMatrixListDataField]
