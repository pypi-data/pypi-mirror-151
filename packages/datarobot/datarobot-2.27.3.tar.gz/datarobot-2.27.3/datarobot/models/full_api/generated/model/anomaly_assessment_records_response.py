...
from datarobot.models.full_api.generated.model.anomaly_assessment_record_response import AnomalyAssessmentRecordResponse

class AnomalyAssessmentRecordsResponse(APIObject):
    """
    Attributes
    ----------
    count:int
         Number of items in current page.
    data:[AnomalyAssessmentRecordResponse]
