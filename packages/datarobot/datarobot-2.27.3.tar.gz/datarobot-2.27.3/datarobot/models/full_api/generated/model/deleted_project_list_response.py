...
from datarobot.models.full_api.generated.model.deleted_project_response import DeletedProjectResponse

class DeletedProjectListResponse(APIObject):
    """
    Attributes
    ----------
    data:[DeletedProjectResponse]
