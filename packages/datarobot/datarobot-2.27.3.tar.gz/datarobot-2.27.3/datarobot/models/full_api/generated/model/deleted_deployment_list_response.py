...
from datarobot.models.full_api.generated.model.deleted_deployment_response import DeletedDeploymentResponse

class DeletedDeploymentListResponse(APIObject):
    """
    Attributes
    ----------
    data:[DeletedDeploymentResponse]
