...
from datarobot.models.full_api.generated.model.prediction_server_response import PredictionServerResponse

class PredictionServerListResponse(APIObject):
    """
    Attributes
    ----------
    data:[PredictionServerResponse]
