...
from datarobot.models.full_api.generated.model.service_stats_over_time_bucket import ServiceStatsOverTimeBucket

class ServiceStatsOverTimeResponse(APIObject):
    """
    Attributes
    ----------
    buckets:[ServiceStatsOverTimeBucket]
         An array of `bucket` objects, representing service health statsof the deployment over time
    metric:str
         Name of the metric requested.
    summary:ServiceStatsOverTimeBucket
