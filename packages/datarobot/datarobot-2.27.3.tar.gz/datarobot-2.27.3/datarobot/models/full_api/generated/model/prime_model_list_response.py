...
class PrimeModelListResponse(APIObject):
    """
    Attributes
    ----------
    count:int
         number of items returned on this page
    data:[PrimeModelDetailsRetrieveResponse]
         each has the same schema as if retrieving the file individually from GET /api/v2/projects/(projectId)/primeFiles/(primeFileId)/.
    next:str, none_type
