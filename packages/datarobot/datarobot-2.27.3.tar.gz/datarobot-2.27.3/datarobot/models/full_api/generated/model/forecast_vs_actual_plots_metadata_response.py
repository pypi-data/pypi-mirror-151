...
from datarobot.models.full_api.generated.model.forecast_vs_actual_plots_status import ForecastVsActualPlotsStatus

class ForecastVsActualPlotsMetadataResponse(APIObject):
    """
    Attributes
    ----------
    ...
    backtest_statuses:[ForecastVsActualPlotsStatus]
    ...
    holdout_statuses:ForecastVsActualPlotsStatus
