...
from datarobot.models.testing_list.generated.model.base_dependency_build_metadata_response import BaseDependencyBuildMetadataResponse
from datarobot.models.testing_list.generated.model.custom_model_access_control_list_response import CustomModelAccessControlListResponse
from datarobot.models.testing_list.generated.model.custom_model_access_control_update_response import CustomModelAccessControlUpdateResponse
from datarobot.models.testing_list.generated.model.custom_model_async_operation_response import CustomModelAsyncOperationResponse
from datarobot.models.testing_list.generated.model.custom_model_copy import CustomModelCopy
from datarobot.models.testing_list.generated.model.custom_model_create import CustomModelCreate
from datarobot.models.testing_list.generated.model.custom_model_deployment_list_response import CustomModelDeploymentListResponse
from datarobot.models.testing_list.generated.model.custom_model_list_response import CustomModelListResponse
from datarobot.models.testing_list.generated.model.custom_model_prediction_explanations import CustomModelPredictionExplanations
from datarobot.models.testing_list.generated.model.custom_model_resource_limits import CustomModelResourceLimits
from datarobot.models.testing_list.generated.model.custom_model_response import CustomModelResponse
from datarobot.models.testing_list.generated.model.custom_model_tests import CustomModelTests
from datarobot.models.testing_list.generated.model.custom_model_tests_list_response import CustomModelTestsListResponse
from datarobot.models.testing_list.generated.model.custom_model_tests_log_tail_response import CustomModelTestsLogTailResponse
from datarobot.models.testing_list.generated.model.custom_model_tests_response import CustomModelTestsResponse
from datarobot.models.testing_list.generated.model.custom_model_update import CustomModelUpdate
from datarobot.models.testing_list.generated.model.custom_model_version_create_from_repository import CustomModelVersionCreateFromRepository
from datarobot.models.testing_list.generated.model.custom_model_version_list_response import CustomModelVersionListResponse
from datarobot.models.testing_list.generated.model.custom_model_version_metadata_update import CustomModelVersionMetadataUpdate
from datarobot.models.testing_list.generated.model.custom_model_version_response import CustomModelVersionResponse
from datarobot.models.testing_list.generated.model.custom_training_blueprint_create import CustomTrainingBlueprintCreate
from datarobot.models.testing_list.generated.model.custom_training_blueprint_list_response import CustomTrainingBlueprintListResponse
from datarobot.models.testing_list.generated.model.custom_training_blueprint_response import CustomTrainingBlueprintResponse
from datarobot.models.testing_list.generated.model.dependency_build_log_response import DependencyBuildLogResponse
from datarobot.models.testing_list.generated.model.feature_impact_create_payload import FeatureImpactCreatePayload
from datarobot.models.testing_list.generated.model.feature_impact_create_response import FeatureImpactCreateResponse
...
from datarobot.models.testing_list.generated.model.training_data_assignment import TrainingDataAssignment
from datarobot.utils import from_api
from datarobot.models.testing_list.generated.model import *

from datarobot.models.testing_list.generated.api.custom_models_api import CustomModelsApi
...
def test_custom_models_api_custom_inference_images_feature_impact_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/customInferenceImages/{imageId}/featureImpact/'.format(endpoint=unittest_endpoint,
...
def test_custom_models_api_custom_model_deployments_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/customModelDeployments/'.format(endpoint=unittest_endpoint,
        offset=0, limit=100, ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_custom_models_api_custom_model_limits_list(unittest_endpoint):
    responses.add(
        responses.GET,
       '{endpoint}/customModelLimits/'.format(endpoint=unittest_endpoint),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_custom_models_api_custom_model_tests_create(unittest_endpoint):
    responses.add(
        responses.POST,
       '{endpoint}/customModelTests/'.format(endpoint=unittest_endpoint),
        status=202,
        content_type='application/json',
        body=json.dumps({
  "statusId" : "statusId"
...
def test_custom_models_api_custom_model_tests_delete(unittest_endpoint):
    responses.add(
        responses.DELETE,
        '{endpoint}/customModelTests/{customModelTestId}/'.format(endpoint=unittest_endpoint,
...
def test_custom_models_api_custom_model_tests_log_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/customModelTests/{customModelTestId}/log/'.format(endpoint=unittest_endpoint,
        customModelTestId="customModelTestId_example", ),
        status=200,
        content_type='',
    )
...
def test_custom_models_api_custom_model_tests_tail_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/customModelTests/{customModelTestId}/tail/'.format(endpoint=unittest_endpoint,
...
def test_custom_models_api_custom_models_access_control_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/customModels/{customModelId}/accessControl/'.format(endpoint=unittest_endpoint,
        offset=0, limit=1000, customModelId="customModelId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_custom_models_api_custom_models_create(unittest_endpoint):
    responses.add(
        responses.POST,
       '{endpoint}/customModels/'.format(endpoint=unittest_endpoint),
        status=201,
        content_type='application/json',
        body=json.dumps({
...
def test_custom_models_api_custom_models_delete(unittest_endpoint):
    responses.add(
        responses.DELETE,
        '{endpoint}/customModels/{customModelId}/'.format(endpoint=unittest_endpoint,
        customModelId="customModelId_example", ),
        status=204,
        content_type='',
    )
...
def test_custom_models_api_custom_models_download_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/customModels/{customModelId}/download/'.format(endpoint=unittest_endpoint,
        customModelId="customModelId_example", ),
        status=200,
        content_type='',
    )
...
def test_custom_models_api_custom_models_from_custom_model_create(unittest_endpoint):
    responses.add(
        responses.POST,
       '{endpoint}/customModels/fromCustomModel/'.format(endpoint=unittest_endpoint),
        status=201,
        content_type='application/json',
        body=json.dumps({
  "targetName" : "targetName",
...
def test_custom_models_api_custom_models_prediction_explanations_initialization_create(unittest_endpoint):
    responses.add(
        responses.POST,
       '{endpoint}/customModels/predictionExplanationsInitialization/'.format(endpoint=unittest_endpoint),
        status=202,
        content_type='',
    )
...
def test_custom_models_api_custom_models_training_data_patch_many(unittest_endpoint):
    responses.add(
        responses.PATCH,
        '{endpoint}/customModels/{customModelId}/trainingData/'.format(endpoint=unittest_endpoint,
        customModelId="customModelId_example", ),
        status=202,
        content_type='',
    )
...
def test_custom_models_api_custom_models_version_create_from_latest(unittest_endpoint):
    responses.add(
        responses.PATCH,
        '{endpoint}/customModels/{customModelId}/versions/'.format(endpoint=unittest_endpoint,
...
def test_custom_models_api_custom_models_versions_dependency_build_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/customModels/{customModelId}/versions/{customModelVersionId}/dependencyBuild/'.format(endpoint=unittest_endpoint,
...
def test_custom_models_api_custom_models_versions_dependency_build_log_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/customModels/{customModelId}/versions/{customModelVersionId}/dependencyBuildLog/'.format(endpoint=unittest_endpoint,
        customModelId="customModelId_example", customModelVersionId="customModelVersionId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_custom_models_api_custom_models_versions_download_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/customModels/{customModelId}/versions/{customModelVersionId}/download/'.format(endpoint=unittest_endpoint,
        customModelId="customModelId_example", customModelVersionId="customModelVersionId_example", ),
        status=200,
        content_type='',
    )
...
def test_custom_models_api_custom_models_versions_feature_impact_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/customModels/{customModelId}/versions/{customModelVersionId}/featureImpact/'.format(endpoint=unittest_endpoint,
        customModelId="customModelId_example", customModelVersionId="customModelVersionId_example", ),
        status=202,
        content_type='application/json',
        body=json.dumps({
...
def test_custom_models_api_custom_models_versions_from_repository_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/customModels/{customModelId}/versions/fromRepository/'.format(endpoint=unittest_endpoint,
        customModelId="customModelId_example", ),
        status=202,
        content_type='',
    )
...
def test_custom_models_api_custom_models_versions_patch(unittest_endpoint):
    responses.add(
        responses.PATCH,
        '{endpoint}/customModels/{customModelId}/versions/{customModelVersionId}/'.format(endpoint=unittest_endpoint,
        customModelId="customModelId_example", customModelVersionId="customModelVersionId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_custom_models_api_custom_models_versions_prediction_explanations_initialization_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/customModels/{customModelId}/versions/{customModelVersionId}/predictionExplanationsInitialization/'.format(endpoint=unittest_endpoint,
        customModelId="customModelId_example", customModelVersionId="customModelVersionId_example", ),
        status=202,
        content_type='',
    )
...
def test_custom_models_api_custom_training_blueprints_create(unittest_endpoint):
    responses.add(
        responses.POST,
       '{endpoint}/customTrainingBlueprints/'.format(endpoint=unittest_endpoint),
        status=201,
        content_type='application/json',
        body=json.dumps({
