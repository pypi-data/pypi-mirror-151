...
from datarobot.models.testing_list.generated.model.approval_policy import ApprovalPolicy
from datarobot.models.testing_list.generated.model.approval_policy_list_response import ApprovalPolicyListResponse
from datarobot.models.testing_list.generated.model.approval_policy_match_response import ApprovalPolicyMatchResponse
from datarobot.models.testing_list.generated.model.approval_policy_response import ApprovalPolicyResponse
from datarobot.models.testing_list.generated.model.approval_workflow_list_trigger_response import ApprovalWorkflowListTriggerResponse
from datarobot.models.testing_list.generated.model.change_request_info_list_response import ChangeRequestInfoListResponse
from datarobot.utils import from_api
from datarobot.models.testing_list.generated.model import *

from datarobot.models.testing_list.generated.api.governance_api import GovernanceApi
...
def test_governance_api_approval_policies_create(unittest_endpoint):
    responses.add(
        responses.POST,
       '{endpoint}/approvalPolicies/'.format(endpoint=unittest_endpoint),
        status=201,
...
def test_governance_api_approval_policies_delete(unittest_endpoint):
    responses.add(
        responses.DELETE,
        '{endpoint}/approvalPolicies/{approvalPolicyId}/'.format(endpoint=unittest_endpoint,
...
def test_governance_api_approval_policies_shareable_change_requests_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/approvalPolicies/{approvalPolicyId}/shareableChangeRequests/'.format(endpoint=unittest_endpoint,
        approvalPolicyId="approvalPolicyId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_governance_api_approval_policy_match_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/approvalPolicyMatch/'.format(endpoint=unittest_endpoint,
...
def test_governance_api_approval_policy_triggers_list(unittest_endpoint):
    responses.add(
        responses.GET,
       '{endpoint}/approvalPolicyTriggers/'.format(endpoint=unittest_endpoint),
        status=200,
        content_type='application/json',
        body=json.dumps({
  "data" : [ {
