...
from datarobot.models.testing_list.generated.model.geometry_feature_p_lot_create_payload import GeometryFeaturePLotCreatePayload
from datarobot.models.testing_list.generated.model.geometry_feature_plot_retrieve_response import GeometryFeaturePlotRetrieveResponse
from datarobot.utils import from_api
from datarobot.models.testing_list.generated.model import *

from datarobot.models.testing_list.generated.api.location_ai_api import LocationAiApi
...
def test_location_ai_api_projects_geometry_feature_plots_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/projects/{projectId}/geometryFeaturePlots/'.format(endpoint=unittest_endpoint,
...
def test_location_ai_api_projects_geometry_feature_plots_retrieve(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/geometryFeaturePlots/{featureName}/'.format(endpoint=unittest_endpoint,
