...
from datarobot.models.testing_list.generated.model.aot_chart_metadata_response import AOTChartMetadataResponse
from datarobot.models.testing_list.generated.model.aot_chart_preview_response import AOTChartPreviewResponse
from datarobot.models.testing_list.generated.model.aot_chart_retrieve_response import AOTChartRetrieveResponse
from datarobot.models.testing_list.generated.model.anomaly_assessment_explanations_response import AnomalyAssessmentExplanationsResponse
from datarobot.models.testing_list.generated.model.anomaly_assessment_initialize import AnomalyAssessmentInitialize
from datarobot.models.testing_list.generated.model.anomaly_assessment_preview_response import AnomalyAssessmentPreviewResponse
from datarobot.models.testing_list.generated.model.anomaly_assessment_records_response import AnomalyAssessmentRecordsResponse
...
from datarobot.models.testing_list.generated.model.confusion_chart_for_datasets_list_response import ConfusionChartForDatasetsListResponse
from datarobot.models.testing_list.generated.model.confusion_chart_retrieve_for_datasets import ConfusionChartRetrieveForDatasets
from datarobot.models.testing_list.generated.model.confusion_chart_retrieve_metadata_for_datasets import ConfusionChartRetrieveMetadataForDatasets
...
from datarobot.models.testing_list.generated.model.external_scores_create import ExternalScoresCreate
from datarobot.models.testing_list.generated.model.external_scores_list_response import ExternalScoresListResponse
...
from datarobot.models.testing_list.generated.model.feature_association_create_payload import FeatureAssociationCreatePayload
from datarobot.models.testing_list.generated.model.feature_association_details_retrieve_controller_response import FeatureAssociationDetailsRetrieveControllerResponse
from datarobot.models.testing_list.generated.model.feature_association_list_controller_response import FeatureAssociationListControllerResponse
from datarobot.models.testing_list.generated.model.feature_association_retrieve_controller_response import FeatureAssociationRetrieveControllerResponse
from datarobot.models.testing_list.generated.model.feature_effect_create import FeatureEffectCreate
from datarobot.models.testing_list.generated.model.feature_effects_create_datetime import FeatureEffectsCreateDatetime
from datarobot.models.testing_list.generated.model.feature_effects_datetime_response import FeatureEffectsDatetimeResponse
from datarobot.models.testing_list.generated.model.feature_effects_response import FeatureEffectsResponse
from datarobot.models.testing_list.generated.model.feature_fit_datetime_response import FeatureFitDatetimeResponse
from datarobot.models.testing_list.generated.model.feature_fit_response import FeatureFitResponse
from datarobot.models.testing_list.generated.model.feature_impact_create_payload import FeatureImpactCreatePayload
from datarobot.models.testing_list.generated.model.feature_impact_response import FeatureImpactResponse
from datarobot.models.testing_list.generated.model.frequent_values_response import FrequentValuesResponse
from datarobot.models.testing_list.generated.model.lift_chart_for_datasets_list import LiftChartForDatasetsList
from datarobot.models.testing_list.generated.model.model_confusion_chart_class_details_for_dataset_retrieve import ModelConfusionChartClassDetailsForDatasetRetrieve
from datarobot.models.testing_list.generated.model.model_xray_create_datetime import ModelXrayCreateDatetime
from datarobot.models.testing_list.generated.model.model_xray_metadata_datetime_response import ModelXrayMetadataDatetimeResponse
from datarobot.models.testing_list.generated.model.model_xray_metadata_response import ModelXrayMetadataResponse
from datarobot.models.testing_list.generated.model.multiclass_feature_impact_response import MulticlassFeatureImpactResponse
from datarobot.models.testing_list.generated.model.multiclass_lift_chart_for_datasets_list import MulticlassLiftChartForDatasetsList
from datarobot.models.testing_list.generated.model.payoff_matrices_create import PayoffMatricesCreate
from datarobot.models.testing_list.generated.model.payoff_matrices_list_response import PayoffMatricesListResponse
from datarobot.models.testing_list.generated.model.payoff_matrices_response import PayoffMatricesResponse
...
from datarobot.models.testing_list.generated.model.residuals_chart_for_datasets_list import ResidualsChartForDatasetsList
from datarobot.models.testing_list.generated.model.roc_curve_for_datasets_list import RocCurveForDatasetsList
from datarobot.models.testing_list.generated.model.shap_impact_retrieve_response import ShapImpactRetrieveResponse
from datarobot.utils import from_api
from datarobot.models.testing_list.generated.model import *

from datarobot.models.testing_list.generated.api.insights_api import InsightsApi
...
def test_insights_api_projects_anomaly_assessment_records_delete(unittest_endpoint):
    responses.add(
        responses.DELETE,
        '{endpoint}/projects/{projectId}/anomalyAssessmentRecords/{recordId}/'.format(endpoint=unittest_endpoint,
...
def test_insights_api_projects_anomaly_assessment_records_explanations_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/anomalyAssessmentRecords/{recordId}/explanations/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", recordId="recordId_example", ),
        status=200,
...
def test_insights_api_projects_anomaly_assessment_records_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/anomalyAssessmentRecords/'.format(endpoint=unittest_endpoint,
...
def test_insights_api_projects_anomaly_assessment_records_predictions_preview_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/anomalyAssessmentRecords/{recordId}/predictionsPreview/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", recordId="recordId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_insights_api_projects_datetime_models_dataset_accuracy_over_time_plots_metadata_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/datetimeModels/{modelId}/datasetAccuracyOverTimePlots/{datasetId}/metadata/'.format(endpoint=unittest_endpoint,
...
def test_insights_api_projects_datetime_models_dataset_accuracy_over_time_plots_preview_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/datetimeModels/{modelId}/datasetAccuracyOverTimePlots/{datasetId}/preview/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", modelId="modelId_example", datasetId="datasetId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_insights_api_projects_datetime_models_dataset_accuracy_over_time_plots_retrieve(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/datetimeModels/{modelId}/datasetAccuracyOverTimePlots/{datasetId}/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", modelId="modelId_example", datasetId="datasetId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_insights_api_projects_datetime_models_feature_effects_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/projects/{projectId}/datetimeModels/{modelId}/featureEffects/'.format(endpoint=unittest_endpoint,
...
def test_insights_api_projects_datetime_models_feature_effects_metadata_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/datetimeModels/{modelId}/featureEffectsMetadata/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", modelId="modelId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_insights_api_projects_datetime_models_feature_fit_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/projects/{projectId}/datetimeModels/{modelId}/featureFit/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", modelId="modelId_example", ),
        status=202,
        content_type='',
    )
...
def test_insights_api_projects_datetime_models_feature_fit_metadata_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/datetimeModels/{modelId}/featureFitMetadata/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", modelId="modelId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_insights_api_projects_external_scores_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/projects/{projectId}/externalScores/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", ),
        status=202,
        content_type='',
    )
...
def test_insights_api_projects_feature_association_featurelists_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/featureAssociationFeaturelists/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_insights_api_projects_feature_association_matrix_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/projects/{projectId}/featureAssociationMatrix/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", ),
        status=202,
        content_type='',
    )
...
def test_insights_api_projects_feature_association_matrix_details_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/featureAssociationMatrixDetails/'.format(endpoint=unittest_endpoint,
...
def test_insights_api_projects_features_frequent_values_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/features/{featureName}/frequentValues/'.format(endpoint=unittest_endpoint,
...
def test_insights_api_projects_models_anomaly_assessment_initialization_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/projects/{projectId}/models/{modelId}/anomalyAssessmentInitialization/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", modelId="modelId_example", ),
        status=202,
        content_type='',
    )
...
def test_insights_api_projects_models_dataset_confusion_charts_class_details_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/models/{modelId}/datasetConfusionCharts/{datasetId}/classDetails/'.format(endpoint=unittest_endpoint,
...
def test_insights_api_projects_models_dataset_confusion_charts_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/models/{modelId}/datasetConfusionCharts/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", modelId="modelId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_insights_api_projects_models_dataset_confusion_charts_metadata_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/models/{modelId}/datasetConfusionCharts/{datasetId}/metadata/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", modelId="modelId_example", datasetId="datasetId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_insights_api_projects_models_dataset_confusion_charts_retrieve(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/models/{modelId}/datasetConfusionCharts/{datasetId}/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", modelId="modelId_example", datasetId="datasetId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_insights_api_projects_models_dataset_lift_charts_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/models/{modelId}/datasetLiftCharts/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", modelId="modelId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_insights_api_projects_models_dataset_multiclass_lift_charts_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/models/{modelId}/datasetMulticlassLiftCharts/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", modelId="modelId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_insights_api_projects_models_dataset_residuals_charts_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/models/{modelId}/datasetResidualsCharts/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", modelId="modelId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_insights_api_projects_models_dataset_roc_curves_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/models/{modelId}/datasetRocCurves/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", modelId="modelId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_insights_api_projects_models_feature_effects_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/projects/{projectId}/models/{modelId}/featureEffects/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", modelId="modelId_example", ),
        status=202,
        content_type='',
    )
...
def test_insights_api_projects_models_feature_effects_metadata_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/models/{modelId}/featureEffectsMetadata/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", modelId="modelId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_insights_api_projects_models_feature_fit_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/projects/{projectId}/models/{modelId}/featureFit/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", modelId="modelId_example", ),
        status=202,
        content_type='',
    )
...
def test_insights_api_projects_models_feature_fit_metadata_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/models/{modelId}/featureFitMetadata/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", modelId="modelId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_insights_api_projects_models_feature_impact_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/projects/{projectId}/models/{modelId}/featureImpact/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", modelId="modelId_example", ),
        status=202,
        content_type='',
    )
...
def test_insights_api_projects_models_multiclass_feature_impact_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/models/{modelId}/multiclassFeatureImpact/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", modelId="modelId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_insights_api_projects_models_shap_impact_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/projects/{projectId}/models/{modelId}/shapImpact/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", modelId="modelId_example", ),
        status=200,
        content_type='',
    )
...
def test_insights_api_projects_payoff_matrices_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/projects/{projectId}/payoffMatrices/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", ),
        status=200,
        content_type='',
    )
...
def test_insights_api_projects_payoff_matrices_delete(unittest_endpoint):
    responses.add(
        responses.DELETE,
        '{endpoint}/projects/{projectId}/payoffMatrices/{payoffMatrixId}/'.format(endpoint=unittest_endpoint,
