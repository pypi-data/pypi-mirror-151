...
from datarobot.models.testing_list.generated.model.feature_discovery_log_list_response import FeatureDiscoveryLogListResponse
from datarobot.models.testing_list.generated.model.feature_discovery_recipe_sqls_export import FeatureDiscoveryRecipeSQLsExport
from datarobot.models.testing_list.generated.model.relationships_config_create import RelationshipsConfigCreate
...
from datarobot.models.testing_list.generated.api.feature_discovery_api import FeatureDiscoveryApi
...
def test_feature_discovery_api_projects_feature_discovery_dataset_download_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/featureDiscoveryDatasetDownload/'.format(endpoint=unittest_endpoint,
...
def test_feature_discovery_api_projects_feature_discovery_logs_download_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/featureDiscoveryLogs/download/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", ),
        status=200,
        content_type='',
    )
...
def test_feature_discovery_api_projects_feature_discovery_logs_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/featureDiscoveryLogs/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", ),
        status=200,
...
def test_feature_discovery_api_projects_feature_discovery_recipe_sql_exports_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/projects/{projectId}/featureDiscoveryRecipeSqlExports/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", ),
        status=202,
        content_type='',
    )
...
def test_feature_discovery_api_projects_feature_discovery_recipe_sqls_download_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/featureDiscoveryRecipeSQLs/download/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", ),
        status=200,
        content_type='',
    )
...
def test_feature_discovery_api_relationships_configurations_create(unittest_endpoint):
    responses.add(
        responses.POST,
       '{endpoint}/relationshipsConfigurations/'.format(endpoint=unittest_endpoint),
        status=201,
        content_type='application/json',
        body=json.dumps({
  "relationships" : [ {
...
def test_feature_discovery_api_relationships_configurations_delete(unittest_endpoint):
    responses.add(
        responses.DELETE,
        '{endpoint}/relationshipsConfigurations/{relationshipsConfigurationId}/'.format(endpoint=unittest_endpoint,
