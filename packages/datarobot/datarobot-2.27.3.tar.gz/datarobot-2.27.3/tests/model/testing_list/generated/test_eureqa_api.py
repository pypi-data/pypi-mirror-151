...
from datarobot.models.testing_list.generated.model.eureqa_distribution_detail_response import EureqaDistributionDetailResponse
from datarobot.models.testing_list.generated.model.eureqa_leaderboard_entry_payload import EureqaLeaderboardEntryPayload
from datarobot.models.testing_list.generated.model.eureqa_model_detail_response import EureqaModelDetailResponse
from datarobot.models.testing_list.generated.model.pareto_front_response import ParetoFrontResponse
from datarobot.utils import from_api
from datarobot.models.testing_list.generated.model import *

from datarobot.models.testing_list.generated.api.eureqa_api import EureqaApi
...
def test_eureqa_api_projects_eureqa_distribution_plot_retrieve(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/eureqaDistributionPlot/{solutionId}/'.format(endpoint=unittest_endpoint,
...
def test_eureqa_api_projects_eureqa_model_detail_retrieve(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/eureqaModelDetail/{solutionId}/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", solutionId="solutionId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_eureqa_api_projects_eureqa_models_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/projects/{projectId}/eureqaModels/'.format(endpoint=unittest_endpoint,
...
def test_eureqa_api_projects_eureqa_models_retrieve(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/eureqaModels/{modelId}/'.format(endpoint=unittest_endpoint,
