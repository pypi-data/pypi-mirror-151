...
from datarobot.models.testing_list.generated.model.driver_configuration_list_response import DriverConfigurationListResponse
...
from datarobot.models.testing_list.generated.api.external_drivers_api import ExternalDriversApi
...
def test_external_drivers_api_external_driver_configurations_list(unittest_endpoint):
    responses.add(
        responses.GET,
       '{endpoint}/externalDriverConfigurations/'.format(endpoint=unittest_endpoint),
        status=200,
...
def test_external_drivers_api_external_driver_configurations_retrieve(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/externalDriverConfigurations/{configurationId}/'.format(endpoint=unittest_endpoint,
