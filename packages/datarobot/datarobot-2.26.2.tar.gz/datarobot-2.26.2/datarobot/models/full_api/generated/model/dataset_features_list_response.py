...
from datarobot.models.full_api.generated.model.dataset_feature_response import DatasetFeatureResponse

class DatasetFeaturesListResponse(APIObject):
    """
    Attributes
    ----------
    data:[DatasetFeatureResponse]
