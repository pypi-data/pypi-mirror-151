...
from datarobot.models.full_api.generated.model.traning_prediction_row import TraningPredictionRow

class TrainingPredictionsRetrieveResponse(APIObject):
    """
    Attributes
    ----------
    data:[TraningPredictionRow]
