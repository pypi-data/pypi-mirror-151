...
from datarobot.models.full_api.generated.model.humility_stats_rule import HumilityStatsRule
from datarobot.models.full_api.generated.model.time_range import TimeRange

class HumilityStatsRetrieveResponse(APIObject):
    """
    Attributes
    ----------
    data:[HumilityStatsRule]
         metrics rules
    period:TimeRange
