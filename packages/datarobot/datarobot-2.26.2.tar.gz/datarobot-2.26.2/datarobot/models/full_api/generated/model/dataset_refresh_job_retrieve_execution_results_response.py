...
from datarobot.models.full_api.generated.model.dataset_refresh_execution_result import DatasetRefreshExecutionResult

class DatasetRefreshJobRetrieveExecutionResultsResponse(APIObject):
    """
    Attributes
    ----------
    data:[DatasetRefreshExecutionResult]
