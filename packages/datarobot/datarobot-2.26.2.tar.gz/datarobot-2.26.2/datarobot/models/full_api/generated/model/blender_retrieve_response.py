...
class BlenderRetrieveResponse(APIObject):
    """
    Attributes
    ----------
    blender_method:str
    ...
    featurelist_id:str, none_type
         The ID of the featurelist used by the model. If null, the model was trained on multiple feature lists.
    featurelist_name:str, none_type
         The name of the featurelist used by the model. If null, the model was trained on multiple feature lists.
    id:str
         The ID of the model.
    is_frozen:bool
    ...
    model_category:str
         Indicates what kind of model it is - will be `blend` for blenders.
    model_family:str
    ...
    model_type:str
         Identifies the model, e.g. `ENET Blender`.
    ...
    processes:[str]
         A list of processes used by the model.
    project_id:str
