...
from datarobot.models.full_api.generated.model.automated_doc_item import AutomatedDocItem

class AutomatedDocListResponse(APIObject):
    """
    Attributes
    ----------
    data:[AutomatedDocItem]
