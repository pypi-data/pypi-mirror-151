...
Detailed explanations are available in the DataRobot Platform documentation,
`Creating augmented models <https://app.datarobot.com/docs/modeling/visual-ai/tti-augment/ttia-introduction.html>`_.
...
After image augmentation samples are computed, you can download them from the
DataRobot server. The following snippet is an example of how to get the
