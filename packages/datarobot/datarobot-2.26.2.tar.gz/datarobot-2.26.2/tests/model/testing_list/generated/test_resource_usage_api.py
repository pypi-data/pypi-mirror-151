...
from datarobot.models.testing_list.generated.model.resource_usage_response import ResourceUsageResponse
from datarobot.utils import from_api
from datarobot.models.testing_list.generated.model import *

from datarobot.models.testing_list.generated.api.resource_usage_api import ResourceUsageApi
...
def test_resource_usage_api_users_rate_limit_usage_delete(unittest_endpoint):
    responses.add(
        responses.DELETE,
        '{endpoint}/users/{userId}/rateLimitUsage/{resourceName}/'.format(endpoint=unittest_endpoint,
...
def test_resource_usage_api_users_rate_limit_usage_delete_many(unittest_endpoint):
    responses.add(
        responses.DELETE,
        '{endpoint}/users/{userId}/rateLimitUsage/'.format(endpoint=unittest_endpoint,
