...
from datarobot.models.testing_list.generated.model.add_users_to_group_response import AddUsersToGroupResponse
from datarobot.models.testing_list.generated.model.list_users_in_group_response import ListUsersInGroupResponse
from datarobot.models.testing_list.generated.model.modify_users_in_group import ModifyUsersInGroup
from datarobot.models.testing_list.generated.model.user_group_bulk_delete import UserGroupBulkDelete
from datarobot.models.testing_list.generated.model.user_group_create import UserGroupCreate
from datarobot.models.testing_list.generated.model.user_group_response import UserGroupResponse
from datarobot.models.testing_list.generated.model.user_group_update import UserGroupUpdate
from datarobot.utils import from_api
from datarobot.models.testing_list.generated.model import *

from datarobot.models.testing_list.generated.api.groups_api import GroupsApi
...
def test_groups_api_groups_create(unittest_endpoint):
    responses.add(
        responses.POST,
       '{endpoint}/groups/'.format(endpoint=unittest_endpoint),
        status=201,
...
def test_groups_api_groups_delete(unittest_endpoint):
    responses.add(
        responses.DELETE,
        '{endpoint}/groups/{groupId}/'.format(endpoint=unittest_endpoint,
...
def test_groups_api_groups_users_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/groups/{groupId}/users/'.format(endpoint=unittest_endpoint,
        groupId="groupId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
