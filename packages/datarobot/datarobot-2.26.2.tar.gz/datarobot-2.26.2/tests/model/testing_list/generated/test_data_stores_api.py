...
from datarobot.models.testing_list.generated.model.data_store_create import DataStoreCreate
from datarobot.models.testing_list.generated.model.data_store_credentials import DataStoreCredentials
from datarobot.models.testing_list.generated.model.data_store_credentials_with_credentials_type_support import DataStoreCredentialsWithCredentialsTypeSupport
from datarobot.models.testing_list.generated.model.data_store_describe_permissions_response import DataStoreDescribePermissionsResponse
from datarobot.models.testing_list.generated.model.data_store_list_response import DataStoreListResponse
from datarobot.models.testing_list.generated.model.data_store_retrieve_response import DataStoreRetrieveResponse
from datarobot.models.testing_list.generated.model.data_store_sql_verify import DataStoreSQLVerify
from datarobot.models.testing_list.generated.model.data_store_sql_verify_response import DataStoreSQLVerifyResponse
from datarobot.models.testing_list.generated.model.data_store_schemas_list import DataStoreSchemasList
from datarobot.models.testing_list.generated.model.data_store_tables import DataStoreTables
from datarobot.models.testing_list.generated.model.data_store_tables_list import DataStoreTablesList
from datarobot.models.testing_list.generated.model.data_store_test_response import DataStoreTestResponse
from datarobot.models.testing_list.generated.model.data_store_update import DataStoreUpdate
...
from datarobot.models.testing_list.generated.api.data_stores_api import DataStoresApi
...
def test_data_stores_api_external_data_stores_access_control_patch_many(unittest_endpoint):
    responses.add(
        responses.PATCH,
        '{endpoint}/externalDataStores/{dataStoreId}/accessControl/'.format(endpoint=unittest_endpoint,
...
def test_data_stores_api_external_data_stores_create(unittest_endpoint):
    responses.add(
        responses.POST,
       '{endpoint}/externalDataStores/'.format(endpoint=unittest_endpoint),
        status=200,
...
def test_data_stores_api_external_data_stores_credentials_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/externalDataStores/{dataStoreId}/credentials/'.format(endpoint=unittest_endpoint,
        dataStoreId="dataStoreId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_data_stores_api_external_data_stores_delete(unittest_endpoint):
    responses.add(
        responses.DELETE,
        '{endpoint}/externalDataStores/{dataStoreId}/'.format(endpoint=unittest_endpoint,
        dataStoreId="dataStoreId_example", ),
        status=204,
        content_type='',
    )
...
def test_data_stores_api_external_data_stores_permissions_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/externalDataStores/{dataStoreId}/permissions/'.format(endpoint=unittest_endpoint,
        dataStoreId="dataStoreId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_data_stores_api_external_data_stores_schemas_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/externalDataStores/{dataStoreId}/schemas/'.format(endpoint=unittest_endpoint,
        dataStoreId="dataStoreId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_data_stores_api_external_data_stores_shared_roles_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/externalDataStores/{dataStoreId}/sharedRoles/'.format(endpoint=unittest_endpoint,
...
def test_data_stores_api_external_data_stores_tables_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/externalDataStores/{dataStoreId}/tables/'.format(endpoint=unittest_endpoint,
        dataStoreId="dataStoreId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_data_stores_api_external_data_stores_test_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/externalDataStores/{dataStoreId}/test/'.format(endpoint=unittest_endpoint,
        dataStoreId="dataStoreId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_data_stores_api_external_data_stores_verify_sql_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/externalDataStores/{dataStoreId}/verifySQL/'.format(endpoint=unittest_endpoint,
        dataStoreId="dataStoreId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
