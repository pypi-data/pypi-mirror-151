...
from datarobot.models.testing_list.generated.model.basic_dataset_details_response import BasicDatasetDetailsResponse
from datarobot.models.testing_list.generated.model.bulk_dataset_action import BulkDatasetAction
from datarobot.models.testing_list.generated.model.create_workspace_state import CreateWorkspaceState
from datarobot.models.testing_list.generated.model.created_dataset_data_engine_response import CreatedDatasetDataEngineResponse
from datarobot.models.testing_list.generated.model.created_dataset_response import CreatedDatasetResponse
from datarobot.models.testing_list.generated.model.dataset_access_control_list_response import DatasetAccessControlListResponse
from datarobot.models.testing_list.generated.model.dataset_access_set import DatasetAccessSet
from datarobot.models.testing_list.generated.model.dataset_create_from_workspace_state import DatasetCreateFromWorkspaceState
from datarobot.models.testing_list.generated.model.dataset_describe_permissions_response import DatasetDescribePermissionsResponse
from datarobot.models.testing_list.generated.model.dataset_feature_histogram_response import DatasetFeatureHistogramResponse
from datarobot.models.testing_list.generated.model.dataset_featurelist_list_response import DatasetFeaturelistListResponse
from datarobot.models.testing_list.generated.model.dataset_featurelist_response import DatasetFeaturelistResponse
from datarobot.models.testing_list.generated.model.dataset_features_list_response import DatasetFeaturesListResponse
from datarobot.models.testing_list.generated.model.dataset_from_file import DatasetFromFile
from datarobot.models.testing_list.generated.model.dataset_list_response import DatasetListResponse
from datarobot.models.testing_list.generated.model.dataset_project_list_response import DatasetProjectListResponse
from datarobot.models.testing_list.generated.model.dataset_refresh_job_create import DatasetRefreshJobCreate
from datarobot.models.testing_list.generated.model.dataset_refresh_job_response import DatasetRefreshJobResponse
from datarobot.models.testing_list.generated.model.dataset_refresh_job_retrieve_execution_results_response import DatasetRefreshJobRetrieveExecutionResultsResponse
from datarobot.models.testing_list.generated.model.dataset_refresh_job_update import DatasetRefreshJobUpdate
from datarobot.models.testing_list.generated.model.dataset_refresh_jobs_list_response import DatasetRefreshJobsListResponse
from datarobot.models.testing_list.generated.model.dataset_relationship_create import DatasetRelationshipCreate
from datarobot.models.testing_list.generated.model.dataset_relationship_list_response import DatasetRelationshipListResponse
from datarobot.models.testing_list.generated.model.dataset_relationship_response import DatasetRelationshipResponse
from datarobot.models.testing_list.generated.model.dataset_relationship_update import DatasetRelationshipUpdate
from datarobot.models.testing_list.generated.model.dataset_shared_roles import DatasetSharedRoles
from datarobot.models.testing_list.generated.model.dataset_transform_list_response import DatasetTransformListResponse
from datarobot.models.testing_list.generated.model.dataset_transform_response import DatasetTransformResponse
from datarobot.models.testing_list.generated.model.datasource import Datasource
from datarobot.models.testing_list.generated.model.feature_list_create import FeatureListCreate
from datarobot.models.testing_list.generated.model.feature_list_modify import FeatureListModify
from datarobot.models.testing_list.generated.model.feature_transform import FeatureTransform
from datarobot.models.testing_list.generated.model.from_latest import FromLatest
from datarobot.models.testing_list.generated.model.from_specific import FromSpecific
from datarobot.models.testing_list.generated.model.full_dataset_details_response import FullDatasetDetailsResponse
from datarobot.models.testing_list.generated.model.get_dataset_version_projects_response import GetDatasetVersionProjectsResponse
from datarobot.models.testing_list.generated.model.hdfs import Hdfs
from datarobot.models.testing_list.generated.model.patch_dataset import PatchDataset
from datarobot.models.testing_list.generated.model.shared_roles_list_response import SharedRolesListResponse
from datarobot.models.testing_list.generated.model.url import Url
from datarobot.models.testing_list.generated.model.workspace_source_created_response import WorkspaceSourceCreatedResponse
from datarobot.models.testing_list.generated.model.workspace_state_response import WorkspaceStateResponse
from datarobot.utils import from_api
from datarobot.models.testing_list.generated.model import *

from datarobot.models.testing_list.generated.api.datasets_api import DatasetsApi
...
def test_datasets_api_data_engine_workspace_states_create(unittest_endpoint):
    responses.add(
        responses.POST,
       '{endpoint}/dataEngineWorkspaceStates/'.format(endpoint=unittest_endpoint),
        status=200,
...
def test_datasets_api_data_engine_workspace_states_retrieve(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/dataEngineWorkspaceStates/{workspaceStateId}/'.format(endpoint=unittest_endpoint,
...
def test_datasets_api_datasets_access_control_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/datasets/{datasetId}/accessControl/'.format(endpoint=unittest_endpoint,
...
def test_datasets_api_datasets_all_features_details_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/datasets/{datasetId}/allFeaturesDetails/'.format(endpoint=unittest_endpoint,
...
def test_datasets_api_datasets_delete(unittest_endpoint):
    responses.add(
        responses.DELETE,
        '{endpoint}/datasets/{datasetId}/'.format(endpoint=unittest_endpoint,
        datasetId="datasetId_example", ),
        status=204,
        content_type='',
    )
...
def test_datasets_api_datasets_deleted_patch_many(unittest_endpoint):
    responses.add(
        responses.PATCH,
        '{endpoint}/datasets/{datasetId}/deleted/'.format(endpoint=unittest_endpoint,
        datasetId="datasetId_example", ),
        status=200,
        content_type='',
    )
...
def test_datasets_api_datasets_feature_histograms_retrieve(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/datasets/{datasetId}/featureHistograms/{featureName}/'.format(endpoint=unittest_endpoint,
...
def test_datasets_api_datasets_feature_transforms_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/datasets/{datasetId}/featureTransforms/'.format(endpoint=unittest_endpoint,
        datasetId="datasetId_example", ),
        status=202,
        content_type='',
    )
...
def test_datasets_api_datasets_feature_transforms_retrieve(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/datasets/{datasetId}/featureTransforms/{featureName}/'.format(endpoint=unittest_endpoint,
...
def test_datasets_api_datasets_featurelists_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/datasets/{datasetId}/featurelists/'.format(endpoint=unittest_endpoint,
        datasetId="datasetId_example", ),
        status=201,
        content_type='application/json',
        body=json.dumps({
...
def test_datasets_api_datasets_featurelists_delete(unittest_endpoint):
    responses.add(
        responses.DELETE,
        '{endpoint}/datasets/{datasetId}/featurelists/{featurelistId}/'.format(endpoint=unittest_endpoint,
...
def test_datasets_api_datasets_file_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/datasets/{datasetId}/file/'.format(endpoint=unittest_endpoint,
        datasetId="datasetId_example", ),
        status=200,
...
def test_datasets_api_datasets_from_data_engine_workspace_state_create(unittest_endpoint):
    responses.add(
        responses.POST,
       '{endpoint}/datasets/fromDataEngineWorkspaceState/'.format(endpoint=unittest_endpoint),
        status=202,
        content_type='application/json',
        body=json.dumps({
  "statusId" : "statusId",
...
def test_datasets_api_datasets_from_data_source_create(unittest_endpoint):
    responses.add(
        responses.POST,
       '{endpoint}/datasets/fromDataSource/'.format(endpoint=unittest_endpoint),
        status=202,
        content_type='application/json',
        body=json.dumps({
  "catalogId" : "catalogId",
...
def test_datasets_api_datasets_from_file_create(unittest_endpoint, temporary_file):
    responses.add(
        responses.POST,
        '{endpoint}/datasets/fromFile/'.format(endpoint=unittest_endpoint,
...
def test_datasets_api_datasets_from_hdfs_create(unittest_endpoint):
    responses.add(
        responses.POST,
       '{endpoint}/datasets/fromHDFS/'.format(endpoint=unittest_endpoint),
        status=202,
        content_type='application/json',
        body=json.dumps({
  "catalogId" : "catalogId",
...
def test_datasets_api_datasets_from_url_create(unittest_endpoint):
    responses.add(
        responses.POST,
       '{endpoint}/datasets/fromURL/'.format(endpoint=unittest_endpoint),
        status=202,
        content_type='application/json',
        body=json.dumps({
  "catalogId" : "catalogId",
...
def test_datasets_api_datasets_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/datasets/'.format(endpoint=unittest_endpoint,
        limit=100, offset=0, ),
        status=200,
        content_type='application/json',
        body=json.dumps({
  ...
  "data" : [ {
    ...
    "name" : "name",
    "datasetId" : "datasetId",
    "categories" : [ "PREDICTION", "PREDICTION" ],
    "rowCount" : 1,
    "isSnapshot" : True,
...
def test_datasets_api_datasets_permissions_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/datasets/{datasetId}/permissions/'.format(endpoint=unittest_endpoint,
        datasetId="datasetId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_datasets_api_datasets_projects_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/datasets/{datasetId}/projects/'.format(endpoint=unittest_endpoint,
        limit=100, offset=0, datasetId="datasetId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_datasets_api_datasets_refresh_jobs_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/datasets/{datasetId}/refreshJobs/'.format(endpoint=unittest_endpoint,
        datasetId="datasetId_example", ),
        status=201,
        content_type='application/json',
        body=json.dumps({
...
def test_datasets_api_datasets_refresh_jobs_delete(unittest_endpoint):
    responses.add(
        responses.DELETE,
        '{endpoint}/datasets/{datasetId}/refreshJobs/{jobId}/'.format(endpoint=unittest_endpoint,
...
def test_datasets_api_datasets_refresh_jobs_execution_results_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/datasets/{datasetId}/refreshJobs/{jobId}/executionResults/'.format(endpoint=unittest_endpoint,
        datasetId="datasetId_example", jobId="jobId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_datasets_api_datasets_relationships_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/datasets/{datasetId}/relationships/'.format(endpoint=unittest_endpoint,
        datasetId="datasetId_example", ),
        status=201,
        content_type='application/json',
        body=json.dumps({
...
def test_datasets_api_datasets_relationships_delete(unittest_endpoint):
    responses.add(
        responses.DELETE,
        '{endpoint}/datasets/{datasetId}/relationships/{datasetRelationshipId}/'.format(endpoint=unittest_endpoint,
...
def test_datasets_api_datasets_shared_roles_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/datasets/{datasetId}/sharedRoles/'.format(endpoint=unittest_endpoint,
        offset=0, limit=100, datasetId="datasetId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_datasets_api_datasets_versions_all_features_details_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/datasets/{datasetId}/versions/{datasetVersionId}/allFeaturesDetails/'.format(endpoint=unittest_endpoint,
...
def test_datasets_api_datasets_versions_delete(unittest_endpoint):
    responses.add(
        responses.DELETE,
        '{endpoint}/datasets/{datasetId}/versions/{datasetVersionId}/'.format(endpoint=unittest_endpoint,
...
def test_datasets_api_datasets_versions_deleted_patch_many(unittest_endpoint):
    responses.add(
        responses.PATCH,
        '{endpoint}/datasets/{datasetId}/versions/{datasetVersionId}/deleted/'.format(endpoint=unittest_endpoint,
        datasetId="datasetId_example", datasetVersionId="datasetVersionId_example", ),
        status=200,
        content_type='',
    )
...
def test_datasets_api_datasets_versions_feature_histograms_retrieve(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/datasets/{datasetId}/versions/{datasetVersionId}/featureHistograms/{featureName}/'.format(endpoint=unittest_endpoint,
...
def test_datasets_api_datasets_versions_featurelists_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/datasets/{datasetId}/versions/{datasetVersionId}/featurelists/'.format(endpoint=unittest_endpoint,
        limit=100, offset=0, orderBy="name", datasetId="datasetId_example", datasetVersionId="datasetVersionId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_datasets_api_datasets_versions_featurelists_retrieve(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/datasets/{datasetId}/versions/{datasetVersionId}/featurelists/{featurelistId}/'.format(endpoint=unittest_endpoint,
...
def test_datasets_api_datasets_versions_file_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/datasets/{datasetId}/versions/{datasetVersionId}/file/'.format(endpoint=unittest_endpoint,
        datasetId="datasetId_example", datasetVersionId="datasetVersionId_example", ),
        status=200,
        content_type='text/csv',
        body=json.dumps("datasetId_example")
...
def test_datasets_api_datasets_versions_from_data_engine_workspace_state_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/datasets/{datasetId}/versions/fromDataEngineWorkspaceState/'.format(endpoint=unittest_endpoint,
        datasetId="datasetId_example", ),
        status=202,
        content_type='application/json',
        body=json.dumps({
...
def test_datasets_api_datasets_versions_from_data_source_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/datasets/{datasetId}/versions/fromDataSource/'.format(endpoint=unittest_endpoint,
        datasetId="datasetId_example", ),
        status=202,
        content_type='application/json',
        body=json.dumps({
...
def test_datasets_api_datasets_versions_from_file_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/datasets/{datasetId}/versions/fromFile/'.format(endpoint=unittest_endpoint,
        datasetId="datasetId_example", ),
        status=202,
        content_type='application/json',
        body=json.dumps({
...
def test_datasets_api_datasets_versions_from_hdfs_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/datasets/{datasetId}/versions/fromHDFS/'.format(endpoint=unittest_endpoint,
        datasetId="datasetId_example", ),
        status=202,
        content_type='application/json',
        body=json.dumps({
...
def test_datasets_api_datasets_versions_from_latest_version_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/datasets/{datasetId}/versions/fromLatestVersion/'.format(endpoint=unittest_endpoint,
        datasetId="datasetId_example", ),
        status=202,
        content_type='application/json',
        body=json.dumps({
...
def test_datasets_api_datasets_versions_from_url_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/datasets/{datasetId}/versions/fromURL/'.format(endpoint=unittest_endpoint,
        datasetId="datasetId_example", ),
        status=202,
        content_type='application/json',
        body=json.dumps({
...
def test_datasets_api_datasets_versions_from_version_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/datasets/{datasetId}/versions/{datasetVersionId}/fromVersion/'.format(endpoint=unittest_endpoint,
        datasetId="datasetId_example", datasetVersionId="datasetVersionId_example", ),
        status=202,
        content_type='application/json',
        body=json.dumps({
...
def test_datasets_api_datasets_versions_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/datasets/{datasetId}/versions/'.format(endpoint=unittest_endpoint,
        limit=100, offset=0, datasetId="datasetId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_datasets_api_datasets_versions_projects_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/datasets/{datasetId}/versions/{datasetVersionId}/projects/'.format(endpoint=unittest_endpoint,
