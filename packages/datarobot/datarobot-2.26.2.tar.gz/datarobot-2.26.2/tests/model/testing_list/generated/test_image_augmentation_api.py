...
from datarobot.models.testing_list.generated.model.image_augmentation_create_list import ImageAugmentationCreateList
from datarobot.models.testing_list.generated.model.image_augmentation_list_create_response import ImageAugmentationListCreateResponse
from datarobot.models.testing_list.generated.model.image_augmentation_list_patch_param import ImageAugmentationListPatchParam
from datarobot.models.testing_list.generated.model.image_augmentation_lists_response import ImageAugmentationListsResponse
from datarobot.models.testing_list.generated.model.image_augmentation_options_response import ImageAugmentationOptionsResponse
from datarobot.models.testing_list.generated.model.image_augmentation_retrieve_list import ImageAugmentationRetrieveList
from datarobot.models.testing_list.generated.model.image_augmentation_retrieve_samples_response import ImageAugmentationRetrieveSamplesResponse
from datarobot.models.testing_list.generated.model.image_augmentation_samples_request import ImageAugmentationSamplesRequest
from datarobot.models.testing_list.generated.model.image_augmentation_samples_response import ImageAugmentationSamplesResponse
from datarobot.utils import from_api
from datarobot.models.testing_list.generated.model import *

from datarobot.models.testing_list.generated.api.image_augmentation_api import ImageAugmentationApi
...
def test_image_augmentation_api_image_augmentation_lists_create(unittest_endpoint):
    responses.add(
        responses.POST,
       '{endpoint}/imageAugmentationLists/'.format(endpoint=unittest_endpoint),
        status=201,
...
def test_image_augmentation_api_image_augmentation_lists_delete(unittest_endpoint):
    responses.add(
        responses.DELETE,
        '{endpoint}/imageAugmentationLists/{augmentationId}/'.format(endpoint=unittest_endpoint,
...
def test_image_augmentation_api_image_augmentation_options_retrieve(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/imageAugmentationOptions/{projectId}/'.format(endpoint=unittest_endpoint,
...
def test_image_augmentation_api_image_augmentation_samples_create(unittest_endpoint):
    responses.add(
        responses.POST,
       '{endpoint}/imageAugmentationSamples/'.format(endpoint=unittest_endpoint),
        status=202,
        content_type='application/json',
        body=json.dumps({
  "statusId" : "statusId"
...
def test_image_augmentation_api_image_augmentation_samples_retrieve(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/imageAugmentationSamples/{samplesId}/'.format(endpoint=unittest_endpoint,
