...
from datarobot.models.testing_list.generated.model.activation_maps_compute_response import ActivationMapsComputeResponse
from datarobot.models.testing_list.generated.model.activation_maps_list_response import ActivationMapsListResponse
from datarobot.models.testing_list.generated.model.activation_maps_retrieve_response import ActivationMapsRetrieveResponse
from datarobot.models.testing_list.generated.model.embeddings_list_response import EmbeddingsListResponse
from datarobot.models.testing_list.generated.model.embeddings_retrieve_response import EmbeddingsRetrieveResponse
from datarobot.models.testing_list.generated.model.image_embeddings_compute_response import ImageEmbeddingsComputeResponse
from datarobot.utils import from_api
from datarobot.models.testing_list.generated.model import *

from datarobot.models.testing_list.generated.api.image_insights_api import ImageInsightsApi
...
def test_image_insights_api_projects_image_activation_maps_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/imageActivationMaps/'.format(endpoint=unittest_endpoint,
...
def test_image_insights_api_projects_image_embeddings_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/imageEmbeddings/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_image_insights_api_projects_models_image_activation_maps_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/projects/{projectId}/models/{modelId}/imageActivationMaps/'.format(endpoint=unittest_endpoint,
...
def test_image_insights_api_projects_models_image_embeddings_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/projects/{projectId}/models/{modelId}/imageEmbeddings/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", modelId="modelId_example", ),
        status=202,
        content_type='application/json',
        body=json.dumps({
