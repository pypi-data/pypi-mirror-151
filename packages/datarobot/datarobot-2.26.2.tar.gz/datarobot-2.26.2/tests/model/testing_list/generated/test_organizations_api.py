...
from datarobot.models.testing_list.generated.model.organization_job_list_response import OrganizationJobListResponse
from datarobot.models.testing_list.generated.model.organization_list_response import OrganizationListResponse
from datarobot.models.testing_list.generated.model.organization_retrieve import OrganizationRetrieve
from datarobot.utils import from_api
from datarobot.models.testing_list.generated.model import *

from datarobot.models.testing_list.generated.api.organizations_api import OrganizationsApi
...
def test_organizations_api_organizations_jobs_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/organizations/{organizationId}/jobs/'.format(endpoint=unittest_endpoint,
...
def test_organizations_api_organizations_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/organizations/'.format(endpoint=unittest_endpoint,
        limit=100, ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_organizations_api_organizations_retrieve(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/organizations/{organizationId}/'.format(endpoint=unittest_endpoint,
