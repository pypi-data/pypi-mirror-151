...
from datarobot.models.testing_list.generated.model.duplicate_image_table_response import DuplicateImageTableResponse
from datarobot.models.testing_list.generated.model.image_bins_list_response import ImageBinsListResponse
from datarobot.models.testing_list.generated.model.image_metadata_list_response import ImageMetadataListResponse
from datarobot.models.testing_list.generated.model.image_metadata_response import ImageMetadataResponse
from datarobot.models.testing_list.generated.model.images_data_quality_log_lines_response import ImagesDataQualityLogLinesResponse
from datarobot.utils import from_api
from datarobot.models.testing_list.generated.model import *

from datarobot.models.testing_list.generated.api.images_api import ImagesApi
...
def test_images_api_datasets_images_data_quality_log_file_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/datasets/{datasetId}/imagesDataQualityLog/file/'.format(endpoint=unittest_endpoint,
...
def test_images_api_datasets_images_data_quality_log_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/datasets/{datasetId}/imagesDataQualityLog/'.format(endpoint=unittest_endpoint,
        datasetId="datasetId_example", ),
        status=200,
...
def test_images_api_projects_duplicate_images_retrieve(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/duplicateImages/{column}/'.format(endpoint=unittest_endpoint,
...
def test_images_api_projects_image_bins_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/imageBins/'.format(endpoint=unittest_endpoint,
...
def test_images_api_projects_image_samples_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/imageSamples/'.format(endpoint=unittest_endpoint,
        featureName="featureName_example", projectId="projectId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_images_api_projects_images_data_quality_log_file_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/imagesDataQualityLog/file/'.format(endpoint=unittest_endpoint,
...
def test_images_api_projects_images_data_quality_log_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/imagesDataQualityLog/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_images_api_projects_images_file_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/images/{imageId}/file/'.format(endpoint=unittest_endpoint,
...
def test_images_api_projects_images_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/images/'.format(endpoint=unittest_endpoint,
...
def test_images_api_projects_images_retrieve(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/projects/{projectId}/images/{imageId}/'.format(endpoint=unittest_endpoint,
        projectId="projectId_example", imageId="imageId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
