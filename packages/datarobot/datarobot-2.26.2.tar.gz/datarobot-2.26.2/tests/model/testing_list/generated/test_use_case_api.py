...
from datarobot.models.testing_list.generated.model.create_use_case_attachment import CreateUseCaseAttachment
from datarobot.models.testing_list.generated.model.use_case import UseCase
from datarobot.models.testing_list.generated.model.use_case_activity_list_response import UseCaseActivityListResponse
from datarobot.models.testing_list.generated.model.use_case_attachment import UseCaseAttachment
from datarobot.models.testing_list.generated.model.use_case_attachment_list_response import UseCaseAttachmentListResponse
from datarobot.models.testing_list.generated.model.use_case_attachment_response import UseCaseAttachmentResponse
from datarobot.models.testing_list.generated.model.use_case_create_response import UseCaseCreateResponse
from datarobot.models.testing_list.generated.model.use_case_list_response import UseCaseListResponse
from datarobot.models.testing_list.generated.model.use_case_realized_values_over_time_response import UseCaseRealizedValuesOverTimeResponse
from datarobot.models.testing_list.generated.model.use_case_response import UseCaseResponse
from datarobot.models.testing_list.generated.model.use_case_sharing_list_response import UseCaseSharingListResponse
from datarobot.models.testing_list.generated.model.use_case_sharing_update import UseCaseSharingUpdate
from datarobot.models.testing_list.generated.model.use_case_update import UseCaseUpdate
from datarobot.models.testing_list.generated.model.use_case_value_template_calculate_response import UseCaseValueTemplateCalculateResponse
from datarobot.models.testing_list.generated.model.use_case_value_template_response import UseCaseValueTemplateResponse
from datarobot.utils import from_api
from datarobot.models.testing_list.generated.model import *

from datarobot.models.testing_list.generated.api.use_case_api import UseCaseApi
...
def test_use_case_api_use_case_value_templates_calculation_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/useCaseValueTemplates/{templateType}/calculation/'.format(endpoint=unittest_endpoint,
...
def test_use_case_api_use_case_value_templates_list(unittest_endpoint):
    responses.add(
        responses.GET,
       '{endpoint}/useCaseValueTemplates/'.format(endpoint=unittest_endpoint),
        status=200,
        content_type='application/json',
        body=json.dumps([{
  "schema" : [ {
  ...
  "title" : "title"
    ...
    assert all(isinstance(item, UseCaseValueTemplateResponse) for item in result)
...
def test_use_case_api_use_case_value_templates_retrieve(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/useCaseValueTemplates/{templateType}/'.format(endpoint=unittest_endpoint,
        templateType="classification", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_use_case_api_use_cases_activities_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/useCases/{useCaseId}/activities/'.format(endpoint=unittest_endpoint,
...
def test_use_case_api_use_cases_attachments_create(unittest_endpoint):
    responses.add(
        responses.POST,
        '{endpoint}/useCases/{useCaseId}/attachments/'.format(endpoint=unittest_endpoint,
        useCaseId="useCaseId_example", ),
        status=201,
        content_type='application/json',
        body=json.dumps([{
  ...
  "type" : "dataset"
    ...
    assert all(isinstance(item, UseCaseAttachment) for item in result)
...
def test_use_case_api_use_cases_attachments_delete(unittest_endpoint):
    responses.add(
        responses.DELETE,
        '{endpoint}/useCases/{useCaseId}/attachments/{attachmentId}/'.format(endpoint=unittest_endpoint,
...
def test_use_case_api_use_cases_create(unittest_endpoint):
    responses.add(
        responses.POST,
       '{endpoint}/useCases/'.format(endpoint=unittest_endpoint),
        status=200,
        content_type='application/json',
        body=json.dumps({
  "modelHealth" : "",
...
def test_use_case_api_use_cases_delete(unittest_endpoint):
    responses.add(
        responses.DELETE,
        '{endpoint}/useCases/{useCaseId}/'.format(endpoint=unittest_endpoint,
        useCaseId="useCaseId_example", ),
        status=200,
        content_type='',
    )
...
def test_use_case_api_use_cases_realized_value_over_time_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/useCases/{useCaseId}/realizedValueOverTime/'.format(endpoint=unittest_endpoint,
        useCaseId="useCaseId_example", ),
        status=200,
        content_type='application/json',
        body=json.dumps({
...
def test_use_case_api_use_cases_shared_roles_list(unittest_endpoint):
    responses.add(
        responses.GET,
        '{endpoint}/useCases/{useCaseId}/sharedRoles/'.format(endpoint=unittest_endpoint,
