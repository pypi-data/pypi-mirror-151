...
from datarobot.models.full_api.generated.model.fairness_insight import FairnessInsight

class FairnessInsightsListResponse(APIObject):
    """
    Attributes
    ----------
    data:[FairnessInsight]
