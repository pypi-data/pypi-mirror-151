...
class ConfusionChartForDatasetsListResponse(APIObject):
    """
    Attributes
    ----------
    count:int
         Number of results returned on this page.
    data:[ModelConfusionChartRetrieveResponse]
         Confusion chart data with the in the same format as the response from :http:get:`/api/v2/projects/(projectId)/models/(modelId)/confusionCharts/(source)/` with additional totalCount field.
    next:str, none_type
