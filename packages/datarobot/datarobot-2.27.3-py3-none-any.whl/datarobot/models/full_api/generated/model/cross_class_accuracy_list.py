...
from datarobot.models.full_api.generated.model.cross_class_accuracy import CrossClassAccuracy

class CrossClassAccuracyList(APIObject):
    """
    Attributes
    ----------
    data:[CrossClassAccuracy]
