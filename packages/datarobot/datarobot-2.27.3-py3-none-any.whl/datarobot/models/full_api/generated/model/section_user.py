...
class SectionUser(APIObject):
    ...
    title:str
         Section Title
    type:str
         Section with user-defined content. Those sections may contain text generated by the user.. defaults to "user", must be one of ["user", ]
