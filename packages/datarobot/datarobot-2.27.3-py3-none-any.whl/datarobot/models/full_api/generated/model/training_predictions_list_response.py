...
from datarobot.models.full_api.generated.model.traning_predictions import TraningPredictions

class TrainingPredictionsListResponse(APIObject):
    """
    Attributes
    ----------
    data:[TraningPredictions]
