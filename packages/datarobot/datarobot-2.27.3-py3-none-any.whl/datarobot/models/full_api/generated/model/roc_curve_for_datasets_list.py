...
from datarobot.models.full_api.generated.model.roc_curve_for_datasets import RocCurveForDatasets

class RocCurveForDatasetsList(APIObject):
    """
    Attributes
    ----------
    data:[RocCurveForDatasets]
