...
from datarobot.models.full_api.generated.model.secondary_datasets_config import SecondaryDatasetsConfig

class SecondaryDatasetsConfigListResponse(APIObject):
    """
    Attributes
    ----------
    count:int
         Number of items
    data:[SecondaryDatasetsConfig]
