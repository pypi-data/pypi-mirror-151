...
from datarobot.models.full_api.generated.model.basic_dataset_with_size_response import BasicDatasetWithSizeResponse

class DatasetListResponse(APIObject):
    """
    Attributes
    ----------
    data:[BasicDatasetWithSizeResponse]
