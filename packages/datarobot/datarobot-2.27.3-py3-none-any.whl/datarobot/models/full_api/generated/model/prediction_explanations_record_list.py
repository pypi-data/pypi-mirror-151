...
class PredictionExplanationsRecordList(APIObject):
    """
    Attributes
    ----------
    count:int
         The number of items returned on this page.
    data:[PredictionExplanationsRecord]
         Each has the same schema as if retrieving the prediction explanations individually from :http:get:`/api/v2/projects/(projectId)/predictionExplanationsRecords/(predictionExplanationsId)/`.
    next:str, none_type
