...
from datarobot.models.full_api.generated.model.dataset_project_response import DatasetProjectResponse

class DatasetProjectListResponse(APIObject):
    """
    Attributes
    ----------
    data:[DatasetProjectResponse]
