...
from datarobot.models.full_api.generated.model.image_insights_metadata_element import ImageInsightsMetadataElement

class ActivationMapsListResponse(APIObject):
    """
    Attributes
    ----------
    data:[ImageInsightsMetadataElement]
