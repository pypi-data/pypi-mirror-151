...
class ApplicationTypeListResponse(APIObject):
    """
    Attributes
    ----------
    count:int
         Number of items
    data:[ApplicationTypeRetrieveResponse]
         each has the same schema as when application types retrieved individually from :http:get:`/api/v2/applicationTypes/(applicationTypeId)/`.
    next:str, none_type
