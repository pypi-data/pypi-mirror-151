...
def get_consensus(infiles):
    ...
    prefix=chr
    postfix=.vcf
    values = {1,2,3} -> is a set and unsorted
    '''
...
# def Annotate_with_ref_genome(vcffile):
#     command = f'bcftools view {vcffile} | vcftools --vcf - --positions {outgroupfile} --recode --stdout'
#     print(command)
