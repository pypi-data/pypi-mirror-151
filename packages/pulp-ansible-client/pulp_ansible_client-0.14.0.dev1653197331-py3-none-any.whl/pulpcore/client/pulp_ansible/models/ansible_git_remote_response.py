...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, sock_read_timeout=None, pulp_href=None, max_retries=None, proxy_url=None, total_timeout=None, headers=None, ca_cert=None, url=None, rate_limit=None, tls_validation=None, pulp_last_updated=None, client_cert=None, pulp_created=None, name=None, connect_timeout=None, pulp_labels=None, sock_connect_timeout=None, download_concurrency=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
