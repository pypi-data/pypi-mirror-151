...
class CodeBuildStepProps(ShellStepProps):
    def __init__(
        ...
        *,
        ...
        install_commands: typing.Optional[typing.Sequence[builtins.str]] = None,
        primary_output_directory: typing.Optional[builtins.str] = None,
        action_role: typing.Optional[aws_cdk.aws_iam.IRole] = None,
        build_environment: typing.Optional[aws_cdk.aws_codebuild.BuildEnvironment] = None,
        partial_build_spec: typing.Optional[aws_cdk.aws_codebuild.BuildSpec] = None,
        project_name: typing.Optional[builtins.str] = None,
        role: typing.Optional[aws_cdk.aws_iam.IRole] = None,
    ...
    @builtins.property
    def action_role(self) -> typing.Optional[aws_cdk.aws_iam.IRole]:
...
class _CodePipelineSourceProxy(
    ...
    def _get_action(
        ...
        :param variables_namespace: -
        '''
        return typing.cast(aws_cdk.aws_codepipeline_actions.Action, jsii.invoke(self, "getAction", [output, action_name, run_order, variables_namespace]))
...
class CodeBuildStep(
    ...
    def action_role(self) -> typing.Optional[aws_cdk.aws_iam.IRole]:
        ...
        :default: - A role is automatically created
        '''
        return typing.cast(typing.Optional[aws_cdk.aws_iam.IRole], jsii.get(self, "actionRole"))
