...
class ServerMeta(type):
    ...
    def __init__(self, clsname, bases, clsdict):
        ...
        # attr_dict - словарь атрибутов и методов экземпляра метакласса
        ...
        for func in clsdict:
            ...
            try:
                ...
                # Если функция, разбираем код, получая используемые методы и
                # атрибуты:
                for i in ret:
                    print(i)
                    # i - Instruction(opname='LOAD_GLOBAL', opcode=116, arg=9,
                    # argval='send_message', argrepr='send_message',
