...
from client.client_dir.main_window_conv import Ui_MainClientWindow
from client.client_dir.add_contact import AddContactDialog
from client.client_dir.del_contact import DelContactDialog
...
class ClientMainWindow(QMainWindow):
    ...
    def __init__(self, database, transport, keys):
        ...
        # объект - дешифровщик сообщений с предзагруженным ключом
    ...
    def history_list_update(self):
        ...
        # Отображает только последние 20 сообщений
