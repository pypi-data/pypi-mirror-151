...
class FundNavAnalysor:
    ...
    def run(self):
        ...
        self.plotly_line(df, "产品净值曲线", "D:\\量化产品跟踪\\深度报告相关\\净值曲线.html", figsize=(1200, 500))
...
if __name__ == '__main__':
    ...
    # nv_series = get_fund_nav_from_sql('20220114', '20220325', {"伯兄永康": "STQ128"})

    FundNavAnalysor('20210507', '20220408', '000905', nv_series).run()
