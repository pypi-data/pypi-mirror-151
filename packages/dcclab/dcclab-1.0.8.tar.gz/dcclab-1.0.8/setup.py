...
setuptools.setup(
    ...
    install_requires=['keyring', 'sshtunnel', 'mysql-connector-python', 'requests', 'matplotlib','numpy','scikit-image','scipy','czifile >= 2019.6.18','tifffile','read-lif','opencv-python','xlrd','seaborn','imagecodecs','deprecated'],
    python_requires='>=3',
    package_data={
