...
from code_size_analyzer_client import rest
from code_size_analyzer_client.configuration import Configuration
from code_size_analyzer_client.exceptions import ApiTypeError, ApiValueError, ApiException
from code_size_analyzer_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AnalyzerApi()
        api_instance.analyze_map_file  # this is an instance of the class Endpoint
        api_instance.analyze_map_file()  # this invokes api_instance.analyze_map_file.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.analyze_map_file.callable or self.callable in this class
