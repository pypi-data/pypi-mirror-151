...
# Defining the host is optional and defaults to https://code-size-analyzer.dev.silabs.net
# See configuration.py for a list of all supported configuration parameters.
configuration = code_size_analyzer_client.Configuration(
    host = "https://code-size-analyzer.dev.silabs.net"
)
...
All URIs are relative to *https://code-size-analyzer.dev.silabs.net*
