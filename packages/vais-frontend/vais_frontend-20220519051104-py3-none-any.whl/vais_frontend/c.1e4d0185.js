import{k as t,a as e,f as i,$ as a,G as o,r,n as s,a6 as n,e as d,t as c,O as l,P as p,m as h,j as m,eb as u,i as g,o as b,A as _,ch as f,aX as v,ec as y,q as x,E as k,aO as w,ed as $,ee as I,h as z,H as O}from"./main-e088bb19.js";import{c as C}from"./c.166c4b5c.js";import"./c.7943fa91.js";import"./c.0bdb0337.js";import"./c.a6191dc5.js";import{d as S}from"./c.efa39a97.js";import{t as j,c as D,M as T,B as H,b as E,i as A,g as P}from"./c.36f258ab.js";import{a as L}from"./c.d8002660.js";import{b as R,e as W}from"./c.fcc8c8a6.js";import"./c.c8c7ce92.js";import"./c.4cc25ce4.js";import"./c.259a5b7b.js";import{a as U}from"./c.7312bad4.js";function M(e){return t({descriptor:t=>({get(){var t,i;return null!==(i=null===(t=this.renderRoot)||void 0===t?void 0:t.querySelectorAll(e))&&void 0!==i?i:[]},enumerable:!0,configurable:!0})})}e([s("ha-header-bar")],(function(t,e){return{F:class extends e{constructor(...e){super(...e),t(this)}},d:[{kind:"method",key:"render",value:function(){return a`<header class="mdc-top-app-bar">
      ...
      <div class="card-actions">
        ${!this._cloudDefaultOptions||this._cloudDefaultOptions[0]===this._cloudOptions[0]&&this._cloudDefaultOptions[1]===this._cloudOptions[1]?a`<span></span>`:a`
    ...
    </ha-card> `}},{kind:"method",key:"_renderCloudOptions",value:function(){if(!this._cloudTTSInfo||!this._cloudOptions)return"";const t=this.getLanguages(this._cloudTTSInfo),e=this._cloudOptions,i=this.getSupportedGenders(e[0],this._cloudTTSInfo,this.hass.localize);return a`
      <div class="cloud-options">
        <ha-select
          ...
          @closed=${U}
        >
          ${t.map((([t,e])=>a`<mwc-list-item .value=${t}>${e}</mwc-list-item>`))}
        </ha-select>
      ...
      `;if(!this._currentItem)return a`<ha-circular-progress active></ha-circular-progress>`;const t=this._currentItem,e=this.hass.localize(`ui.components.media-browser.class.${t.media_class}`),i=t.children||[],o=T[t.media_class],r=t.children_media_class?T[t.children_media_class]:T.directory;return a`
                    ...
                    >
                      <div class="header-content">
                        ${t.thumbnail?a`
                              <div
                                class="img"
                                style=${_({backgroundImage:t.thumbnail?`url(${t.thumbnail})`:"none"})}
                              >
                                ${this._narrow&&null!=t&&t.can_play?a`
                                      <ha-fab
                                        mini
                                        .item=${t}
                        ...
                        <div class="header-info">
                          <div class="breadcrumb">
                            ...
                            ${e?a` <h2 class="subtitle">${e}</h2> `:""}
                          </div>
                          ${!t.can_play||t.thumbnail&&this._narrow?"":a`
                                <mwc-button
                                  raised
                                  .item=${t}
                                  @click=${this._actionClicked}
          ...
          >
            ${this._error?a`
                  ...
                  `:(s=t.media_content_id,s.startsWith("media-source://tts/")?a`
                    <ha-browse-media-tts
                      .item=${t}
                      .hass=${this.hass}
                      .action=${this.action}
                    ...
                    ></ha-browse-media-tts>
                  `:i.length||t.not_shown?"grid"===r.layout?a`
                    <div
                      class="children ${b({portrait:"portrait"===r.thumbnail_ratio})}"
                    >
                      ${i.map((t=>a`
                          <div
                            class="child"
                          ...
                          >
                            <ha-card outlined>
                              <div class="thumbnail">
                                ${t.thumbnail?a`
                                      <div
                                        class="${["app","directory"].includes(t.media_class)?"centered-image":""} image lazythumbnail"
                                ...
                                ${t.can_play?a`
                                      <ha-icon-button
                                        class="play ${b({can_expand:t.can_expand})}"
                                        .item=${t}
                                        .label=${this.hass.localize(`ui.components.media-browser.${this.action}-media`)}
                                        .path=${"play"===this.action?f:v}
                                        @click=${this._actionClicked}
                  ...
                  `:a`
                    <mwc-list>
                      ${i.map((t=>a`
                          ...
                          >
                            <div
                              class=${b({graphic:!0,lazythumbnail:!0===o.show_list_images})}
                              data-src=${x(o.show_list_images&&t.thumbnail?t.thumbnail:void 0)}
                              slot="graphic"
                            >
                              <ha-icon-button
                                class="play ${b({show:!o.show_list_images||!t.thumbnail})}"
                                .item=${t}
                                .label=${this.hass.localize(`ui.components.media-browser.${this.action}-media`)}
                                .path=${"play"===this.action?f:v}
                                @click=${this._actionClicked}
    ...
    `;var s}},{kind:"method",key:"firstUpdated",value:function(){this._measureCard(),this._attachResizeObserver()}},{kind:"method",key:"shouldUpdate",value:function(t){if(t.size>1||!t.has("hass"))return!0;const e=t.get("hass");return void 0===e||e.localize!==this.hass.localize}},{kind:"method",key:"willUpdate",value:function(t){var e;if(l(p(i.prototype),"willUpdate",this).call(this,t),t.has("entityId"))this._setError(void 0);else if(!t.has("navigateIds"))return;this._setError(void 0);const a=t.get("navigateIds"),o=this.navigateIds;null===(e=this._content)||void 0===e||e.scrollTo(0,0),this._scrolled=!1;const r=this._currentItem,s=this._parentItem;this._currentItem=void 0,this._parentItem=void 0;const n=o[o.length-1],d=o.length>1?o[o.length-2]:void 0;let c,h;t.has("entityId")||(a&&o.length===a.length+1&&a.every(((t,e)=>{const i=o[e];return i.media_content_id===t.media_content_id&&i.media_content_type===t.media_content_type}))?h=Promise.resolve(r):a&&o.length===a.length-1&&o.every(((t,e)=>{const i=a[e];return t.media_content_id===i.media_content_id&&t.media_content_type===i.media_content_type}))&&(c=Promise.resolve(s))),c||(c=this._fetchData(this.entityId,n.media_content_id,n.media_content_type)),c.then((t=>{this._currentItem=t,m(this,"media-browsed",{ids:o,current:t})}),(e=>{a&&t.has("entityId")&&o.length===a.length&&a.every(((t,e)=>o[e].media_content_id===t.media_content_id&&o[e].media_content_type===t.media_content_type))?m(this,"media-browsed",{ids:[{media_content_id:void 0,media_content_type:void 0}],replace:!0}):this._setError(e)})),h||void 0===d||(h=this._fetchData(this.entityId,d.media_content_id,d.media_content_type)),h&&h.then((t=>{this._parentItem=t}))}},{kind:"method",key:"updated",value:function(t){l(p(i.prototype),"updated",this).call(this,t),t.has("_scrolled")?this._animateHeaderHeight():t.has("_currentItem")&&(this._setHeaderHeight(),this._attachIntersectionObserver())}},{kind:"method",key:"_actionClicked",value:function(t){t.stopPropagation();const e=t.currentTarget.item;this._runAction(e)}},{kind:"method",key:"_runAction",value:function(t){m(this,"media-picked",{item:t,navigateIds:this.navigateIds})}},{kind:"method",key:"_ttsPicked",value:function(t){t.stopPropagation();const e=this.navigateIds.slice(0,-1);e.push(t.detail.item),m(this,"media-picked",{...t.detail,navigateIds:e})}},{kind:"method",key:"_childClicked",value:async function(t){const e=t.currentTarget.item;e&&(e.can_expand?m(this,"media-browsed",{ids:[...this.navigateIds,e]}):this._runAction(e))}},{kind:"method",key:"_fetchData",value:async function(t,e,i){return t!==H?E(this.hass,t,e,i):F(this.hass,e)}},{kind:"method",key:"_measureCard",value:function(){this._narrow=(this.dialog?window.innerWidth:this.offsetWidth)<450}},{kind:"method",key:"_attachResizeObserver",value:async function(){this._resizeObserver||(await A(),this._resizeObserver=new ResizeObserver(S((()=>this._measureCard()),250,!1))),this._resizeObserver.observe(this)}},{kind:"method",key:"_attachIntersectionObserver",value:async function(){if(!("IntersectionObserver"in window)||!this._thumbnails)return;this._intersectionObserver||(this._intersectionObserver=new IntersectionObserver((async(t,e)=>{await Promise.all(t.map((async t=>{if(!t.isIntersecting)return;const i=t.target;let a=i.dataset.src;if(a){if(a.startsWith("/")){a=(await P(this.hass,a)).path}else if(a.startsWith("https://localhost:8123/brands")){var o;a=R({domain:W(a),type:"icon",useFallback:!0,darkOptimized:null===(o=this.hass.themes)||void 0===o?void 0:o.darkMode})}i.style.backgroundImage=`url(${a})`,e.unobserve(i)}})))})));const t=this._intersectionObserver;for(const e of this._thumbnails)t.observe(e)}},{kind:"method",key:"_closeDialogAction",value:function(){m(this,"close-dialog")}},{kind:"method",key:"_setError",value:function(t){this.dialog?t&&(this._closeDialogAction(),L(this,{title:this.hass.localize("ui.components.media-browser.media_browsing_error"),text:this._renderError(t)})):this._error=t}},{kind:"method",key:"_renderError",value:function(t){return"Media directory does not exist."===t.message?a`
      ...
      `:a`<span class="error">${t.message}</span>`}},{kind:"method",key:"_setHeaderHeight",value:async function(){await this.updateComplete;const t=this._header,e=this._content;t&&e&&(this._headerOffsetHeight=t.offsetHeight,e.style.marginTop=`${this._headerOffsetHeight}px`,e.style.maxHeight=`calc(var(--media-browser-max-height, 100%) - ${this._headerOffsetHeight}px)`)}},{kind:"method",key:"_animateHeaderHeight",value:function(){let t;const e=i=>{void 0===t&&(t=i);const a=i-t;this._setHeaderHeight(),a<400&&requestAnimationFrame(e)};requestAnimationFrame(e)}},{kind:"method",decorators:[k({passive:!0})],key:"_scroll",value:function(t){const e=t.currentTarget;!this._scrolled&&e.scrollTop>this._headerOffsetHeight?this._scrolled=!0:this._scrolled&&e.scrollTop<this._headerOffsetHeight&&(this._scrolled=!1)}},{kind:"get",static:!0,key:"styles",value:function(){return[w,r`
        :host {
          display: flex;
          flex-direction: column;
          position: relative;
      ...
      `]}}]}}),i);e([s("ha-media-manage-button")],(function(t,e){return{F:class extends e{constructor(...e){super(...e),t(this)}},d:[{kind:"field",decorators:[d({attribute:!1})],key:"hass",value:void 0},{kind:"field",decorators:[d()],key:"currentItem",value:void 0},{kind:"field",decorators:[c()],key:"_uploading",value:()=>0},{kind:"method",key:"render",value:function(){return this.currentItem&&N(this.currentItem.media_content_id||"")?a`
      <mwc-button
    ...
    `:a``}},{kind:"method",key:"_manage",value:function(){var t,e;t=this,e={currentItem:this.currentItem,onClose:()=>m(this,"media-refresh")},m(t,"show-dialog",{dialogTag:"dialog-media-manage",dialogImport:()=>import("./c.cb47f570.js"),dialogParams:e})}},{kind:"field",static:!0,key:"styles",value:()=>r`
    mwc-button {
  ...
  `}]}}),i),e([s("dialog-media-player-browse")],(function(t,e){return{F:class extends e{constructor(...e){super(...e),t(this)}},d:[{kind:"field",decorators:[d({attribute:!1})],key:"hass",value:void 0},{kind:"field",decorators:[c()],key:"_currentItem",value:void 0},{kind:"field",decorators:[c()],key:"_navigateIds",value:void 0},{kind:"field",decorators:[c()],key:"_params",value:void 0},{kind:"field",decorators:[g("ha-media-player-browse")],key:"_browser",value:void 0},{kind:"method",key:"showDialog",value:function(t){this._params=t,this._navigateIds=t.navigateIds||[{media_content_id:void 0,media_content_type:void 0}]}},{kind:"method",key:"closeDialog",value:function(){this._params=void 0,this._navigateIds=void 0,this._currentItem=void 0,m(this,"dialog-closed",{dialog:this.localName})}},{kind:"method",key:"render",value:function(){return this._params&&this._navigateIds?a`
    ...
    `:a``}},{kind:"method",key:"_goBack",value:function(){var t;this._navigateIds=null===(t=this._navigateIds)||void 0===t?void 0:t.slice(0,-1),this._currentItem=void 0}},{kind:"method",key:"_mediaBrowsed",value:function(t){this._navigateIds=t.detail.ids,this._currentItem=t.detail.current}},{kind:"method",key:"_mediaPicked",value:function(t){this._params.mediaPickedCallback(t.detail),"play"!==this._action&&this.closeDialog()}},{kind:"get",key:"_action",value:function(){return this._params.action||"play"}},{kind:"method",key:"_refreshMedia",value:function(){this._browser.refresh()}},{kind:"get",static:!0,key:"styles",value:function(){return[O,r`
      ...
      `]}}]}}),i);var Q=Object.freeze({__proto__:null});export{F as b,Q as d,N as i,B as r,V as u};
