...
from pokeapiclient import rest
from pokeapiclient.configuration import Configuration
from pokeapiclient.exceptions import ApiTypeError, ApiValueError, ApiException
from pokeapiclient.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AbilityApi()
        api_instance.ability_list  # this is an instance of the class Endpoint
        api_instance.ability_list()  # this invokes api_instance.ability_list.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.ability_list.callable or self.callable in this class
