...
class TrajectoryFilter(WellsBaseModel):
    ...
    wellbore_ids: Optional[List[Identifier]] = Field(None, alias="wellboreIds", max_items=1000, min_items=1)
    is_definitive: Optional[bool] = Field(None, alias="isDefinitive")
...
class TimeRange(WellsBaseModel):
    ...
    min: Optional[int] = Field(None, description="epoch time stamp in milliseconds when time range started.", example=1)
    max: Optional[int] = Field(None, description="epoch time stamp in milliseconds when time range ended.", example=1)
...
class DoglegSeverityUnit(WellsBaseModel):
    ...
    distance_interval: Optional[float] = Field(30, alias="distanceInterval")
...
class Npt(WellsBaseModel):
    ...
    end_time: Optional[int] = Field(
        None, alias="endTime", description="epoch time stamp in milliseconds for when the NPT event ended.", example=1
    )
...
class NptIngestion(WellsBaseModel):
    ...
    start_time: Optional[int] = Field(
        None, alias="startTime", description="epoch time stamp in milliseconds for when the NPT event started."
    )
    end_time: Optional[int] = Field(
        None, alias="endTime", description="epoch time stamp in milliseconds for when the NPT event ended."
    )
    measured_depth: Optional[Distance] = Field(None, alias="measuredDepth")
    root_cause: Optional[str] = Field(
        None,
...
class Nds(WellsBaseModel):
    ...
    hole_start: Optional[Distance] = Field(None, alias="holeStart", description="Deprecated field, use holeTop")
    hole_end: Optional[Distance] = Field(None, alias="holeEnd", description="Deprecated field, use holeBase")
    hole_top: Optional[Distance] = Field(None, alias="holeTop")
    hole_base: Optional[Distance] = Field(None, alias="holeBase")
    ...
    severity: Optional[int] = Field(None, description="severity of NDS event", example=1)
    probability: Optional[int] = Field(None, description="NDS event probability, between 0-5")
...
class NdsFilter(WellsBaseModel):
    ...
    hole_start: Optional[DistanceRange] = Field(None, alias="holeStart", description="Deprecated field, use holeTop")
    hole_end: Optional[DistanceRange] = Field(None, alias="holeEnd", description="Deprecated field, use holeBase")
    hole_top: Optional[DistanceRange] = Field(None, alias="holeTop")
    hole_base: Optional[DistanceRange] = Field(None, alias="holeBase")
...
class HoleSectionIngestion(WellsBaseModel):
    ...
    name: str
    hole_size: float = Field(..., alias="holeSize")
    bit_size: float = Field(..., alias="bitSize")
    start_time: Optional[int] = Field(
        None,
        alias="startTime",
        description="epoch time stamp in milliseconds for when the Hole Sections was started.",
        example=1,
    )
    end_time: Optional[int] = Field(
        None,
        alias="endTime",
        description="epoch time stamp in milliseconds for when the Hole Sections was compleated.",
        example=1,
    )
    top_measured_depth: float = Field(..., alias="topMeasuredDepth", description="The start of the hole section")
    base_measured_depth: float = Field(..., alias="baseMeasuredDepth", description="End of the hole section")
...
class HoleSection(WellsBaseModel):
    ...
    source: GeneralExternalId
    name: str
    hole_size: Optional[float] = Field(None, alias="holeSize")
    bit_size: Optional[float] = Field(None, alias="bitSize")
    start_time: Optional[int] = Field(
        None,
        alias="startTime",
        description="epoch time stamp in milliseconds for when the Hole Sections was started.",
    ...
    top_measured_depth: Optional[float] = Field(
        None, alias="topMeasuredDepth", description="The start of the hole section"
    )
    base_measured_depth: Optional[float] = Field(None, alias="baseMeasuredDepth", description="End of the hole section")
...
class HoleSectionFilter(WellsBaseModel):
    ...
    start_time: Optional[TimeRange] = Field(None, alias="startTime")
    end_time: Optional[TimeRange] = Field(None, alias="endTime")
    is_definitive: Optional[bool] = Field(
        None,
        alias="isDefinitive",
        description="Specifies if query is to return only definitive or not. If value is not set, then all hole sections are returned",
    )
...
class DeleteExternalIdSource(WellsBaseModel):
    ...
    items: List[ExternalIdSource] = Field(..., max_items=1000, min_items=1)
...
class WellIngestionItems(WellsBaseModel):
    ...
    items: List[WellIngestion] = Field(..., max_items=1000, min_items=1)
...
class HoleSectionGroupIngestion(WellsBaseModel):
    ...
    external_id: str = Field(..., alias="externalId")
    is_definitive: Optional[bool] = Field(None, alias="isDefinitive")
    sections: List[HoleSectionIngestion]
...
class WellboreIngestionItems(WellsBaseModel):
    ...
    items: List[WellboreIngestion] = Field(..., max_items=1000, min_items=1)
