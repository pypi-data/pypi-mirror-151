...
class NxMonorepoProject(
    ...
    def __init__(
        self,
        *,
        no_hoist_globs: typing.Optional[typing.Sequence[builtins.str]] = None,
        ...
        '''
        :param no_hoist_globs: List of package globs to exclude from hoisting in the workspace. Default: []
...
class NxMonorepoProjectOptions(projen.typescript.TypeScriptProjectOptions):
    def __init__(
        ...
        *,
        ...
        if no_hoist_globs is not None:
            self._values["no_hoist_globs"] = no_hoist_globs
    ...
    @builtins.property
    def no_hoist_globs(self) -> typing.Optional[typing.List[builtins.str]]:
        ...
        '''
        result = self._values.get("no_hoist_globs")
        return typing.cast(typing.Optional[typing.List[builtins.str]], result)
