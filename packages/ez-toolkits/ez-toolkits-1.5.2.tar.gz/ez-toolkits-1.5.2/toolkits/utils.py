...
def datetime_local_to_timezone(dt, tz=timezone.utc):
    '''
...
def datetime_utc_to_timezone(dt, tz=datetime.now(timezone.utc).astimezone().tzinfo):
    '''
...
def timestamp_to_datetime(ts, tz=timezone.utc):
