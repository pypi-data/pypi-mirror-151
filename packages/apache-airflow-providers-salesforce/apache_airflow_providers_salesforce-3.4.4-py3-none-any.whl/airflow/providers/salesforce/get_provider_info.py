...
def get_provider_info():
    return {
        ...
        'sensors': [
            {
                'integration-name': 'Salesforce',
                'python-modules': ['airflow.providers.salesforce.sensors.tableau_job_status'],
            }
        ],
        'hooks': [
            {'integration-name': 'Tableau', 'python-modules': ['airflow.providers.salesforce.hooks.tableau']},
            {
                'integration-name': 'Salesforce',
                'python-modules': ['airflow.providers.salesforce.hooks.salesforce'],
            },
        ],
        'hook-class-names': ['airflow.providers.salesforce.hooks.salesforce.SalesforceHook'],
        'connection-types': [
            {
