...
class Ui_CameraSettings(object):
    def setupUi(self, CameraSettings):
        ...
        self.gridLayout.addWidget(self.chk_manual_tango_device, 2, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.le_tango_server, 2, 2, 1, 1)
        ...
        self.fr_vimba_picture_setings = QtWidgets.QFrame(self.groupBox)
        self.fr_vimba_picture_setings.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.fr_vimba_picture_setings.setFrameShadow(QtWidgets.QFrame.Raised)
        self.fr_vimba_picture_setings.setObjectName("fr_vimba_picture_setings")
        self.verticalLayout_6 = QtWidgets.QVBoxLayout(self.fr_vimba_picture_setings)
        self.verticalLayout_6.setObjectName("verticalLayout_6")
        self.chk_color = QtWidgets.QCheckBox(self.fr_vimba_picture_setings)
        self.chk_color.setObjectName("chk_color")
        self.verticalLayout_6.addWidget(self.chk_color)
        self.chk_high_depth = QtWidgets.QCheckBox(self.fr_vimba_picture_setings)
        self.chk_high_depth.setObjectName("chk_high_depth")
        self.verticalLayout_6.addWidget(self.chk_high_depth)
        self.gridLayout_2.addWidget(self.fr_vimba_picture_setings, 0, 1, 2, 1)
        self.chk_flip_h = QtWidgets.QCheckBox(self.groupBox)
        self.chk_flip_h.setObjectName("chk_flip_h")
        self.gridLayout_2.addWidget(self.chk_flip_h, 1, 0, 1, 1)
