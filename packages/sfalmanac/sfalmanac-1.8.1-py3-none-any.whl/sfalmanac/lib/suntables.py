...
from sfalmanac.lib import alma_skyfield as alma_skyfield
...
def sunalmanac(first_day, dtp, dfra):
    # dtp = 0 if for entire year; = -1 if for entire month; else days to print
...
\newgeometry{nomarginpar, top=5mm, bottom=13mm, left=20mm, right=14mm}'''
    ...
    \textsc{{\huge The Nautical Almanac for the Sun}}\\[0.7cm]'''.format(dfra)
