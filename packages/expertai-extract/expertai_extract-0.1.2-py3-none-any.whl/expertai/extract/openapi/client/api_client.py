...
from expertai.extract.openapi.client import rest
from expertai.extract.openapi.client.configuration import Configuration
from expertai.extract.openapi.client.exceptions import ApiTypeError, ApiValueError, ApiException
from expertai.extract.openapi.client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.layout_document_async_post  # this is an instance of the class Endpoint
        api_instance.layout_document_async_post()  # this invokes api_instance.layout_document_async_post.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.layout_document_async_post.callable or self.callable in this class
