...
while 1:
    try:
        ...
        if cmd[0] == 'regions':
            ...
            print('''\
Usage:
    create <name> <region> <plan>
        Create an instance with the specified name, region and plan.
    setup <name>
        Setup the instance with the specified name.
    key <key>
        Set the API key.
    user <username>
        Set the username.
    ...
    ls
        List all instances.
    info <name>
        Get information about the instance with the specified name.
    del <name>
        Delete the instance with the specified name.
    regions
        List all regions.
    plans
        List all plans.
