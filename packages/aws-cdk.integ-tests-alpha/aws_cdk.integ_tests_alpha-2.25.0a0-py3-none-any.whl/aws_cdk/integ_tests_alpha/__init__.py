...
class AssertionsProvider(
    ...
    def handler_role_arn(self) -> aws_cdk.Reference:
        '''(experimental) A reference to the provider Lambda Function execution Role ARN.

        :stability: experimental
        '''
        return typing.cast(aws_cdk.Reference, jsii.get(self, "handlerRoleArn"))
...
class DeployAssert(
    constructs.Construct,
    metaclass=jsii.JSIIMeta,
    jsii_type="@aws-cdk/integ-tests-alpha.DeployAssert",
):
...
@jsii.data_type(
    jsii_type="@aws-cdk/integ-tests-alpha.DeployAssertProps",
    jsii_struct_bases=[],
    name_mapping={},
)
class DeployAssertProps:
    def __init__(self) -> None:
        ...
        Example::
            ...
            deploy_assert_props = integ_tests_alpha.DeployAssertProps()
        '''
        self._values: typing.Dict[str, typing.Any] = {}
...
class IntegTest(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        test_cases: typing.Sequence[aws_cdk.Stack],
...
class IntegTestCase(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        stacks: typing.Sequence[aws_cdk.Stack],
        allow_destroy: typing.Optional[typing.Sequence[builtins.str]] = None,
        cdk_command_options: typing.Optional[aws_cdk.cloud_assembly_schema.CdkCommands] = None,
        diff_assets: typing.Optional[builtins.bool] = None,
        hooks: typing.Optional[aws_cdk.cloud_assembly_schema.Hooks] = None,
...
class IntegTestCaseProps(aws_cdk.cloud_assembly_schema.TestOptions):
    ...
    def stacks(self) -> typing.List[aws_cdk.Stack]:
        ...
        return typing.cast(typing.List[aws_cdk.Stack], result)
...
@jsii.data_type(
    ...
    jsii_struct_bases=[aws_cdk.cloud_assembly_schema.TestOptions, aws_cdk.StackProps],
    name_mapping={
        "allow_destroy": "allowDestroy",
        "cdk_command_options": "cdkCommandOptions",
        "diff_assets": "diffAssets",
...
class IntegTestProps(aws_cdk.cloud_assembly_schema.TestOptions):
    ...
    @builtins.property
    def test_cases(self) -> typing.List[aws_cdk.Stack]:
...
@jsii.data_type(
    jsii_type="@aws-cdk/integ-tests-alpha.ResultsCollectionRequest",
    jsii_struct_bases=[],
    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            results_collection_request = integ_tests_alpha.ResultsCollectionRequest(
                assertion_results=[integ_tests_alpha.AssertionResultData(
                    status=integ_tests_alpha.Status.PASS,
...
@jsii.data_type(
    jsii_type="@aws-cdk/integ-tests-alpha.ResultsCollectionResult",
    jsii_struct_bases=[],
...
class ResultsCollectionResult:
    def __init__(self, *, message: builtins.str) -> None:
        ...
        Example::
            ...
            results_collection_result = integ_tests_alpha.ResultsCollectionResult(
                message="message"
            )
        '''
        self._values: typing.Dict[str, typing.Any] = {
