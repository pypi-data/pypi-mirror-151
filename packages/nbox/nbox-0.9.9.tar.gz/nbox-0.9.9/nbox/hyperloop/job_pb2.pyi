...
class Job(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["auth_info",b"auth_info","code",b"code","created_at",b"created_at","dag",b"dag","id",b"id","k8sInfo",b"k8sInfo","name",b"name","paused",b"paused","resource",b"resource","schedule",b"schedule","status",b"status"]) -> None: ...
global___Job = Job
...
class NBXAuthInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["access_token",b"access_token","refresh_token",b"refresh_token","username",b"username","workspace_id",b"workspace_id"]) -> None: ...
