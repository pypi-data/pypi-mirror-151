...
setup(
    ...
    description='med-data-science-helper-utility de proyectos de analitica avanzada',
    long_description=read("README.md"),
    author='Analitica Avanzada',
    author_email='analitica.avanzada.talento@gmail.com',
    
    download_url='https://URL_PAQUETE/med-data-science-helper-utility/-/archive/master/med-data-science-helper-utility-master.tar'.format(
        VERSION),
    ...
    install_requires=[
        ...
        'openpyxl>=3.0.6',
        'tables>=3.6.1',
        'data-science-helper-utility>=0.0.6',
    ],
