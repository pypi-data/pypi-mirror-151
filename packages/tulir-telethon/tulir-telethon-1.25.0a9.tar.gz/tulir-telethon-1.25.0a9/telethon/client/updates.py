    ...
    async def _update_loop(self: 'TelegramClient'):
        try:
            ...
            while self.is_connected():
                ...
                if get_diff:
                    self._log[__name__].info('Getting difference for account updates (%d / %s)', get_diff.pts, get_diff.date)
                ...
                if get_diff:
                    self._log[__name__].info('Getting difference for channel updates (%d / %d)', get_diff.channel.channel_id, get_diff.pts)
                    diff = await self(get_diff)
