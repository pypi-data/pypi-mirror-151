...
def jacobian_mlp(wts: list[float], 
    ...
    for lyr in range(1,len(mlpstr)):
        ...
        D.append(float_array([deractfunc[lyr](Z[lyr][irow,]) for irow in r_samples]))
...
def hessian_mlp(wts: list[float], 
    ...
    D2 = [float_array([der2actfunc[0](Z[0][irow,]) for irow in r_samples])]
    ...
    for lyr in range(1,len(mlpstr)):
        ...
        D2.append(float_array([der2actfunc[lyr](Z[lyr][irow,]) for irow in r_samples]))
    ...
    sens = [pd.DataFrame(float_array([meanSens[:,:,out], stdSens[:,:,out], meansquareSens[:,:,out]]).T.reshape(meanSens.shape[1],-1), 
...
def jerkian_mlp(wts: list[float], 
    ...
    D3 = [float_array([der3actfunc[0](Z[0][irow,]) for irow in r_samples])]
    ...
    for lyr in range(1,len(mlpstr)):
        ...
        D3.append(float_array([der3actfunc[lyr](Z[lyr][irow,]) for irow in r_samples]))
