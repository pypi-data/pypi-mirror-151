...
try:
    ...
    use_torch = True
    def float_array(x, device) -> FloatTensor:
    ...
    use_torch = False
    def float_array(x, device) -> array:
        return array(x) 
...
def alpha_curve(raw_sens:list, tol: float = None, 
    ...
    alpha_curve = float_array([scl_factor * sum(scl_rs ** a / N) ** (1/a) for a in alpha])
