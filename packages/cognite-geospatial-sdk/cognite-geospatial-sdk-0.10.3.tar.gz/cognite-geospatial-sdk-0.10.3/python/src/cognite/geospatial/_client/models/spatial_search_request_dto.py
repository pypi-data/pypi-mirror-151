...
class SpatialSearchRequestDTO(object):
    ...
    def __init__(self, name=None, metadata=None, asset_ids=None, source=None, created_time=None, last_updated_time=None, external_id_prefix=None, spatial_filter=None, layer=None, attributes=None, output_crs=None, cursor=None, limit=100, offset=0, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def cursor(self):
        """Gets the cursor of this SpatialSearchRequestDTO.  # noqa: E501

        Cursor for paging through results.  # noqa: E501

        :return: The cursor of this SpatialSearchRequestDTO.  # noqa: E501
        :rtype: str
        """
        return self._cursor
    ...
    def cursor(self, cursor):
        """Sets the cursor of this SpatialSearchRequestDTO.

        Cursor for paging through results.  # noqa: E501

        :param cursor: The cursor of this SpatialSearchRequestDTO.  # noqa: E501
        :type cursor: str
        """
    ...
    def limit(self):
        ...
        Limits the number of results to return.  # noqa: E501
    ...
    def offset(self, offset):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                offset is not None and offset > 1000):  # noqa: E501
            raise ValueError("Invalid value for `offset`, must be a value less than or equal to `1000`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
