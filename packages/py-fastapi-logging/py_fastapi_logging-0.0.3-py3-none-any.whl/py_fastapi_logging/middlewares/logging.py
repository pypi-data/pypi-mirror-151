...
from py_fastapi_logging.middlewares.utils.request_id import generate_request_id, REQUEST_ID_HEADER
...
from py_fastapi_logging.config.config import init_logger, LogConfigure
...
class LoggingMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(
        ...
        self._prefix = prefix
        self._logger = logger if logger else init_logger(LogConfigure(app_name=app_name, cleanup=True))
    ...
    async def dispatch(self, request: Request, call_next: RequestResponseEndpoint) -> Response:
        ...
        extra_fields = {
            "tags": ["API", "REQUEST"],
            "payload": self._filter_private_data(request_log_payload.dict()),
            "to_mask": True,
        ...
        extra_fields["tags"] = ["API", "RESPONSE"]
        extra_fields["payload"] = self._filter_private_data(response_log_payload.dict())
    ...
    def _filter_private_data(self, payload: dict):
        ...
        elif "response_body" in payload.keys():
