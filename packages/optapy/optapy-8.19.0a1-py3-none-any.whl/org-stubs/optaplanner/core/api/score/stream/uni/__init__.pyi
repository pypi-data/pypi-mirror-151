...
class UniConstraintCollector(typing.Generic[_UniConstraintCollector__A, _UniConstraintCollector__ResultContainer_, _UniConstraintCollector__Result_]):
    ...
    public interface UniConstraintCollector<A, ResultContainer_, Result_>
        ...
        :meth:`~org.optaplanner.core.api.score.stream.uni.UniConstraintStream.groupBy`, ...
    
        Loosely based on JDK's
        :class:`~org.optaplanner.core.api.score.stream.uni.https:.docs.oracle.com.javase.8.docs.api.java.util.stream.Collector?is`,
...
class UniConstraintStream(org.optaplanner.core.api.score.stream.ConstraintStream, typing.Generic[_UniConstraintStream__A]):
    """
    public interface UniConstraintStream<A> extends :class:`~org.optaplanner.core.api.score.stream.ConstraintStream`
    
        A :class:`~org.optaplanner.core.api.score.stream.ConstraintStream` that matches one fact.
    ...
    @typing.overload
    def join(self, uniConstraintStream: 'UniConstraintStream'[_join_2__B], *biJoiner: org.optaplanner.core.api.score.stream.bi.BiJoiner[_UniConstraintStream__A, _join_2__B]) -> org.optaplanner.core.api.score.stream.bi.BiConstraintStream[_UniConstraintStream__A, _join_2__B]: ...
    @typing.overload
    def join(self, class_: typing.Type[_join_3__B]) -> org.optaplanner.core.api.score.stream.bi.BiConstraintStream[_UniConstraintStream__A, _join_3__B]: ...
    @typing.overload
    def join(self, class_: typing.Type[_join_4__B], biJoiner: org.optaplanner.core.api.score.stream.bi.BiJoiner[_UniConstraintStream__A, _join_4__B]) -> org.optaplanner.core.api.score.stream.bi.BiConstraintStream[_UniConstraintStream__A, _join_4__B]: ...
    @typing.overload
    def join(self, class_: typing.Type[_join_5__B], biJoiner: org.optaplanner.core.api.score.stream.bi.BiJoiner[_UniConstraintStream__A, _join_5__B], biJoiner2: org.optaplanner.core.api.score.stream.bi.BiJoiner[_UniConstraintStream__A, _join_5__B]) -> org.optaplanner.core.api.score.stream.bi.BiConstraintStream[_UniConstraintStream__A, _join_5__B]: ...
    @typing.overload
    def join(self, class_: typing.Type[_join_6__B], biJoiner: org.optaplanner.core.api.score.stream.bi.BiJoiner[_UniConstraintStream__A, _join_6__B], biJoiner2: org.optaplanner.core.api.score.stream.bi.BiJoiner[_UniConstraintStream__A, _join_6__B], biJoiner3: org.optaplanner.core.api.score.stream.bi.BiJoiner[_UniConstraintStream__A, _join_6__B]) -> org.optaplanner.core.api.score.stream.bi.BiConstraintStream[_UniConstraintStream__A, _join_6__B]: ...
    @typing.overload
    def join(self, class_: typing.Type[_join_7__B], biJoiner: org.optaplanner.core.api.score.stream.bi.BiJoiner[_UniConstraintStream__A, _join_7__B], biJoiner2: org.optaplanner.core.api.score.stream.bi.BiJoiner[_UniConstraintStream__A, _join_7__B], biJoiner3: org.optaplanner.core.api.score.stream.bi.BiJoiner[_UniConstraintStream__A, _join_7__B], biJoiner4: org.optaplanner.core.api.score.stream.bi.BiJoiner[_UniConstraintStream__A, _join_7__B]) -> org.optaplanner.core.api.score.stream.bi.BiConstraintStream[_UniConstraintStream__A, _join_7__B]: ...
    @typing.overload
    def join(self, uniConstraintStream: 'UniConstraintStream'[_join_8__B]) -> org.optaplanner.core.api.score.stream.bi.BiConstraintStream[_UniConstraintStream__A, _join_8__B]: ...
    @typing.overload
