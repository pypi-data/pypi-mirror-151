...
module_dir = os.path.join(__location__, "../src/mud_examples")
try:
...
copyright = "2021, Mathematical Michael"
...
htmlhelp_basename = "mud-examples-doc"
...
intersphinx_mapping = {
    ...
    "mud": ("https://mud.dataconsistent.com", None),
}
