...
class WSPipelines(BaseService):
    ...
    def _default_path_to_result(self, result_name: str) -> str:
        return f'.ibm_watson_studio_pipelines/results/{result_name}'
    ...
    def store_results(
        ...
        if test_mode:
            print("Running outside of Watson Studio Pipeline - storing results in the local filesystem for testing purposes...")
