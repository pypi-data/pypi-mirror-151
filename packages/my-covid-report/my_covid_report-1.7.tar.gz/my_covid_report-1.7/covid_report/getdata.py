...
def GET_shanghai_data(data_name = 'ts_shanghai_covid', plot = False, encoding = "UTF-8"):
    ...
    url = f'https://raw.githubusercontent.com/datoujinggzj/WhalePkg/master/DATA/{data_name}.csv'
