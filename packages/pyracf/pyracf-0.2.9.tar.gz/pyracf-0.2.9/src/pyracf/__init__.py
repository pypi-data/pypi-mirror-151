...
class RACF:
    ...
    def parse(self, thread_count=1, recordtypes=['0100', '0102', '0200','0205','0400', '0404', '0500', '0505']):
        self._starttime = datetime.now()
        if thread_count == 1:
            pt3 = threading.Thread(target=self.parse_t,args=(recordtypes,))
            pt3.start()
        elif thread_count == 2:
            # TODO: make this follow user selected recordtypes
