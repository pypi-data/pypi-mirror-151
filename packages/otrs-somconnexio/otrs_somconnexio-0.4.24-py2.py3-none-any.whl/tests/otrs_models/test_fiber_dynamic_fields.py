...
class FiberDynamicFieldsTestCase(unittest.TestCase):
    ...
    def test_process_id_field(self):
        ...
        self.assertEqual(dynamic_fields_dct["ProcessManagementProcessID"], "FiberProcessID")
    ...
    def test_pon_field(self):
        ...
        dynamic_fields_dct = dynamic_fields_to_dct(dynamic_fields)
        self.assertEqual(
            dynamic_fields_dct["ponAntic"],
            self.service_data.previous_contract_pon
        )
    ...
    def test_activity_id_field(self):
        ...
        dynamic_fields_dct = dynamic_fields_to_dct(dynamic_fields)
        self.assertEqual(dynamic_fields_dct["ProcessManagementActivityID"], "FiberActivityID")
