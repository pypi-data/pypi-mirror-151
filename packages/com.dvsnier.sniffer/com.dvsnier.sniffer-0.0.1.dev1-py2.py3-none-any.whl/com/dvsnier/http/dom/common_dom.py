...
class CommonDom(IDom, object):
    ...
    def get_attribute(self):
        ...
        if self._debug:
            if not attribute:
                logging.warning('The current value({}) is invalid and illegal, and then please reset the value'.format('attribute'))
        return attribute
    ...
    def get_brs(self):
        ...
        if self._debug:
            if not brs:
                logging.warning('The current value({}) is invalid and illegal, and then please reset the value'.format('brs'))
        return brs
    ...
    def get_cfg(self):
        ...
        if self._debug:
            if not cfg:
                logging.warning('The current value({}) is invalid and illegal, and then please reset the value'.format('cfg'))
        return cfg
    ...
    def get_content(self):
        ...
        if self._debug:
            if not content:
                logging.warning('The current value({}) is invalid and illegal, and then please reset the value'.format('content'))
        return content
    ...
    def get_comment_model(self):
        ...
        if self._debug:
            if not comment_model:
                logging.warning('The current value({}) is invalid and illegal, and then please reset the value'.format('comment_model'))
    ...
    def get_debug(self):
        ...
        if self._debug:
            if not debug:
                logging.warning('The current value({}) is invalid and illegal, and then please reset the value'.format('debug'))
        return debug
    ...
    def get_eoe(self):
        ...
        if self._debug:
            if not eoe:
                logging.warning('The current value({}) is invalid and illegal, and then please reset the value'.format('eoe'))
        return eoe
    ...
    def get_http(self):
        ...
        if self._debug:
            if not http:
                logging.warning('The current value({}) is invalid and illegal, and then please reset the value'.format('http'))
        return http
    ...
    def get_model(self):
        ...
        if self._debug:
            if not model:
                logging.warning('The current value({}) is invalid and illegal, and then please reset the value'.format('model'))
        return model
    ...
    def get_meta_model(self):
        ...
        if self._debug:
            if not meta_model:
                logging.warning('The current value({}) is invalid and illegal, and then please reset the value'.format('meta_model'))
        return meta_model
    ...
    def get_publisher_model(self):
        ...
        if self._debug:
            if not publisher_model:
                logging.warning('The current value({}) is invalid and illegal, and then please reset the value'.format('publisher_model'))
    ...
    def get_resolver(self):
        ...
        if self._debug:
            if not resolver:
                logging.warning('The current value({}) is invalid and illegal, and then please reset the value'.format('resolver'))
        return resolver
    ...
    def get_respondent_model(self):
        ...
        if self._debug:
            if not respondent_model:
                logging.warning('The current value({}) is invalid and illegal, and then please reset the value'.format('respondent_model'))
