    ...
    def get_element_node(self, beautifulSoup, **kwargs):
        ...
        if beautifulSoup and kwargs:
            ...
            if div and isinstance(div, Tag):
                ...
                main_item = div.findChild(name=kwargs_present_find_child_name, attrs=kwargs_present_find_child_attrs)  # main item
                if main_item and isinstance(main_item, Tag):
                    kwargs_publisher = kwargs.get('publisher', dict())
                    element_node['item'].append(__common_object_model.get_publisher_model().get_main_item(main_item, **kwargs_publisher))
