...
from schema_registry.client.sumup_schema_registry_client import (
    RegisteredSchema,
    Schema,
    SchemaReference,
)

from schema_registry.utils import schema_utils
...
class ConfluentSchemaRegistry(KafkaSchemaRegistryBase):
    ...
    def __init__(
        ...
        self.schema_registry_client = (
            sr.client.sumup_schema_registry_client.SchemaRegistryClient(
                {
    ...
    def _get_schema_fields(
        ...
        if schema.schema_type == "AVRO":
            ...
            fields = schema_utils.avro_schema_to_mce_fields(
