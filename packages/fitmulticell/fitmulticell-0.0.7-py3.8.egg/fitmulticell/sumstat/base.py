...
class SummaryStatistics:
    ...
    #             )
    #         if isinstance(list(self.sum_stat_calculator.values())[0], Callable):
    #             sumstats = self._call_summary_statistics_use_function(sumstats)
    #         elif isinstance(
    ...
    def call_sum_stat_dict(self, sumstats, function_name='main'):
        ...
        generic_key_list = [key for key in
                            list(self.sum_stat_calculator.keys())]
