...
class JointGroupInstructionInfo(object, metaclass=_SwigNonDynamicMeta):
    ...
    def __init__(self, plan_instruction: "PlanInstruction", request: "PlannerRequest", manip_info: "ManipulatorInfo"):
...
def getInterpolatedComposite(joint_names: "vector_string", states: "Eigen::MatrixXd const &", base_instruction: "PlanInstruction") -> "Eigen::MatrixXd const &":
    r"""
    ...
    :type base_instruction: :py:class:`PlanInstruction`
...
class SimplePlannerPlanProfile(object, metaclass=_SwigNonDynamicMeta):
    ...
    def generate(self, prev_instruction: "PlanInstruction", prev_seed: "MoveInstruction", base_instruction: "PlanInstruction", next_instruction: "Instruction", request: "PlannerRequest", global_manip_info: "ManipulatorInfo") -> "tesseract_planning::CompositeInstruction":
        r"""
        Generate a seed for the provided base_instruction
        :type prev_instruction: :py:class:`PlanInstruction`
