...
class TrajOptMotionPlanner(tesseract_robotics.tesseract_motion_planners.tesseract_motion_planners_python.MotionPlanner):
    ...
    callbacks = property(_tesseract_motion_planners_trajopt_python.TrajOptMotionPlanner_callbacks_get, _tesseract_motion_planners_trajopt_python.TrajOptMotionPlanner_callbacks_set, doc=r""" Callback functions called on each iteration of the optimization (Optional)""")
