...
def satisfiesPositionLimits(*args) -> "bool":
    ...
    :type joint_positions: Eigen::Ref< Eigen::VectorXd const >
...
def enforcePositionLimits(position_limits: "Eigen::Ref< Eigen::MatrixX2d const > const &") -> "Eigen::Ref< Eigen::VectorXd >":
    r"""
    Enforce position to be within the provided limits
    :type joint_positions: Eigen::Ref< Eigen::VectorXd >
    :param joint_positions: The joint position to enforce bounds on
    :param joint_limits: The limits to perform check
    """
    return _tesseract_common_python.enforcePositionLimits(position_limits)
