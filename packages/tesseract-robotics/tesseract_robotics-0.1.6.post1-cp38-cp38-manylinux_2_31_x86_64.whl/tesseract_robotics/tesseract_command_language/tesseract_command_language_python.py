...
class Waypoint(object, metaclass=_SwigNonDynamicMeta):
    ...
    def __eq__(self, rhs: "Waypoint") -> "bool":
        return _tesseract_command_language_python.Waypoint___eq__(self, rhs)

    def __ne__(self, rhs: "Waypoint") -> "bool":
        return _tesseract_command_language_python.Waypoint___ne__(self, rhs)

    def as_NullWaypoint(self, *args) -> "tesseract_planning::NullWaypoint const &":
        return _tesseract_command_language_python.Waypoint_as_NullWaypoint(self, *args)

    def as_const_NullWaypoint(self, *args) -> "tesseract_planning::NullWaypoint const const &":
        return _tesseract_command_language_python.Waypoint_as_const_NullWaypoint(self, *args)

    def as_CartesianWaypoint(self, *args) -> "tesseract_planning::CartesianWaypoint const &":
        return _tesseract_command_language_python.Waypoint_as_CartesianWaypoint(self, *args)

    def as_const_CartesianWaypoint(self, *args) -> "tesseract_planning::CartesianWaypoint const const &":
        return _tesseract_command_language_python.Waypoint_as_const_CartesianWaypoint(self, *args)

    def as_JointWaypoint(self, *args) -> "tesseract_planning::JointWaypoint const &":
        return _tesseract_command_language_python.Waypoint_as_JointWaypoint(self, *args)

    def as_const_JointWaypoint(self, *args) -> "tesseract_planning::JointWaypoint const const &":
        return _tesseract_command_language_python.Waypoint_as_const_JointWaypoint(self, *args)

    def as_StateWaypoint(self, *args) -> "tesseract_planning::StateWaypoint const &":
        return _tesseract_command_language_python.Waypoint_as_StateWaypoint(self, *args)

    def as_const_StateWaypoint(self, *args) -> "tesseract_planning::StateWaypoint const const &":
        return _tesseract_command_language_python.Waypoint_as_const_StateWaypoint(self, *args)
...
class Instruction(object):
    ...
    def __eq__(self, rhs: "Instruction") -> "bool":
        return _tesseract_command_language_python.Instruction___eq__(self, rhs)

    def __ne__(self, rhs: "Instruction") -> "bool":
        return _tesseract_command_language_python.Instruction___ne__(self, rhs)

    def as_NullInstruction(self, *args) -> "tesseract_planning::NullInstruction const &":
        return _tesseract_command_language_python.Instruction_as_NullInstruction(self, *args)

    def as_const_NullInstruction(self, *args) -> "tesseract_planning::NullInstruction const const &":
        return _tesseract_command_language_python.Instruction_as_const_NullInstruction(self, *args)

    def as_CompositeInstruction(self, *args) -> "tesseract_planning::CompositeInstruction const &":
        return _tesseract_command_language_python.Instruction_as_CompositeInstruction(self, *args)

    def as_const_CompositeInstruction(self, *args) -> "tesseract_planning::CompositeInstruction const const &":
        return _tesseract_command_language_python.Instruction_as_const_CompositeInstruction(self, *args)

    def as_PlanInstruction(self, *args) -> "tesseract_planning::PlanInstruction const &":
        return _tesseract_command_language_python.Instruction_as_PlanInstruction(self, *args)

    def as_const_PlanInstruction(self, *args) -> "tesseract_planning::PlanInstruction const const &":
        return _tesseract_command_language_python.Instruction_as_const_PlanInstruction(self, *args)

    def as_MoveInstruction(self, *args) -> "tesseract_planning::MoveInstruction const &":
        return _tesseract_command_language_python.Instruction_as_MoveInstruction(self, *args)

    def as_const_MoveInstruction(self, *args) -> "tesseract_planning::MoveInstruction const const &":
        return _tesseract_command_language_python.Instruction_as_const_MoveInstruction(self, *args)

    def as_TimerInstruction(self, *args) -> "tesseract_planning::TimerInstruction const &":
        return _tesseract_command_language_python.Instruction_as_TimerInstruction(self, *args)

    def as_const_TimerInstruction(self, *args) -> "tesseract_planning::TimerInstruction const const &":
        return _tesseract_command_language_python.Instruction_as_const_TimerInstruction(self, *args)

    def as_WaitInstruction(self, *args) -> "tesseract_planning::WaitInstruction const &":
        return _tesseract_command_language_python.Instruction_as_WaitInstruction(self, *args)

    def as_const_WaitInstruction(self, *args) -> "tesseract_planning::WaitInstruction const const &":
        return _tesseract_command_language_python.Instruction_as_const_WaitInstruction(self, *args)

    def as_SetToolInstruction(self, *args) -> "tesseract_planning::SetToolInstruction const &":
        return _tesseract_command_language_python.Instruction_as_SetToolInstruction(self, *args)

    def as_const_SetToolInstruction(self, *args) -> "tesseract_planning::SetToolInstruction const const &":
        return _tesseract_command_language_python.Instruction_as_const_SetToolInstruction(self, *args)

    def as_SetAnalogInstruction(self, *args) -> "tesseract_planning::SetAnalogInstruction const &":
        return _tesseract_command_language_python.Instruction_as_SetAnalogInstruction(self, *args)

    def as_const_SetAnalogInstruction(self, *args) -> "tesseract_planning::SetAnalogInstruction const const &":
        return _tesseract_command_language_python.Instruction_as_const_SetAnalogInstruction(self, *args)
...
def isPlanInstruction(instruction: "Instruction") -> "bool":
    return _tesseract_command_language_python.isPlanInstruction(instruction)
...
PlanInstructionType_LINEAR = _tesseract_command_language_python.PlanInstructionType_LINEAR
PlanInstructionType_FREESPACE = _tesseract_command_language_python.PlanInstructionType_FREESPACE
PlanInstructionType_CIRCULAR = _tesseract_command_language_python.PlanInstructionType_CIRCULAR
PlanInstructionType_START = _tesseract_command_language_python.PlanInstructionType_START
class PlanInstruction(object, metaclass=_SwigNonDynamicMeta):
    r"""
    The plan instruction is used when generating motion planning requests
    ...
    def __init__(self, *args):
        ...
        *Overload 5:*
        ...
        :param manipulator_info: Then manipulator information
        """
        _tesseract_command_language_python.PlanInstruction_swiginit(self, _tesseract_command_language_python.new_PlanInstruction(*args))

    def setWaypoint(self, waypoint: "Waypoint") -> "void":
        return _tesseract_command_language_python.PlanInstruction_setWaypoint(self, waypoint)

    def getWaypoint(self, *args) -> "tesseract_planning::Waypoint const &":
        return _tesseract_command_language_python.PlanInstruction_getWaypoint(self, *args)

    def setManipulatorInfo(self, info: "ManipulatorInfo") -> "void":
        return _tesseract_command_language_python.PlanInstruction_setManipulatorInfo(self, info)

    def getManipulatorInfo(self, *args) -> "tesseract_planning::ManipulatorInfo &":
        return _tesseract_command_language_python.PlanInstruction_getManipulatorInfo(self, *args)

    def setProfile(self, profile: "std::string const &") -> "void":
        return _tesseract_command_language_python.PlanInstruction_setProfile(self, profile)

    def getProfile(self) -> "std::string const &":
        return _tesseract_command_language_python.PlanInstruction_getProfile(self)

    def setPathProfile(self, profile: "std::string const &") -> "void":
        return _tesseract_command_language_python.PlanInstruction_setPathProfile(self, profile)

    def getPathProfile(self) -> "std::string const &":
        return _tesseract_command_language_python.PlanInstruction_getPathProfile(self)
    profile_overrides = property(_tesseract_command_language_python.PlanInstruction_profile_overrides_get, _tesseract_command_language_python.PlanInstruction_profile_overrides_set, doc=r""" Dictionary of profiles that will override named profiles for a specific task""")

    def getDescription(self) -> "std::string const &":
        return _tesseract_command_language_python.PlanInstruction_getDescription(self)

    def setDescription(self, description: "std::string const &") -> "void":
        return _tesseract_command_language_python.PlanInstruction_setDescription(self, description)

    def _print(self, *args) -> "void":
        return _tesseract_command_language_python.PlanInstruction__print(self, *args)

    def getPlanType(self) -> "tesseract_planning::PlanInstructionType":
        return _tesseract_command_language_python.PlanInstruction_getPlanType(self)

    def setPlanType(self, type: "tesseract_planning::PlanInstructionType") -> "void":
        return _tesseract_command_language_python.PlanInstruction_setPlanType(self, type)

    def isLinear(self) -> "bool":
        return _tesseract_command_language_python.PlanInstruction_isLinear(self)

    def isFreespace(self) -> "bool":
        return _tesseract_command_language_python.PlanInstruction_isFreespace(self)

    def isCircular(self) -> "bool":
        return _tesseract_command_language_python.PlanInstruction_isCircular(self)

    def isStart(self) -> "bool":
        return _tesseract_command_language_python.PlanInstruction_isStart(self)

    def __eq__(self, rhs: "PlanInstruction") -> "bool":
        return _tesseract_command_language_python.PlanInstruction___eq__(self, rhs)

    def __ne__(self, rhs: "PlanInstruction") -> "bool":
        return _tesseract_command_language_python.PlanInstruction___ne__(self, rhs)
    __swig_destroy__ = _tesseract_command_language_python.delete_PlanInstruction

# Register PlanInstruction in _tesseract_command_language_python:
_tesseract_command_language_python.PlanInstruction_swigregister(PlanInstruction)
...
class MoveInstruction(object, metaclass=_SwigNonDynamicMeta):
    ...
    def __init__(self, *args):
        ...
        *Overload 6:*
        ...
        Create a move instruction using properties of the plan_instruction
        :type waypoint: :py:class:`Waypoint`
        :param waypoint: The waypoint associated with the instruction
        :type plan_instruction: :py:class:`PlanInstruction`
...
def planFilter(instruction: "Instruction", composite: "CompositeInstruction", parent_is_first_composite: "bool") -> "bool":
    return _tesseract_command_language_python.planFilter(instruction, composite, parent_is_first_composite)
...
def clampToJointLimits(*args) -> "bool":
    ...
    *Overload 1:*
    ...
    :type limits: Eigen::Ref< Eigen::MatrixX2d const >
    :param limits: Matrix2d of limits with first column being lower limits and second column being upper limits
    :type max_deviation: float, optional
...
def getFirstPlanInstruction(*args) -> "tesseract_planning::PlanInstruction const *":
    r"""
    *Overload 1:*

    Get the first Plan Instruction in a Composite Instruction
    This does not consider the start instruction in child composite instruction
    :type composite_instruction: :py:class:`CompositeInstruction`
    :param composite_instruction: Composite Instruction to search
    :rtype: :py:class:`PlanInstruction`
    ...
    *Overload 2:*
    ...
    """
    return _tesseract_command_language_python.getFirstPlanInstruction(*args)
...
def getLastPlanInstruction(*args) -> "tesseract_planning::PlanInstruction const *":
    r"""
    *Overload 1:*

    Get the last Plan Instruction in a Composite Instruction
    This does not consider the start instruction in child composite instruction
    :type composite_instruction: :py:class:`CompositeInstruction`
    :param composite_instruction: Composite Instruction to search
    :rtype: :py:class:`PlanInstruction`
    ...
    *Overload 2:*
    ...
    """
    return _tesseract_command_language_python.getLastPlanInstruction(*args)
...
def getPlanInstructionCount(composite_instruction: "CompositeInstruction") -> "long":
    r"""
    Get number of Plan Instruction in a Composite Instruction
    This does not consider the start instruction in the child composite instruction
    :type composite_instruction: :py:class:`CompositeInstruction`
    :param composite_instruction: The Composite Instruction to process
    :rtype: int
    ...
    """
    return _tesseract_command_language_python.getPlanInstructionCount(composite_instruction)
