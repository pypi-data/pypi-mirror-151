...
class PlannerRequest(object, metaclass=_SwigNonDynamicMeta):
    ...
    This should be a one to one match with the instructions where the PlanInstruction is replaced with a
...
class PlannerResponse(object, metaclass=_SwigNonDynamicMeta):
    ...
    succeeded_instructions = property(_tesseract_motion_planners_python.PlannerResponse_succeeded_instructions_get, _tesseract_motion_planners_python.PlannerResponse_succeeded_instructions_set, doc=r"""
    Waypoints for which the planner
                                                                           succeeded
    """)
    failed_instructions = property(_tesseract_motion_planners_python.PlannerResponse_failed_instructions_get, _tesseract_motion_planners_python.PlannerResponse_failed_instructions_set, doc=r"""
    Waypoints for which the planner
                                                                                 failed
    """)
    data = property(_tesseract_motion_planners_python.PlannerResponse_data_get, _tesseract_motion_planners_python.PlannerResponse_data_set, doc=r"""
    data Planner specific data. For planners included in Tesseract_planning this is the planner problem that was
    solved
    """)
