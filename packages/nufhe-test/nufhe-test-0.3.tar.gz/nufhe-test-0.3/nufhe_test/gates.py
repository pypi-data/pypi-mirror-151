...
def gate_nand(
    ...
    #result = LweSampleArray.empty(thr, in_out_params, result.shape)
    #compute: (0,1/8) - a - b
    NandConst = phase_to_t32(1, 8)
    lwe_noiseless_trivial_constant(thr, result, NandConst)
    lwe_sub_to(thr, result, a)
    lwe_sub_to(thr, result, b)
...
def gate_or(
    ...
    lwe_noiseless_trivial_constant(thr, result, OrConst)
    lwe_add_to(thr, result, a)
    lwe_add_to(thr, result, b)
...
def gate_and(
    ...
    lwe_noiseless_trivial_constant(thr, result, AndConst)
    lwe_add_to(thr, result, a)
    lwe_add_to(thr, result, b)
...
def gate_xor(
    ...
    lwe_noiseless_trivial_constant(thr, result, XorConst)
    lwe_add_mul_to(thr, result, 2, a)
    lwe_add_mul_to(thr, result, 2, b)
...
def gate_xnor(
    ...
    lwe_noiseless_trivial_constant(thr, result, XnorConst)
    lwe_sub_mul_to(thr, result, 2, a)
    lwe_sub_mul_to(thr, result, 2, b)
...
def gate_nor(
    ...
    lwe_noiseless_trivial_constant(thr, result, NorConst)
    lwe_sub_to(thr, result, a)
    lwe_sub_to(thr, result, b)
...
def gate_andny(
    ...
    lwe_noiseless_trivial_constant(thr, result, AndNYConst)
    lwe_sub_to(thr, result, a)
    lwe_add_to(thr, result, b)
...
def gate_andyn(
    ...
    lwe_noiseless_trivial_constant(thr, result, AndYNConst)
    lwe_add_to(thr, result, a)
    lwe_sub_to(thr, result, b)
...
def gate_orny(
    ...
    lwe_noiseless_trivial_constant(thr, result, OrNYConst)
    lwe_sub_to(thr, result, a)
    lwe_add_to(thr, result, b)
...
def gate_oryn(
    ...
    lwe_noiseless_trivial_constant(thr, result, OrYNConst)
    lwe_add_to(thr, result, a)
    lwe_sub_to(thr, result, b)
...
def gate_mux(
    ...
    #result = LweSampleArray.empty(thr, in_out_params, result.shape)
    result1 = LweSampleArray.empty(thr, extracted_params, result.shape)
    ...
    lwe_noiseless_trivial_constant(thr, result1, MuxConst)
    lwe_add_to(thr, result1, u1)
    lwe_add_to(thr, result1, u2)

    # Key switching
    lwe_keyswitch(thr, result, cloud_key.keyswitch_key, result1)
