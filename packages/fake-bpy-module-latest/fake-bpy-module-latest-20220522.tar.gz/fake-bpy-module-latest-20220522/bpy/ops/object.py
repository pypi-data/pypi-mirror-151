...
def curves_empty_hair_add(align: typing.Union[int, str] = 'WORLD',
                          location: typing.List[float] = (0.0, 0.0, 0.0),
                          rotation: typing.List[float] = (0.0, 0.0, 0.0),
                          scale: typing.List[float] = (0.0, 0.0, 0.0)):
...
def curves_random_add(align: typing.Union[int, str] = 'WORLD',
                      location: typing.List[float] = (0.0, 0.0, 0.0),
                      rotation: typing.List[float] = (0.0, 0.0, 0.0),
                      scale: typing.List[float] = (0.0, 0.0, 0.0)):
...
def gpencil_modifier_add(type: typing.Union[int, str] = 'GP_THICK'):
...
def instance_offset_from_cursor():
    ''' Set offset used for collection instances based on cursor position :file: startup/bl_operators/object.py\:851 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/object.py$851> _
...
def make_override_library(collection: typing.Union[int, str] = 'DEFAULT',
    ...
    :type collection: typing.Union[int, str]
    :param do_fully_editable: Create Fully Editable, Make all created override data-blocks fully editable
