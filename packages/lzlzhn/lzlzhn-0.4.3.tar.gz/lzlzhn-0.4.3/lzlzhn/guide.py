...
def guide():
    """
    import lzlzhn import guide
    guide.guide()
    """
    print('======================================================================')
    print('欢迎下载我的第三方模块0.4.3版')
    print('Welcome to download my third-party module-0.4.3')
    time.sleep(2)
    print('==========================================================================================')
    print('本模块是由多人联合完成的模块')
    print('==========================================================================================')
    print('author/name/connecting_points/connecting_points_tester/information_bombardment/QR')
    print('请输入需要查询的函数 ')
    ...
    if guide_to_print == 'author':
        ...
        print('==========================================================================================')
        time.sleep(3)
    elif guide_to_print == 'connecting_points':
        print('这是一个连点器,用法如下')
        print('this is a connecting point and is used as follows')
        print('==========================================================================================')
        print('connecting_points.connecting_points()')
        print('==========================================================================================')
        time.sleep(3)
    elif guide_to_print == 'connecting_points_tester':
        print('这是一个连点器测试器,用法如下')
        print('This is a connecting point tester and is used as follows')
        print('==========================================================================================')
        print('connecting_points_tester.connecting_points_tester()')
        print('==========================================================================================')
        time.sleep(3)
    elif guide_to_print == 'information_bombardment':
        print('这是一个社交软件信息轰炸器，用法如下')
        print('This is a social software information bomberand is used as follows')
        print('==========================================================================================')
        print('如果你用的语言是中文请用：')
        print('information_bombardment.information_bombardment_Chinese()')
        print('')
        print('If you speak English,please use:')
        print('information_bombardment.information_bombardment_English()')
        print('==========================================================================================')
        time.sleep(3)
    elif guide_to_print == 'QR':
        print('这是一个二维码生成器，用法如下')
