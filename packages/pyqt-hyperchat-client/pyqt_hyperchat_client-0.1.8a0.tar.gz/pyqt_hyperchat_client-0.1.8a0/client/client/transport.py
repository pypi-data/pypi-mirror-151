...
# Объекты блокировки сокета и работы с базой данных
...
class ClientTransport(threading.Thread, QObject):
    """Класс обработки сообщений и работы сокета. Принимает:
    базу данных, имя, пароль, ip-адрес сервера, порт сервера, ключ
    """
    # Сигналы новое сообщениеб отобразить сообщение и потеря соединения
    ...
    def connection_init(self, serv_ip, serv_port):
        """Метод инициализатор сокета. Принимает:
        ip-адрес сервера, порт сервера
        """
        try:
    ...
    def add_contact(self, contact):
        """Метод добавляет контакт в список контактов. Принимает:
        имя
        """
    ...
    def del_contact(self, contact):
        """Метод удаляет контакт из списка контактов. Принимает:
        имя
        """
    ...
    def update_db_list(self, command):
        """Метод загружает актуальною базу с сервера и сохраняет локально. Принимает:
         USER_LIST
         GET_CONTACTS
         """
    ...
    def get_users_list(self):
        """Метод загружает в память локальную базу всех пользователей"""
    ...
    def get_contact_list(self):
        """Метод загружает в память локальную базу всех контактов текущего пользователя"""
    ...
    def send_text_message(self, dest_name, msg):
        """Метод отправляет серверу текстовое сообщение для получателя. Принимает:
        имя, сообщение
        """
        message_dict = {
            ACTION: MESSAGE,
    ...
    def send_service_message(self, msg_type, data=None):
        """Метод отправляет сервисное сообщение серверу. Принимаются команды:
        USER_LIST
        ONLINE
        GET_CONTACTS
        EXIT
    ...
    def process_server_ans(self, msg):
        """Метод обработчик неожиданно поступающих сообщений с сервера."""
