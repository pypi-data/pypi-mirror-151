...
class CapsulesOutputV1(object):
    ...
    def __init__(self, capsules=None, graph_limit=None, key_unit_of_measure=None, limit=None, next=None, offset=None, prev=None, status_message=None, warning_count=None, warning_logs=None):
        """
