...
class CapsulesOverwriteInputV1(object):
    ...
    def __init__(self, capsules=None, interval=None, key_unit_of_measure=None):
        """
    ...
    def interval(self):
        ...
        The time range to overwrite. if not provided, it will be the inclusive of all the provided capsules starts.
    ...
    def key_unit_of_measure(self):
        """
        Gets the key_unit_of_measure of this CapsulesOverwriteInputV1.
        The unit of measure for the capsule starts and ends. If left empty, input is assumed to be in ISO8601 format.

        :return: The key_unit_of_measure of this CapsulesOverwriteInputV1.
        :rtype: str
        """
    ...
    def key_unit_of_measure(self, key_unit_of_measure):
        """
        Sets the key_unit_of_measure of this CapsulesOverwriteInputV1.
        The unit of measure for the capsule starts and ends. If left empty, input is assumed to be in ISO8601 format.

        :param key_unit_of_measure: The key_unit_of_measure of this CapsulesOverwriteInputV1.
        :type: str
        """
