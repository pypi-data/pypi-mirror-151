...
class TreesApi(object):
    ...
    def create_tree_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/trees/assets/createTree', 'POST',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='AssetGroupOutputV1',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def get_tree_with_http_info(self, **kwargs):
        ...
        all_params = ['id', 'scope', 'offset', 'limit', 'include_descendants']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_tree_root_nodes_with_http_info(self, **kwargs):
        ...
        all_params = ['scope', 'offset', 'limit', 'properties']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def rebuild_search_index(self, **kwargs):
        """
        Trigger a rebuild of an asset tree search index in the background, starting at the specified root or datasource. This can be a time consuming and resource intensive operation, especially on large trees. The reindexing is performed in the background, and the API call will return as soon as the rebuild has been triggered.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.rebuild_search_index(id=id_value, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str id: ID of either the datasource or the root of the tree to rebuild (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: None
    ...
    def rebuild_search_index_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.rebuild_search_index_with_http_info(id=id_value, callback=callback_function)
        ...
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `rebuild_search_index`")
        ...
        return self.api_client.call_api('/trees/assets/{id}/rebuildSearchIndex', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
