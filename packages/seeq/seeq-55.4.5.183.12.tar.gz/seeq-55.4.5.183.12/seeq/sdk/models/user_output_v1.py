...
class UserOutputV1(object):
    ...
    def __init__(self, created_at=None, datasource_name=None, description=None, effective_permissions=None, email=None, first_name=None, groups=None, id=None, is_active=False, is_admin=False, is_archived=False, is_enabled=False, is_password_settable=False, is_redacted=False, last_login_at=None, last_name=None, name=None, status_message=None, translation_key=None, type=None, username=None, workbench=None):
        """
