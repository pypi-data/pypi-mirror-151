...
def push(items: Union[pd.DataFrame, dict, list, str], acl: Union[pd.DataFrame, dict, list], *, replace: bool = False,
         disable_inheritance: bool = None, errors: str = 'raise', quiet: bool = False, status: Optional[Status] = None,
