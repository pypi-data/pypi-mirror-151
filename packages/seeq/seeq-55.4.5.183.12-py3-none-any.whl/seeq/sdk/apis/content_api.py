...
class ContentApi(object):
    ...
    def create_asset_selection_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/content/asset-selections', 'POST',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='AssetSelectionOutputV1',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def get_report_statistics_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/content/reports/metrics', 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='ReportAdminListOutputV1',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def get_report_summary_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/content/reports/metrics/summary', 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='ReportSummaryWeekOutputV1',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def update_asset_selection(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_asset_selection(id=id_value, body=body_value, callback=callback_function)
    ...
    def update_asset_selection_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_asset_selection_with_http_info(id=id_value, body=body_value, callback=callback_function)
