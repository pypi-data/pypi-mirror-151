...
class ConditionsApi(object):
    ...
    def put_capsules(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.put_capsules(id=id_value, body=body_value, callback=callback_function)
    ...
    def put_capsules_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.put_capsules_with_http_info(id=id_value, body=body_value, callback=callback_function)
