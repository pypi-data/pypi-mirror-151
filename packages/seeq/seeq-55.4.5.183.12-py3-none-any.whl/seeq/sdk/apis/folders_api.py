...
class FoldersApi(object):
    ...
    def get_folders(self, **kwargs):
        ...
        :param list[str] search_fields: Search by name and/or description
    ...
    def get_folders_with_http_info(self, **kwargs):
        ...
        all_params = ['filter', 'user_id', 'is_archived', 'sort_order', 'offset', 'limit', 'only_pinned', 'folder_id', 'ids', 'types', 'text_search', 'is_exact', 'root', 'search_fields']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
