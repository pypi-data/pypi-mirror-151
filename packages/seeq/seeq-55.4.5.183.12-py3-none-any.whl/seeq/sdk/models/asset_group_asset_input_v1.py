...
class AssetGroupAssetInputV1(object):
    ...
    def __init__(self, children=None, data_id=None, description=None, host_id=None, id=None, manually_added=None, name=None, properties=None, scoped_to=None, security_string=None, source_security_string=None, sync_token=None):
        """
