[![PyPI version](https://badge.fury.io/py/nlp-service.svg)](https://badge.fury.io/py/nlp-service)
[![Downloads](https://pepy.tech/badge/nlp-service)](https://pepy.tech/project/nlp-service)
...
**nlp-service**实现了BertSoftmax、BertCrf、BertSpan等多种命名实体识别模型，并在标准数据集上比较了各模型的效果。
...
# Feature
### 命名实体识别模型
- [BertSoftmax](nlp-service/ner_model.py)：BertSoftmax基于BERT预训练模型实现实体识别，本项目基于PyTorch实现了BertSoftmax模型的训练和预测
...
Demo: https://huggingface.co/spaces/shibing624/nlp-service
...
```shell
>>> from nlp-service import NERModel
...
是`nlp-service.NERModel`指定的默认模型，可以通过上面示例调用，或者如下所示用[transformers库](https://github.com/huggingface/transformers)调用，
模型自动下载到本机路径：`~/.cache/huggingface/transformers`

#### Usage (HuggingFace Transformers)
Without [nlp-service](https://github.com/shibing624/nlp-service), you can use the model like this: 
...
| 数据集 | 语料 | 下载链接 | 文件大小 |
| :------- | :--------- | :---------: | :---------: |
| **`CNER中文实体识别数据集`** | CNER(12万字) | [CNER github](https://github.com/shibing624/nlp-service/tree/main/examples/data/cner)| 1.1MB |
| **`PEOPLE中文实体识别数据集`** | 人民日报数据集（200万字） | [PEOPLE github](https://github.com/shibing624/nlp-service/tree/main/examples/data/people)| 12.8MB |
| **`CoNLL03英文实体识别数据集`** | CoNLL-2003数据集（22万字） | [CoNLL03 github](https://github.com/shibing624/nlp-service/tree/main/examples/data/conll03)| 1.7MB |
...
sys.path.append('..')
from nlp-service.ner_model import NERModel
...
APA:
```latex
Xu, M. nlp-service: Named Entity Recognition Toolkit (Version 0.0.2) [Computer software]. https://github.com/shibing624/nlp-service
```
...
author = {Xu, Ming},
title = {{nlp-service: Named Entity Recognition Toolkit}},
