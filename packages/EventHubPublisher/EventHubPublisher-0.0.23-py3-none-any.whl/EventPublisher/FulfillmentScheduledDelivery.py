...
def run(env_name, client_code, account_name, events_json):
    return SendEvents.send_events('FulfillmentScheduledDelivery', env_name, client_code, account_name, events_json)

# for testing 
if sys.stdin and len(sys.argv) > 0:
    print(SendEvents.run('FulfillmentScheduledDelivery'))
