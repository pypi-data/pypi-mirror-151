...
def collection_external_asset_drop(session_uuid: int = 0, align: str = 'WORLD', location: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), rotation: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), scale: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), use_instance: bool = True, drop_x: int = 0, drop_y: int = 0, collection: str = '') -> None:
...
def convert(target: str = 'MESH', keep_original: bool = False, merge_customdata: bool = True, angle: float = 1.22173, thickness: int = 5, seams: bool = False, faces: bool = True, offset: float = 0.01) -> None:
...
def curves_empty_hair_add(align: str = 'WORLD', location: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), rotation: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), scale: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0)) -> None:
...
def curves_random_add(align: str = 'WORLD', location: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), rotation: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), scale: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0)) -> None:
...
def game_property_copy(operation: str = 'COPY', property: str = '') -> None:
...
def game_property_move(index: int = 0, direction: str = 'UP') -> None:
...
def game_property_new(type: str = 'FLOAT', name: str = '') -> None:
...
def game_property_remove(index: int = 0) -> None:
...
def gpencil_modifier_add(type: str = 'GP_THICK') -> None:
...
def hide_collection(collection_index: int = -1, toggle: bool = False, extend: bool = False) -> None:
...
def lod_generate(count: int = 3, target: float = 0.1, package: bool = False) -> None:
...
def lod_remove(index: int = 1) -> None:
...
def make_override_library(collection: str = 'DEFAULT', do_fully_editable: bool = False) -> None:
...
def modifier_apply(modifier: str = '', report: bool = False, merge_customdata: bool = True, single_user: bool = False) -> None:
...
def modifier_convert(modifier: str = '', merge_customdata: bool = True) -> None:
...
def parent_no_inverse_set(keep_transform: bool = False) -> None:
...
def paths_calculate(display_type: str = 'RANGE', range: str = 'SCENE') -> None:
...
def shade_smooth(use_auto_smooth: bool = False, auto_smooth_angle: float = 0.523599) -> None:
...
def transform_apply(location: bool = True, rotation: bool = True, scale: bool = True, properties: bool = True, isolate_users: bool = False) -> None:
