...
def seq_slide(value: typing.Tuple[float, float] = (0.0, 0.0), orient_axis_ortho: str = 'X', snap: bool = False, snap_target: str = 'CLOSEST', snap_point: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), snap_align: bool = False, snap_normal: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), view2d_edge_pan: bool = False, release_confirm: bool = False, use_accurate: bool = False) -> None:
...
def vert_crease(value: float = 0.0, snap: bool = False, snap_target: str = 'CLOSEST', snap_point: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), snap_align: bool = False, snap_normal: typing.Tuple[float, float, float] = (0.0, 0.0, 0.0), release_confirm: bool = False, use_accurate: bool = False) -> None:
