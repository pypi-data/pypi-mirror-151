...
class Paginator:
    ...
    def _new_page(self, title: str, description: str):
        ...
        """
        return discord.Embed(title=title, description=description, color=self.color,author=self.author)
    ...
    def add_command(self, command: commands.Command, signature: str):
        ...
        if cooldown:
            page.add_field(
                name="<:timer:941993935507689492> Cooldown",
    ...
    def add_index(self, title: str, bot: commands.Bot):
        ...
        if self.show_index:
            ...
            for page_no, page in enumerate(self._pages, 1):
                if page.description:
                  text=f'{self.prefix}{page.description}{self.suffix}'
                else:
