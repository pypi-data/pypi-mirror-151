...
def get_YTDPDF(username, password, groupnum,
               ...
               url = 'https://dbapps.optimedhp.com/reports/request_report/YTDPDF',
               download = False,
               downloadDir = None):
    '''
    Parameters
    ...
    url (str):
        ...
        Default is 'https://dbapps.optimedhp.com/reports/request_report/YTDPDF' \n
