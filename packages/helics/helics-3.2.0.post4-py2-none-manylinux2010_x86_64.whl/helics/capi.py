...
class HelicsValueFederate(HelicsFederate):
    ...
    def register_publication(self, name     , kind                            , units      = "", local       = True)                     :
        """
...
def helicsFederateGetTag(fed                , tagname     ):
    """
...
def helicsFederateSetTag(fed                , tagname     , tagvalue     ):
    """
...
def helicsEndpointGetTag(endpoint                , tagname     ):
    """
...
def helicsEndpointSetTag(endpoint                , tagname     , tagvalue     ):
    """
...
def helicsInputGetTag(input             , tagname     ):
    """
...
def helicsInputSetTag(input             , tagname     , tagvalue     ):
    """
...
def helicsFilterGetTag(filter              , tagname     ):
    """
...
def helicsFilterSetTag(filter              , tagname     , tagvalue     ):
    """
...
def helicsFederateRegisterTranslator(fed                , type                       , name     )                    :
    """
...
def helicsFederateRegisterGlobalTranslator(fed                , type                       , name     )                    :
    """
    Create a source Translator on the specified federate.
...
def helicsCoreRegisterGlobalTranslator(core            , type                       , name     )                    :
    """
...
def helicsFederateGetTranslatorCount(fed                )       :
    """
...
def helicsFederateGetTranslator(fed                , name     )                    :
    """
...
def helicsFederateGetTranslatorByIndex(fed                , index     )                    :
    """
    Get a translator by its name, typically already created via registerInterfaces file or something of that nature.
...
def helicsTranslatorIsValid(translator                  )        :
    """
...
def helicsTranslatorGetName(translator                  )       :
    """
...
def helicsTranslatorSet(translator                  , property     , value       ):
    """
...
def helicsTranslatorSetString(translator                  , property     , value     ):
    """
...
def helicsTranslatorAddInputTarget(translator                  , input     ):
    """
...
def helicsTranslatorAddPublicationTarget(translator                  , publication     ):
    """
...
def helicsTranslatorAddSourceEndpoint(translator                  , source     ):
    """
...
def helicsTranslatorAddDestinationEndpoint(translator                  , destination     ):
    """
...
def helicsTranslatorRemoveTarget(translator                  , target     ):
    """
...
def helicsTranslatorGetInfo(translator                  )       :
    """
...
def helicsTranslatorSetInfo(translator                  , info     ):
    """
...
def helicsTranslatorGetTag(translator                  )       :
    """
...
def helicsTranslatorSetTag(translator                  , tag     ):
    """
...
def helicsTranslatorGetOption(translator                  , option                    )       :
    """
...
def helicsTranslatorSetOption(translator                  , option                    , value     ):
    """
...
def helicsPublicationPublishComplexVector(pub                   , vectorInput               ):
    """
...
def helicsInputGetComplexVector(ipt             )                 :
    """
...
def helicsInputSetDefaultComplexVector(ipt             , vectorInput               ):
    """
    Set the default as a vector of doubles.
...
def helicsCoreSetLoggingCallback(core            , logger, user_data):
    """
...
def helicsBrokerSetLoggingCallback(broker              , logger, user_data):
    """
...
def helicsFederateSetQueryCallback(fed                , query, user_data):
    """
...
def helicsFederateSetTimeRequestEntryCallback(fed                , request_time, user_data):
    """
...
def helicsFederateSetTimeRequestUpdateCallback(fed                , update_time, user_data):
    """
    Set the callback for the time request
...
def helicsFederateSetTimeRequestReturnCallback(fed                , request_time_return, user_data):
    """
    Set the callback for the time request
...
def HelicsQueryBufferFill(buffer                   , string     ):
    """
...
def helicsCreateDataBuffer(initial_capacity     )                    :
    """
...
def helicsWrapDataInBuffer(data       , data_capacity     )                    :
    """
...
def helicsDataBufferFree(data                  ):
    f = loadSym("helicsDataBufferFree")
    f(data)


def helicsDataBufferCapacity(data                  )       :
    f = loadSym("helicsDataBufferCapacity")
    return f(data)


def helicsDataBufferSize(data                  )       :
    f = loadSym("helicsDataBufferSize")
    return f(data)


def helicsDataBufferReserve(data                  , new_capacity)        :
    f = loadSym("helicsDataBufferReserve")
    return f(data, new_capacity) == 1


def helicsDataBufferData(data                  )         :
    f = loadSym("helicsDataBufferData")
    return f(data)


def helicsIntToBytes(value     , data                  ):
    """
...
def helicsDoubleToBytes(value     , data                  ):
    """
...
def helicsStringToBytes(string     , data                  ):
    """
...
def helicsBoolToBytes(value      , data                  ):
    """
...
def helicsCharToBytes(value     , data                  ):
    """
    Convert a bool to serialized bytes
    """
...
def helicsTimeToBytes(value            , data                  ):
    """
    Convert a bool to serialized bytes
    """
...
def helicsComplexToBytes(value         , data                  ):
    """
...
def helicsVectorToBytes(value             , data                  ):
    """
    Convert a complex to serialized bytes
    """
...
def helicsDataBufferType(data                  )       :
    f = loadSym("helicsDataBufferType")
    return f(data)


def helicsDataBufferToInt(data                  )       :
    f = loadSym("helicsDataBufferToInt")
    return f(data)


def helicsDataBufferToDouble(data                  )         :
    f = loadSym("helicsDataBufferToDouble")
    return f(data)


def helicsDataBufferToBool(data                  )        :
