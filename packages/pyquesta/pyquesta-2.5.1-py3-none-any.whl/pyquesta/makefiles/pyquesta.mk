...
DPI_PATH := $(realpath $(shell pyquesta-config --dpi-dir))

sv_conduit.so: $(DPI_PATH)/sv_conduit.c $(DPI_PATH)/sv_conduit.h
	gcc -I $(DPI_PATH)/dpi -I ${QUESTA_HOME}/include $(DPI_PATH)/sv_conduit.c -shared -o sv_conduit.so -fPIC
