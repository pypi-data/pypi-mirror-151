...
def create_rule_sentencizer(nlp, name, split_patterns, join_patterns):
    return RuleSentencizer(nlp, name, split_patterns, join_patterns)


class RuleSentencizer(object):
    """
    Simple component that correct some over-segmentation errors of the sentencizer using exception rule_segmenter.
